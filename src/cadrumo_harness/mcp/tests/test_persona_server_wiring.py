...
delegate to: :func:`~cadrumo_harness.mcp.server.filter_descriptors_for_persona`
(the ``_list_tools`` half) and
:func:`~cadrumo_harness.mcp.server.persona_scope_refusal` (the ``_call_tool``
...
from ..server import filter_descriptors_for_persona, persona_scope_refusal
