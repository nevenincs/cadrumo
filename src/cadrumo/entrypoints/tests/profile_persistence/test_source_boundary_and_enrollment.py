"""Persistence-backed tests for source-boundary safety and resolver enrollment.
...
from cadrumo.adapters.persistence.profile.tests.relation_prefill_support import empty_profile_read_ports
    ...
    source_resolution = merge_source_resolutions(
        [
            LedgerIvaAggregationSourceResolver(
                transaction_repository=tx_repo,
                invoice_catalogue_read_ports=catalogue_read_ports,
...
def test_s27_withholding_source_kind_is_enrolled_not_deferred() -> None:
    ...
    from cadrumo.application.aggregation.source_resolution_operations import collect_unhandled_source_diagnostics
