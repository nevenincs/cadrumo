...
from cadrumo.entrypoints.tests.profile_persistence.file_flow_test_support import _FILE_FLOW_PROFILE_ID, _Repos
...
class TestPersistedPayloadFallback:
    ...
    def test_a_legacy_year_payload_still_matches_the_filing_year(self, repos: _Repos) -> None:
        ...
        """
        from cadrumo.domain.buckets.event import BucketEvent, BucketEventObjectType, derive_bucket_event_id
        from cadrumo.domain.buckets.event_repository import emit_bucket_events
        ...
        narrowed = assemble_modelo_lifecycle_history("130", filing_year=2026, ports=_history_ports(repos))
