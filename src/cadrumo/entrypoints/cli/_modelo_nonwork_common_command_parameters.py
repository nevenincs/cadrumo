...
_REFUND_ELECTION_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("...core.refund_election", "RefundElection", __package__)),
...
_PAYMENT_ELECTION_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("...core.payment_election", "PaymentElection", __package__)),
