...
def root_command(
    ...
    ctx.with_resource(bind_bucket_event_history_repository_factory(build_bucket_event_history_repository))
    ctx.with_resource(bind_confirmation_record_repository_factory(ConfirmationRecordRepository))
