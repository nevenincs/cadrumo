...
Held as catalogue KEYS and resolved beside the assertion, never at import:
the page resolves its wording under whatever language the profile carries,
and a value captured when this module loaded would be compared against a
sentence produced later under different settings."""
