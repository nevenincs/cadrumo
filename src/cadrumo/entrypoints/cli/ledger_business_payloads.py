...
from ...application.ledger.invoice_draft_payloads import (
...
if TYPE_CHECKING:
    from ...application.inventory.service import InventoryValuationPreviewResult as _AppInventoryValuationPreviewResult
