...
_OPTIONAL_YEAR_FROM_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    help_key=translation_key("cli.app.live.from_year_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
...
_OPTIONAL_YEAR_TO_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("builtins", "int")),
    default=ParameterDefault.value(None),
    help_key=translation_key("cli.app.live.to_year_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=2000, maximum=2099),
...
_OPTIONAL_MODELOS_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    help_key=translation_key("cli.app.live.filed.pull_modelo_help"),
    multiple=True,
    is_flag=False,
    flag_value=None,
...
_OPTIONAL_YEAR_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("builtins", "int")),
    default=ParameterDefault.value(None),
    help_key=translation_key("cli.app.live.year_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=2000, maximum=2099),
...
_OUTPUT_ROOT_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    default=ParameterDefault.value(None),
    help_key=translation_key("cli.app.live.output_root_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=None, maximum=None),
...
_REQUIRED_MODELO_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    help_key=translation_key("cli.app.live.modelo_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=None, maximum=None),
...
_REQUIRED_FILING_YEAR_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("builtins", "int")),
    default=ParameterDefault.required(),
    help_key=translation_key("cli.app.live.borrador.filing_year_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=2000, maximum=2099),
...
_REQUIRED_PERIOD_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("builtins", "str")),
    default=ParameterDefault.required(),
    help_key=translation_key("cli.app.live.period_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=None, maximum=None),
...
_OPTIONAL_TAXPAYER_NIF_OPTION: Final[OptionSpec] = OptionSpec(
    ...
    value=ValueContract(DeferredTarget("builtins", "str")),
    default=ParameterDefault.value(None),
    help_key=translation_key("cli.app.live.iva_wallet.taxpayer_nif_help"),
    multiple=False,
    is_flag=False,
    flag_value=None,
    constraint=ParameterConstraint(minimum=None, maximum=None),
