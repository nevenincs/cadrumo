...
LEDGER_COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        ...
        parameters=(
            ...
            OptionSpec(
                name="authority_stdin",
                declarations=("--authority-stdin",),
                value=ValueContract(DeferredTarget("builtins", "bool")),
                default=ParameterDefault.value(False),
                help_key=TranslationKey("cli.app.ledger.inventory.authority_stdin_help"),
                metavar=None,
                is_flag=True,
                flag_value=True,
                multiple=False,
            ...
            OptionSpec(
                name="authority_fd",
                declarations=("--authority-fd",),
                value=ValueContract(DeferredTarget("builtins", "int")),
                default=ParameterDefault.value(None),
                help_key=TranslationKey("cli.app.ledger.inventory.authority_fd_help"),
                metavar=None,
                is_flag=False,
                flag_value=None,
                multiple=False,
