...
def compose_ledger_action_ports(*, bucket_id: str) -> LedgerActionPorts:
    ...
    authority = bundled_indexed_authority()

    def load_pinned_usage_ratios(*, bucket_id: str) -> UsageRatioProfile:
    ...
    return LedgerActionPorts(
        ...
        usage_ratio_profile=load_pinned_usage_ratios(bucket_id=bucket_id),
