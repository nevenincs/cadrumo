...
_LEDGER_LOCALE_KEYS: Final = (
    ...
    "tui.ledger.column.date",
    "tui.ledger.column.description",
    "tui.ledger.column.counterparty",
    "tui.ledger.column.amount",
    "tui.ledger.column.direction",
    "tui.ledger.column.classification",
    ...
    "tui.ledger.reconciliation.direction_state.invoice_only",
    "tui.ledger.reconciliation.direction_state.transaction_only",
