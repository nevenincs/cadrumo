...
from cadrumo.domain.invoices.decomposition import InvoiceComponents

pytestmark = [pytest.mark.unit, pytest.mark.hex_application]

_CORPUS = pathlib.Path(__file__).resolve().parents[4] / "application" / "ledger" / "tests" / "_evidence_corpus"
