...
:func:`adapters.inbound.borrador.parser.parse_borrador` entry point.
...
:class:`adapters.inbound.borrador.schema.BorradorExtractionProfile` to
the public parser.
...
See Also:
    ...
    :class:`adapters.inbound.borrador.schema.BorradorParseMode`
