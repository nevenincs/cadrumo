...
helpers from :mod:`adapters.inbound.financial.providers.csv` so
the same alias rules apply to spreadsheet exports as to the
matching CSV downloads.

The selected worksheet emits
:class:`~adapters.inbound.financial.providers.base.ParsedLedgerRow` records
...
class XlsxProvider(FinancialProvider):
    ...
    against :data:`adapters.inbound.financial.providers.csv.CSV_LAYOUTS`
    ...
    Like :class:`~adapters.inbound.financial.providers.csv.CsvProvider`, this
