"""Inert namespace for financial input adapters.
...
:class:`domain.transactions.raw_transaction.RawTransaction` records with
:class:`domain.transactions.raw_transaction.RawProvenance`; application services own
...
Consumers import providers and contracts from their defining modules; the
package initializer exports no symbols.
