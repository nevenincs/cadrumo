...
def _m303_snapshot_ref(filing_year: int):
    return published_snapshot("303", filing_year=filing_year, period="4T").snapshot_ref
...
def test_two_sectors_apportion_at_own_percentage_with_common_use_split(
    ...
    register_2026 = ProrrataRegister(
        ...
        sector_definitions=(
            SectorDefinition(
                sector_id="comercio", letra=SectorDiferenciadoLetra.from_registry("a"), member_activity_codes=("4711",)
            ),
            SectorDefinition(
