...
def active_profile_isolated_backend_fixture(
    *,
    ...
    :func:`~cadrumo.adapters.persistence.profile.tests.profile_registration.register_minimal_profile`.
    The default ``None`` preserves every existing caller's behaviour unchanged.
