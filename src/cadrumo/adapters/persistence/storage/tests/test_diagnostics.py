"""Tests for application diagnostics over the real storage adapter."""
...
def test_profile_check_warn_row_names_every_missing_required_key() -> None:
    ...
    from .....application.wizard.status import WizardStatusReport
    ...
    check = build_profile_check(report)
