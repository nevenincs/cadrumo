...
Living here in the bucket adapter's test owner keeps the second creator out of
the production surface while placing the helper beside the layout contract it
exercises. Nothing an operator runs can reach this test-only provisioner.
"""
...
if TYPE_CHECKING:
    ...
    from ..directory_layout import BucketPaths
