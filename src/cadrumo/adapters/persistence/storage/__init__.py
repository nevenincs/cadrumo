...
if TYPE_CHECKING:
    ...
    from .crypto.encrypted_columns import EncryptedBytes, EncryptedJSON, EncryptedString, HashedLookup
    ...
    from .custody.paths import profile_custody_path
...
_LAZY_EXPORTS: dict[str, str] = {
    "AEAT_BROWSER_SESSION_NAMESPACE": "._secure_object_namespaces",
    "AEAT_FILED_DECLARATION_ARTEFACTS_NAMESPACE": "._secure_object_namespaces",
    "AEAT_FILED_DECLARATION_OBSERVATIONS_NAMESPACE": "._secure_object_namespaces",
    "AEAT_IVA_WALLET_OBSERVATIONS_NAMESPACE": "._secure_object_namespaces",
    "APPLICATION_EVIDENCE_BUNDLE_NAMESPACE": "._secure_object_namespaces",
    "APPLICATION_FILING_HISTORY_NAMESPACE": "._secure_object_namespaces",
    "ARGON2_VERSION": ".master_key",
    "ATTACHMENT_BLOB_NAMESPACE": "._secure_object_namespaces",
    "ATTACHMENT_MANIFEST_NAMESPACE": "._secure_object_namespaces",
    "AUTH_APODERADO_CONFIGURATION_NAMESPACE": "._secure_object_namespaces",
    ...
    "BUCKET_EVENT_HISTORY_NAMESPACE": "._secure_object_namespaces",
    ...
    "CALCULATION_OBSERVATIONS_NAMESPACE": "._secure_object_namespaces",
    "CLAVE_MOVIL_DIAGNOSTICS_NAMESPACE": "._secure_object_namespaces",
    ...
    "DOMAIN_NAMESPACE_DEFINITIONS": "._secure_object_namespaces",
    "DecryptionError": ".errors",
    "EncryptedBlob": ".crypto.aead",
    "EncryptedBlobStore": ".blob_store",
    "EncryptedBytes": ".crypto.encrypted_columns",
    "EncryptedJSON": ".crypto.encrypted_columns",
    "EncryptedString": ".crypto.encrypted_columns",
    "EncryptionError": ".errors",
    "EncryptionMetadata": ".envelope",
    "Envelope": ".envelope",
    "EnvelopeVersionError": ".errors",
    "FILING_AMENDMENTS_NAMESPACE": "._secure_object_namespaces",
    "FILING_DRAFTS_NAMESPACE": "._secure_object_namespaces",
    "FILING_EXPORT_REPLAY_PROOFS_NAMESPACE": "._secure_object_namespaces",
    "GCM_TAG_SIZE": ".crypto.aead",
    "GOOGLE_CREDENTIAL_SOURCE_NAMESPACE": "._secure_object_namespaces",
    "GOOGLE_DRIVE_CONFIG_NAMESPACE": "._secure_object_namespaces",
    "GOOGLE_OAUTH_CLIENT_NAMESPACE": "._secure_object_namespaces",
    "GOOGLE_OAUTH_METADATA_NAMESPACE": "._secure_object_namespaces",
    "GOOGLE_OAUTH_TOKEN_NAMESPACE": "._secure_object_namespaces",
    "HashedLookup": ".crypto.encrypted_columns",
    "INVOICE_CATALOGUE_NAMESPACE": "._secure_object_namespaces",
    "IVA_COMPENSATION_HISTORY_NAMESPACE": "._secure_object_namespaces",
    "IVA_WALLET_RECONCILIATION_DECISIONS_NAMESPACE": "._secure_object_namespaces",
    "IVA_WALLET_RECONCILIATION_DECISION_EVENTS_NAMESPACE": "._secure_object_namespaces",
    "JUSTIFICANTE_METADATA_NAMESPACE": "._secure_object_namespaces",
    "KEYSTORE_DIRNAME": "._storage_path_definitions",
    "KEY_SIZE": ".crypto.aead",
    "KeyDerivationError": ".errors",
    "KDF_SALT_BYTES": "._kdf_salt",
    "KeyringUnavailableError": ".errors",
    "LEDGER_CLASSIFICATION_RULES_NAMESPACE": "._secure_object_namespaces",
    "LEDGER_CONFIRMATION_RECORD_NAMESPACE": "._secure_object_namespaces",
    "LEDGER_CONFIRMED_COUNTERPARTY_FACTS_NAMESPACE": "._secure_object_namespaces",
    "LEDGER_EXTRACTED_DOCUMENT_CACHE_NAMESPACE": "._secure_object_namespaces",
    "LEDGER_EXTRACTION_DRAFT_NAMESPACE": "._secure_object_namespaces",
    "LEDGER_PURCHASE_INVOICE_EVIDENCE_NAMESPACE": "._secure_object_namespaces",
    "LIVE_BORRADOR_100_SNAPSHOT_NAMESPACE": "._secure_object_namespaces",
    "LIVE_DEUDAS_SNAPSHOT_NAMESPACE": "._secure_object_namespaces",
    "LIVE_EXPEDIENTES_SNAPSHOT_NAMESPACE": "._secure_object_namespaces",
    "LIVE_IVA_REMOTE_STATE_ACQUISITIONS_NAMESPACE": "._secure_object_namespaces",
    "LIVE_JUSTIFICANTE_CAPTURE_SNAPSHOT_NAMESPACE": "._secure_object_namespaces",
    "LIVE_M036_DECLARATION_NAMESPACE": "._secure_object_namespaces",
    "LIVE_NOTIFICATIONS_SNAPSHOT_NAMESPACE": "._secure_object_namespaces",
    "LIVE_NOTIFICATION_DOCUMENT_NAMESPACE": "._secure_object_namespaces",
    "LIVE_VERIFY_OBSERVATION_NAMESPACE": "._secure_object_namespaces",
    "LLM_CACHE_NAMESPACE": "._secure_object_namespaces",
    "LLM_EVIDENCE_CONSENT_LEDGER_NAMESPACE": "._secure_object_namespaces",
    "LLM_RUN_TELEMETRY_NAMESPACE": "._secure_object_namespaces",
    "LLM_USAGE_NAMESPACE": "._secure_object_namespaces",
    "LOGIN_THROTTLE_FILENAME": "._storage_path_definitions",
    "LockAcquisitionError": "....core.locks_errors",
    "M145_COMMUNICATION_RECORD_NAMESPACE": "._secure_object_namespaces",
    "MODELO_CALCULATION_REVISION_CATALOGUE_NAMESPACE": "._secure_object_namespaces",
    "MODELO_EDIT_RECEIPT_NAMESPACE": "._secure_object_namespaces",
    "MODELO_FILING_RECORD_CATALOGUE_NAMESPACE": "._secure_object_namespaces",
    "MODELO_RECONCILIATION_RECORDS_NAMESPACE": "._secure_object_namespaces",
    "MODELO_REVIEW_PACKAGE_RECIPIENT_ENCRYPTION_KEY_NAMESPACE": "._secure_object_namespaces",
    "MODELO_REVIEW_PACKAGE_RECIPIENT_FINGERPRINT_REGISTRY_NAMESPACE": "._secure_object_namespaces",
    "MODELO_REVIEW_PACKAGE_RECIPIENT_REPLAY_GUARD_NAMESPACE": "._secure_object_namespaces",
    "MODELO_REVIEW_PACKAGE_SIGNING_KEY_NAMESPACE": "._secure_object_namespaces",
    "OPERATION_SECURE_REFERENCE_NAMESPACE": "._secure_object_namespaces",
    "MODELO_VERIFICATION_REPORT_CATALOGUE_NAMESPACE": "._secure_object_namespaces",
    "MODELO_WORK_UNIT_CATALOGUE_NAMESPACE": "._secure_object_namespaces",
    ...
    "NONCE_SIZE": ".crypto.aead",
    "NoActiveBucketSessionError": ".master_key",
    "NonceCollisionError": ".errors",
    "PROFILE_ASSETS_AMORTIZATION_LEDGER_NAMESPACE": "._secure_object_namespaces",
    "PROFILE_ASSETS_LEDGER_NAMESPACE": "._secure_object_namespaces",
    "PROFILE_BIENES_INVERSION_IVA_REGISTER_NAMESPACE": "._secure_object_namespaces",
    "PROFILE_CUSTODY_ENVELOPE_MAX_BYTES": ".custody.records",
    "PROFILE_CUSTODY_ENVELOPE_SCHEMA_VERSION": ".custody.records",
    "PROFILE_CUSTODY_KDF_ITERATIONS": ".custody.records",
    "PROFILE_CUSTODY_KDF_MEMORY_MIB": ".custody.records",
    "PROFILE_CUSTODY_KDF_PARALLELISM": ".custody.records",
    "PROFILE_CUSTODY_PASSWORD_GENERATION_MAX": ".custody.records",
    "PROFILE_INVENTORY_LEDGER_NAMESPACE": "._secure_object_namespaces",
    "PROFILE_PRORRATA_REGISTER_NAMESPACE": "._secure_object_namespaces",
    ...
    "ProfileCustodyEnvelope": ".custody.records",
    "ProfileCustodyError": ".custody.errors",
    "ProfileCustodyKdfParameters": ".custody.records",
    "ProfileCustodyPasswordError": ".custody.errors",
    "ProfileCustodyRecordError": ".custody.errors",
    "ProfileCustodyRecoverySecretError": ".custody.errors",
    "ProfileCustodyRefusal": ".custody.errors",
    "ProfileCustodyRefusedError": ".custody.errors",
    "ProfileCustodyWrappedDek": ".custody.records",
    "REPAIR_INTEGRITY_DECISION_NAMESPACE": "._secure_object_namespaces",
    "RETENCION_OBSERVATIONS_NAMESPACE": "._secure_object_namespaces",
    ...
    "SECURE_OBJECT_CATALOGUE_KEY": "._secure_object_namespaces",
    "SECURE_OBJECT_DEFAULT_KEY": "._secure_object_namespaces",
    "SECURE_OBJECT_SCHEMA_VERSION_V1": "._secure_object_namespaces",
    ...
    "SecureObjectNamespaceDefinition": "._secure_object_namespaces",
    ...
    "StorageCustodyDisposition": "._secure_object_namespaces",
    "StorageError": ".errors",
    "StorageHierarchyRegistry": "._secure_object_namespaces",
    "StorageNamespaceScope": "._secure_object_namespaces",
    "StoragePathAnchor": "._secure_object_namespaces",
    "StoragePathDefinition": "._storage_path_definitions",
    "StoragePathKind": "._secure_object_namespaces",
    "StorageRemoteMirrorPolicy": "._secure_object_namespaces",
    ...
    "TEST_SECURE_BOUND_CONTRACT_NAMESPACE": "._secure_object_namespaces",
    "TEST_SESSION_LIFECYCLE_NAMESPACE": "._secure_object_namespaces",
    "TEST_SNAPSHOT_BASE_PROBE_NAMESPACE": "._secure_object_namespaces",
    "TRANSACTION_CATALOGUE_NAMESPACE": "._secure_object_namespaces",
    "TRANSACTION_PARTICIPATION_INDEX_NAMESPACE": "._secure_object_namespaces",
    "USAGE_RATIO_PROFILE_NAMESPACE": "._secure_object_namespaces",
    "USER_PROFILE_SNAPSHOT_NAMESPACE": "._secure_object_namespaces",
    "USER_PROFILE_VALUE_NAMESPACE": "._secure_object_namespaces",
    "UnsecuredMasterKeyProvider": ".master_key",
    "UnsecuredModeRefusedError": ".errors",
    "WITHHOLDING_OBSERVATIONS_NAMESPACE": "._secure_object_namespaces",
    "WORKFLOW_RUN_NAMESPACE": "._secure_object_namespaces",
    "WORKFLOW_STATE_NAMESPACE": "._secure_object_namespaces",
    ...
    "parse_profile_custody_envelope": ".custody.records",
    "profile_custody_path": ".custody.paths",
