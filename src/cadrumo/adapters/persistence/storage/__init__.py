...
_LAZY_EXPORTS: dict[str, str] = {
    ...
    "BUCKET_DEK_FILENAME": "._storage_path_definitions",
    ...
    "CorpusManifestDiff": "....core.corpus_manifest",
    "DEFAULT_LOCK_TIMEOUT": "....core.locks",
    ...
    "FileFallbackMasterKeyProvider": ".master_key",
    "GCM_TAG_SIZE": ".crypto",
    ...
    "MasterKeyKdfVersionError": ".errors",
    "MasterKeyKeychainLockedError": ".errors",
    "MasterKeyMaterialMissingError": ".errors",
    "MasterKeyPassphraseMismatchError": ".errors",
    ...
    "PROFILE_CUSTODY_PASSWORD_MAX_BYTES": ".custody",
    "PROFILE_CUSTODY_PASSWORD_MAX_SCALARS": ".custody",
    "PROFILE_CUSTODY_PASSWORD_MIN_SCALARS": ".custody",
    ...
    "encode_mnemonic": ".master_key",
    "encrypt_record": ".crypto",
    "generate_recovery_key": ".master_key",
    "get_active_master_key": ".master_key",
    "get_engine": ".sql.engine",
    "get_master_key_provider": ".master_key",
    ...
    "load_wrapped_master_key": ".master_key",
    ...
    "save_wrapped_master_key": ".master_key",
    ...
    "unwrap_master_key": ".master_key",
    "validate_profile_password": ".custody",
