    ...
    if active is None:
        issues.append(
            _readiness_issue(
                ...
                message_key="errors.storage.runtime.no_active_session",
                message=(
                    "no active bucket session; run `cadrumo config switch NAME` "
        ...
        if active.sealed:
            issues.append(
                _readiness_issue(
                    ...
                    message_key="errors.storage.runtime.session_sealed",
                    message=(
                        "the active bucket session is sealed; run `cadrumo config switch NAME` "
            ...
            issues.append(
                _readiness_issue(
                    ...
                    message_key="errors.storage.runtime.session_expired",
                    message=(
                        "the active bucket session has expired; run `cadrumo config switch NAME` "
                        "to re-activate the profile."
                    ),
                ),
            )
