...
from cadrumo.adapters.persistence.storage.custody.label_head_repository import ProfileLabelHeadRepository
...
def test_public_facade_exposes_no_transaction_service_or_generic_record_replace() -> None:
    ...
    from cadrumo.application import user_profile as public_user_profile
