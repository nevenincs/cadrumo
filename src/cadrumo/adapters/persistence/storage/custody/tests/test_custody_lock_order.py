...
from cadrumo.adapters.persistence.storage.custody.filesystem import profile_custody_local_lock
...
def _hold_root_lock_in_sibling(root_text: str, release_event: Any, result_queue: Any) -> None:
    ...
    from cadrumo.core.paths import effective_storage_root as _effective_root
