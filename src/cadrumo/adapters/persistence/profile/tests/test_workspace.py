...
def _assemble_static_inspection_pieces(bucket_id: str, repository: WorkUnitCatalogueRepository):
    ...
    from cadrumo.application.modelo.workspace import resolve_modelo_workspace_revision_axes
    from cadrumo.application.modelo.workspace_models import ModeloWorkspaceResolvedTargetV1
...
def test_static_inspection_parameter_schema_records_key_off_dispatching_formulas() -> None:
    from cadrumo.application.modelo.workspace_models import ModeloWorkspaceParameterReferenceV1
...
def _real_calculation_revision_with_row_materialization():
    ...
    from cadrumo.domain.calculations.row_casilla import DirectRowMaterializationProvenance
