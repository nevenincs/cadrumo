...
def _calculate_111(
    *,
    ...
    snapshot = compiled_bundled_authority().snapshot(_MODELO_111, filing_year=filing_year, period=period)
...
def _calculate_190(
    *,
    ...
    snapshot = compiled_bundled_authority().snapshot(_MODELO_190, filing_year=filing_year, period="0A")
