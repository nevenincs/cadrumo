...
from cadrumo.application.modelo._registry_helpers import refuse_stored_row_field_scalar_inputs
...
def test_m180_scalar_retenciones_input_is_refused_before_anything_is_persisted(repos: Repos) -> None:
    ...
    with pytest.raises(RegistryValidationError) as refusal, bundled_indexed_authority().operation() as operation:
