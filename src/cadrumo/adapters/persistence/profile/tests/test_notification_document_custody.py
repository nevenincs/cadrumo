"""Adapter-layer custody, refusal and roundtrip behaviour for notification documents.
...
from cadrumo.adapters.outbound.aeat.sede.errors import SedeNavigationError
