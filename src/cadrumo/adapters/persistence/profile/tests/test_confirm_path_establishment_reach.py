...
def test_a_confirmed_canarian_counterparty_resolves_its_territory_through_the_verb(
    ...
    assert establishment.counterparty.scope is IvaTerritorialScope.from_registry("es_canarias")
...
def test_the_resolved_scope_reaches_the_criteria_as_a_declared_fact(
    ...
    assert declared_issuer.value is IvaTerritorialScope.from_registry("es_canarias")
    ...
    assert declared_customer.value is IvaTerritorialScope.from_registry("es_mainland")
