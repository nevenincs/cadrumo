...
def test_the_existing_oo_corpus_record_confirms_as_ordinary(
    ...
    assert result.invoice.invoice_class == InvoiceClass.from_registry("ORDINARIA")
...
def test_the_existing_or_corpus_record_confirms_as_corrective(
    ...
    assert result.invoice.invoice_class == InvoiceClass.from_registry("RECTIFICATIVA")
...
def test_a_summary_declaration_is_reported_without_overwriting_the_operator_class(
    ...
    assert result.invoice.invoice_class == InvoiceClass.from_registry("SIMPLIFICADA")
