...
from .....application.modelo.tests.advisory_diagnostic_assertions import operator_text as _operator_text
...
def test_this_covers_the_state_the_sibling_undeclared_advisory_returns_early_on() -> None:
    ...
    sibling = tuple(
        ...
        if diagnostic.source_kind == "minimo_descendientes_undeclared"
    )
