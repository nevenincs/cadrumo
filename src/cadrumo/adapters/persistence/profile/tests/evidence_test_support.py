...
runtime_profile = bucket_scoped_runtime_profile_fixture(BUCKET_ID, autouse=False, name="runtime_profile")
...
def make_svc(isolated_settings: Settings, objects: SecureObjectRepository) -> PurchaseInvoiceEvidenceService:
