"""Application certificate-secret fakes owned by profile integration tests."""
...
from cadrumo.application.auth.certificate_secret_backend import CertificateSecretBackend
...
class InMemoryCertificateSecretBackendFactory:
    """Construct certificate-secret fakes independently for each profile root."""
