...
See Also:
    ...
    :func:`~application.modelo.m145_communication_records.mark_m145_communication_record_delivered_to_payer`
        Transition to payer-delivered state.
    :func:`~application.modelo.m145_communication_records.mark_m145_communication_record_locally_completed`
        Transition to local-completion state.
    :func:`~application.modelo.m145_communication_records.read_m145_communication_record`
