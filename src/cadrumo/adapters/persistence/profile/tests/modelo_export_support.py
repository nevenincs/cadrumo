...
def export_m303_filing_evidence(period: Period, *, operation: PinnedAuthorityOperation) -> FilingInstanceEvidence:
...
def export_taxpayer_profile() -> TaxpayerProfile:
...
def seed_profile(*, tax_id: str | None = None, profile_overrides: dict[str, str] | None = None) -> str:
...
def synthetic_valid_nif(number: int) -> str:
