...
:meth:`core.access_gate.AeatAccessGate.require_live_write` always
raises :class:`core.access_gate.LiveSubmitForbiddenError`. Local
filing state is modeled separately by :mod:`domain.submission`, and
