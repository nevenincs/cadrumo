...
:class:`domain.currency.service.ExchangeRateProvider` that resolves each rate from the
...
:class:`domain.currency.service.CurrencyNormalizationService`, and a date the ECB did not
