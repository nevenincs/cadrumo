...
def secure_objects(tmp_path: Path) -> Iterator[SecureObjectRepository]:
    """Own the encrypted transaction store used by the import integration path."""
...
def test_usd_import_populates_fx_rate_and_value_in_eur(
    ...
    repo = TransactionCatalogueRepository(bucket_id=_BUCKET_ID, objects=secure_objects)
...
def test_anti_tautology_mutated_rate_changes_value_in_eur(
    ...
    repo_canonical = TransactionCatalogueRepository(bucket_id=_BUCKET_ID, objects=secure_objects)
    ...
    repo_mutant = TransactionCatalogueRepository(bucket_id=_BUCKET_ID, objects=secure_objects)
