...
class LLMPreconditionCondition(StrEnum):
    ...
    EVIDENCE_TOKEN_BOUND = "llm.evidence." + "token_bound"
    EVIDENCE_TOKEN_EPHEMERAL = "llm.evidence." + "token_ephemeral"
...
def llm_no_recovery_verdict(
    ...
    *,
    ...
    The import is deferred because application modules consume :mod:`cadrumo.adapters.outbound.llm`;
