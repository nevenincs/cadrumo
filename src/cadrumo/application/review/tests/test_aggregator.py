...
def _seed_all_sources(tmp_path: Path) -> tuple[Settings, DraftReviewPorts]:
    """Build one pending item in every source through inward port fakes."""
    ...
    return settings, draft_review_ports(
