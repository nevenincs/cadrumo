...
def test_transaction_review_item_round_trips_through_json() -> None:
    item = TransactionReviewItem(
        ...
        summary=_summary("tx"),
        drill_command="cadrumo app ledger review t-1",
...
def test_review_item_discriminator_resolves_each_kind() -> None:
    payloads = [
        ...
        InvoiceReviewItem(
            ...
            drill_command="cadrumo app review view i-1",
        ...
        FindingReviewItem(
            ...
            drill_command="cadrumo app review view draft-1:casilla-out-of-range:03",
...
def test_finding_review_item_allows_none_source_for_placeholder_row() -> None:
    placeholder = FindingReviewItem(
        ...
        drill_command="cadrumo app review view draft-1:_status:VALIDATED",
        since=datetime(2026, 4, 14, tzinfo=UTC),
        source=None,
        draft_id="draft-1",
        draft_path="draft.json",
