...
def _to_transaction_item(
    ...
    *,
    ...
    return TransactionReviewItem(
        ...
        severity=severity,
        summary=summary,
        drill_command=f"cadrumo app ledger review {transaction.transaction_id}",
        since=since,
        source=transaction,
    )
...
def _to_invoice_item(invoice: Invoice, *, severity: ReviewSeverity, reason: str) -> InvoiceReviewItem:
    ...
    return InvoiceReviewItem(
        ...
        severity=severity,
        summary=summary,
        drill_command=f"cadrumo app review view {invoice.invoice_id}",
        since=since,
        source=invoice,
    )
...
def _to_finding_item(
    *,
    ...
    return FindingReviewItem(
        ...
        severity=severity,
        summary=summary,
        drill_command=f"cadrumo app review view {draft.draft_id}:{finding.code}:{casilla}",
...
def _to_placeholder_item(*, draft: ModeloDraft, path_str: str) -> FindingReviewItem:
    ...
    return FindingReviewItem(
        ...
        summary=summary,
        drill_command=f"cadrumo app review view {draft.draft_id}:_status:{draft.status.value}",
        since=draft.updated_at,
        source=None,
        draft_id=draft.draft_id,
        draft_path=path_str,
...
def _to_stale_approval_item(*, draft: ModeloDraft, path_str: str) -> FindingReviewItem:
    ...
    return FindingReviewItem(
        ...
        summary=summary,
        drill_command=f"cadrumo app review view {draft.draft_id}:_status:APPROVAL_STALE",
        since=draft.updated_at,
        source=None,
        draft_id=draft.draft_id,
        draft_path=path_str,
