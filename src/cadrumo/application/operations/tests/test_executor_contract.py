...
_NAMESPACE = SecureObjectNamespaceDefinition(
    key="operation_executor_contract_test",
    namespace="cadrumo-test.operations.executor-contract",
    owner="cadrumo.application.operations.tests.test_executor_contract",
