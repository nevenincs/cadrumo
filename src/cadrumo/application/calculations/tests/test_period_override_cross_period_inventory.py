...
from ...tests.period_override_authority import authority_with_period_override
...
def test_the_inventory_covers_only_the_periods_the_override_year_serves() -> None:
    ...
    inventory = cross_period_dependency_inventory(authority, filing_year=_YEAR, modelos=[_MODELO])
