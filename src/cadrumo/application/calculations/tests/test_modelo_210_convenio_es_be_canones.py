...
def test_be_canones_resolves_treaty_ceiling_of_5_percent() -> None:
...
def test_be_canones_treaty_and_legal_entry_are_grounded() -> None:
    ...
    assert published_legal_reference("convenio-es-be-1995:art-12").id == "convenio-es-be-1995:art-12"
    art12 = published_legal_reference("convenio-es-be-1995:art-12")
