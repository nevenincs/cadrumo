"""Cross-year prior-filing continuity for Modelo 130.

This module drives the real M130 backend (real
...
— no mocks) across two distinct renta years.
...
#: _produced by the real engine; the test asserts the cross-renta minoración
