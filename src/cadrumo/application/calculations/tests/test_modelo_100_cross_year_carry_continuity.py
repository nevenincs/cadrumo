"""Cross-year carry continuity for Modelo 100 (IRPF anual).

This module drives the real M100 calculation engine
(``calculate_modelo_revision``) across two distinct renta years.
