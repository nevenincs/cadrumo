...
def test_nl_dividend_resolves_treaty_ceiling_of_15_percent() -> None:
...
def test_nl_interest_resolves_treaty_ceiling_of_10_percent() -> None:
...
def test_nl_treaty_legal_entries_are_grounded() -> None:
    ...
    assert published_legal_reference("convenio-es-nl-1971:art-10").id == "convenio-es-nl-1971:art-10"
    assert published_legal_reference("convenio-es-nl-1971:art-11").id == "convenio-es-nl-1971:art-11"
    art10 = published_legal_reference("convenio-es-nl-1971:art-10")
    art11 = published_legal_reference("convenio-es-nl-1971:art-11")
