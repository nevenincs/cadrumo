...
_DOCS = (
    CommandDoc(
        ...
        description="Run `cadrumo app modelo work calculate`.",
    ...
    CommandDoc(
        ...
        description="Run `cadrumo app ledger add`.",
    ...
    CommandDoc(
        ...
        description="Run `cadrumo app modelo export`.",
...
def test_key_tier_outranks_the_same_token_in_the_help_tier() -> None:
    ...
    docs = (
        CommandDoc(
            ...
            description="Run `cadrumo app widget run`.",
        ...
        CommandDoc(
            ...
            description="Run `cadrumo app other thing`.",
