...
def test_catalogue_lookup_returns_canonical_record() -> None:
    entry = profile_key("identity.tax_id")
...
def test_spouse_tax_id_is_conditionally_required_for_joint_taxation() -> None:
    ...
    """
    entry = profile_key("renta_spouse.tax_id")
...
def test_renta_family_profile_keys_cover_official_scalar_family_fields() -> None:
    ...
    assert profile_key("renta_spouse.eu_eea_resident").required_when_key is None
    assert profile_key("renta_spouse.eu_eea_country").required_when_key == "renta_spouse.eu_eea_resident"
    assert profile_key("renta_spouse.eu_eea_country").required_when_value == "true"
