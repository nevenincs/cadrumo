...
from ._record_storage import default_bucket_event_history_repository
...
def _last_fact_per_merge_key(facts: tuple[UserProfileFact, ...]) -> tuple[UserProfileFact, ...]:
    ...
    :meth:`ProfileRecordLifecycle._merge_facts` keys on
...
class ProfileRecordLifecycle:
    ...
    def __init__(
        ...
        *,
        ...
        self._events = events or default_bucket_event_history_repository()
...
__all__ = ["ProfileRecordLifecycle"]
