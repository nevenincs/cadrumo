    ...
    *,
    ...
    with active_profile_storage_span(settings, operator_scope_ports=operator_scope_ports) as bucket_id:
        ...
        with auth_mutation_span(
            ...
            active_bucket_id = _gate_active_bucket(operation=operation)
            from ..workflow.persistence import workflow_state_repository
...
def register_operator_certificate_source(
    *,
    ...
    with _certificate_mutation_span(operation=operation, operator_scope_ports=operator_scope_ports) as active_bucket_id:
        _persist_with_event(
