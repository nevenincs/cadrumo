...
This focused public module owns the authentication sub-projection used by
:mod:`cadrumo.application.state_projection`. It derives redacted, fail-closed
readiness from either an active-auth snapshot or direct state.
"""
