...
def test_create_mints_a_fresh_id_for_an_unused_label(_backend: Path) -> None:
...
def test_create_refuses_a_label_already_bound_to_a_committed_capsule(_backend: Path) -> None:
...
def test_create_refuses_a_taken_label_case_insensitively(_backend: Path) -> None:
...
def test_edit_resolves_a_registered_label_to_its_committed_bucket(_backend: Path) -> None:
...
def test_edit_refuses_an_unregistered_label(_backend: Path) -> None:
