...
:func:`~cadrumo.application.ledger._llm_classification.suggest_evidence_split` to
:func:`~cadrumo.application.ledger._actions_split_merge.split_transaction`, whose
...
def derive_child_amounts(gross: Decimal, proportions: Sequence[Decimal]) -> tuple[Decimal, ...]:
    ...
    (:func:`~cadrumo.application.ledger._llm_classification.suggest_evidence_split`)
    surfaces that verdict for review and never drives a one-way split through
    :func:`~cadrumo.application.ledger._actions_split_merge.split_transaction`;
    :func:`~cadrumo.application.ledger._llm_classification.apply_evidence_split`
