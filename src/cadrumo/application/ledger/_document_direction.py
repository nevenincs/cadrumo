...
counterparty us", and :func:`~application.ledger.resolve_counterparty_identity`
...
:func:`~application.ledger.party_regions` -- the same heading partition the
...
from ._grounding_anchor import printed_excerpt_occurs_in_text
from ._party_attribution import party_addresses
from ._party_colocation import party_regions
...
:func:`~application.ledger.party_addresses` declares, so a party table that grew
