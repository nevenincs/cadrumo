...
_LAZY_EXPORTS: dict[str, str] = {
    ...
    "LLMClassificationSuggestion": "._llm_classification",
    "LLMProvider": "._llm_classification",
    "LLMProviderAvailability": "._llm_classification",
    "LLMSaturatedSuggestion": "._llm_classification",
    "LLMSplitApplyResult": "._llm_classification",
    "LLMSplitChildSuggestion": "._llm_classification",
    "LLMSplitSuggestion": "._llm_classification",
    "LLMSuggestionRejectionResult": "._llm_classification",
    ...
    "available_llm_providers": "._llm_classification",
    ...
    "is_llm_provider_available": "._llm_classification",
