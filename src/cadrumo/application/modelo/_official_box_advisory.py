...
:class:`~cadrumo.application.aggregation.source_mesh.CalculationSourceDiagnostic` on the
...
def collect_official_box_unpopulated_diagnostics(
    ...
    :class:`~cadrumo.application.aggregation.source_mesh.CalculationSourceDiagnostic` with
