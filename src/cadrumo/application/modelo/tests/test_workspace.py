...
#: The zero-remnant fixed point for these forbidden private paths (``_workspace``,
#: ``_workspace_projection``) is scanned across ``src``, ``docs`` and ``dev``
#: together and lives in the development test tree:
#: ``test_workspace_assembly_forbidden_paths.py``.
