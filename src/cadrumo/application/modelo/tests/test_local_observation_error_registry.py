...
def test_modelo_local_observation_error_is_registered_and_envelopes() -> None:
    ...
    assert code.default_suggestion == "cadrumo app modelo filing-record observe-local --help"
    ...
    assert envelope.suggestion == "cadrumo app modelo filing-record observe-local --help"
