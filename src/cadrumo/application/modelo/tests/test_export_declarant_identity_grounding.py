...
from .._export import _grounded_identity_requirements
...
def test_a_single_missing_identity_field_renders_as_its_label() -> None:
    rendered = _grounded_identity_requirements([_LEGAL_NAME_PATH])
...
def test_several_missing_identity_fields_all_appear() -> None:
    ...
    rendered = _grounded_identity_requirements([_SURNAMES_PATH, _NAME_PATH])
