...
_UNADJUDICATED: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        ("application/user_profile/bundle.py", "_build_secure_object_custody_payload"),
        ("application/user_profile/bundle.py", "_import_calculation_revisions"),
        ("application/user_profile/bundle.py", "_import_filing_records"),
        ("application/user_profile/bundle.py", "_import_ledger_transactions"),
        ("application/user_profile/bundle.py", "_import_work_units"),
        ("application/user_profile/bundle.py", "register_imported_profile_bundle"),
        ("application/user_profile/bundle.py", "serialize_profile_bundle"),
