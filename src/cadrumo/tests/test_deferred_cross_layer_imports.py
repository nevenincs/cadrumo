...
_UNADJUDICATED: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        ("application/ledger/_actions_common.py", "_verify_attachment_references"),
        ...
        ("application/ledger/_actions_manual.py", "_record_attachment_back_references"),
        ("application/ledger/_batch_ingest.py", "_reads_without_a_model"),
        ("application/ledger/_evidence_input.py", "_reject_unreadable_bytes"),
        ("application/ledger/_evidence_input.py", "document_shape"),
        ("application/ledger/_llm_classification.py", "_record_injected_classifier_run"),
        ("application/ledger/_review_projection.py", "_bucket_event_repository"),
        ("application/live/__init__.py", "capture_justificante_snapshot_outcome"),
        ("application/live/__init__.py", "capture_notifications"),
        ("application/live/__init__.py", "pull_censal_datos"),
        ("application/live/_errors.py", "_classify_clave_movil_timeout"),
        ("application/live/_errors.py", "_classify_sede_error"),
        ("application/live/_errors.py", "classify_live_iva_acquisition_failure"),
        ("application/live/_iva_remote_state.py", "_active_profile_storage_span"),
        ("application/live/_justificante.py", "parse_capture_to_justificante"),
        ("application/live/_justificante.py", "register_capture_as_filing_evidence"),
        ("application/live/_justificante.py", "register_capture_justificante_metadata"),
        ("application/live/_justificante.py", "stamp_capture_evidence_if_filed"),
        ...
        ("application/modelo/_reconcile.py", "_filed_revision_for_work_unit"),
        ("application/modelo/_reconcile.py", "_finalise_reconciliation"),
        ("application/modelo/_reconcile.py", "_reconcile_parsed_declaracion"),
        ("application/modelo/_reconcile.py", "_reconcile_parsed_justificante"),
        ("application/modelo/_reconcile.py", "_require_declaration_enrolled_modelo"),
        ("application/modelo/_reconcile.py", "modelo_reconcile"),
        ("application/modelo/_reconcile.py", "modelo_reconcile_bytes"),
        ...
        ("application/user_profile/_bundle.py", "_build_secure_object_custody_payload"),
        ("application/user_profile/_bundle.py", "_import_calculation_revisions"),
        ("application/user_profile/_bundle.py", "_import_filing_records"),
        ("application/user_profile/_bundle.py", "_import_ledger_transactions"),
        ("application/user_profile/_bundle.py", "_import_work_units"),
        ("application/user_profile/_bundle.py", "register_imported_profile_bundle"),
        ("application/user_profile/_bundle.py", "serialize_profile_bundle"),
        ("application/user_profile/_capabilities.py", "_active_profile_record"),
        ("application/user_profile/_custody.py", "_reconcile_active_profile_recovery_flag"),
        ("application/user_profile/_language_resolver.py", "resolve_active_profile_output_language"),
        ("application/user_profile/_language_resolver.py", "resolve_profile_output_language_hint"),
        ("application/user_profile/_login_session.py", "_authenticate_or_record_failure"),
        ("application/user_profile/_login_session.py", "_mint_or_warn"),
        ("application/user_profile/_login_session.py", "_persist_advanced_idle_deadline"),
        ("application/user_profile/_login_session.py", "_resume_for_idempotent_login"),
        ("application/user_profile/_login_session.py", "login_profile"),
        ("application/user_profile/_login_session.py", "resume_active_profile_session"),
        ("application/user_profile/_orchestration.py", "_append_profile_activated_event"),
        ("application/user_profile/_orchestration.py", "_profile_export_runtime"),
        ("application/user_profile/_orchestration.py", "build_lifecycle_service"),
        ("application/user_profile/_orchestration.py", "logout_active_profile"),
        ("application/user_profile/_orchestration.py", "profile_create_storage_span"),
        ("application/user_profile/_orchestration.py", "profile_storage_session"),
        ("application/user_profile/_orchestration.py", "remove_profile_bucket_directory"),
        ("application/user_profile/_repository.py", "_output_language_is_already_current"),
        ("application/user_profile/_repository.py", "_refresh_output_language_hint"),
        ("application/user_profile/_repository.py", "_secure_objects_for_bucket"),
