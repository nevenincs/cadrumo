...
_MODULE_LINE_LIMIT_OVERRIDES = {
    ...
    "src/aeat/application/aggregation/_iva_ledger.py": 1617,  # SPLIT-CANDIDATE
    "src/aeat/application/wizard/_commands.py": 1339,  # SPLIT-CANDIDATE
    ...
    "src/aeat/domain/calculations/registry/_ledger_bindings.py": 1440,  # SPLIT-CANDIDATE
    "src/aeat/domain/calculations/registry/tests/test_modelo_100_registry_roles.py": 1373,  # SPLIT-CANDIDATE
    "src/aeat/domain/transactions/_models.py": 1419,  # SPLIT-CANDIDATE
    "src/aeat/entrypoints/cli/_config/__init__.py": 1261,  # SPLIT-CANDIDATE
}
_CALLABLE_LINE_LIMIT_OVERRIDES = {
    ...
    ("src/aeat/entrypoints/cli/_ledger.py", "ledger_add"): 238,  # SPLIT-CANDIDATE
    ("src/aeat/application/aggregation/_iva_ledger.py", "_classify_iva_transaction"): 208,  # SPLIT-CANDIDATE
    ...
    ("src/aeat/entrypoints/mcp/_server.py", "build_server"): 512,  # SPLIT-CANDIDATE
    ("src/aeat/entrypoints/mcp/_server.py", "_call_tool"): 209,  # SPLIT-CANDIDATE
}
