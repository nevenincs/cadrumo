...
status pages. The scrubbed fixture corpus lives under
`src/cadrumo/tests/fixtures/aeat-pages/`.
...
4. Save under `src/cadrumo/tests/fixtures/aeat-pages/<surface>/<name>.html`.
