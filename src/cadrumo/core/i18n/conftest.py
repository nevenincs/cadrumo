...
from .render import I18N_STRICT_MISSING_KEYS, I18N_STRICT_PLACEHOLDERS


@pytest.fixture(autouse=True)
def strict_i18n_placeholders() -> Generator[None]:
    """Activate strict-placeholder mode for the duration of each test."""
    token = I18N_STRICT_PLACEHOLDERS.set(True)
    yield
    I18N_STRICT_PLACEHOLDERS.reset(token)


@pytest.fixture(autouse=True)
def strict_i18n_missing_keys() -> Generator[None]:
