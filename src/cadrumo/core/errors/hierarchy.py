"""The Cadrumo exception hierarchy, and the site-health shapes beside it.

Every refusal in the application descends from :class:`CadrumoError`, so this
module is the root of the error tree rather than a collection of unrelated
classes. It deliberately imports nothing from the error-code registry: the
registry knows about the hierarchy, not the other way round, and keeping the
...
class CadrumoError(Exception):
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        ...
        from .error_codes import bind_error_code
    ...
    def __init__(
        ...
        *,
        ...
        (:mod:`core.errors.error_codes`) falls through to the registry
