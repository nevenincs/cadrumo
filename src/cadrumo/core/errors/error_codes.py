...
:class:`core.errors.hierarchy.CadrumoError` subclass binds to a predeclared
...
class ErrorCode(BaseModel):
    """Stable metadata attached to an :class:`core.errors.hierarchy.CadrumoError` type."""
...
def _stringify_context_value(value: object) -> str:
    ...
    :class:`core.errors.hierarchy.CadrumoError` subclass can — accidentally or
