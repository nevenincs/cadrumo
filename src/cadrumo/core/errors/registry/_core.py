"""Core-layer :class:`~core.errors.error_codes.ErrorCode` registry declarations.
...
DECLARED_ERROR_CODES: tuple[tuple[str, ErrorCode], ...] = (
    ...
    (
        "cadrumo.core.i18n.render.MissingTranslationError",
        ErrorCode(
    ...
    (
        "cadrumo.core.i18n.render.UnmatchedPlaceholderError",
        ErrorCode(
