...
_DECLARED_ERROR_CODES: tuple[tuple[str, ErrorCode], ...] = (
    ...
    (
        ...
        ErrorCode(
            ...
            default_suggestion="aeat app live filed discover && aeat app live filed pull-all",
            retryable=False,
            runbook_id=None,
        ),
    ),
    ...
    (
        ...
        ErrorCode(
            ...
            default_suggestion="aeat config reset status",
            retryable=True,
            runbook_id=None,
        ),
    ),
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.ERROR,
            message_key="errors.error.error_config_boundary",
            default_suggestion="aeat config reset resume --yes",
            retryable=False,
            runbook_id=None,
        ),
    ),
