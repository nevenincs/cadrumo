...
``CADRUMO_DATABASE_URL`` leaves the effective :class:`~core.config.StorageRouteKind`
...
EXPLICIT_DATABASE_URL_PROFILE_RECOVERY = (
    "Unset CADRUMO_DATABASE_URL before profile setup or profile-bound writes; "
    "use CADRUMO_LOCAL_STORAGE_ROOT to choose the local storage root, then create "
