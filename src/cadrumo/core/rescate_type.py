...
:func:`~domain.modelos.dt12_reduccion.compute_dt12_reduccion_plan_pensiones`). It changes
...
:func:`application.modelo.calculate_input.apply_calculation_shortcut_inputs`.
"""
