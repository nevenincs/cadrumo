...
class IvaCategory(str):
    """Opaque IVA-category token projected from the facts authority."""
...
class IvaCashAccountingTreatment(str):
    """Opaque registry-projected IVA cash-accounting treatment token.

    Treatment membership and legal semantics are selected from fact 0098;
    this type retains only the stable token shape.
    """
...
class IvaRateKind(str):
    """Opaque registry-projected IVA rate-tier token."""
