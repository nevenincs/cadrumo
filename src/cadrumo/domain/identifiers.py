"""Canonical shared validating identifiers and hash-payload primitives.
...
registry or in the closed :class:`core.modelo.Modelo` enum. Callers that need a
...
class ModeloIdentifier(str):
    ...
    registry or the closed :class:`core.modelo.Modelo` enum.
    """

    __slots__ = ()

    def __new__(cls, value: str) -> ModeloIdentifier:
        """Validate and construct a modelo identifier."""
