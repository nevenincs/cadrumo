...
def compute_sal_reserva_especial_dotacion(
    *,
    ...
    capital social. Once the accumulated reserva is already strictly above
    twice (2x) the capital social, the dotacion is zero. The result is rounded
    to 2 decimal places (money-2).
