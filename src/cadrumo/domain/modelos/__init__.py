...
_LAZY_EXPORTS: dict[str, str] = {
    ...
    "Modelo036LifecycleError": ".errors",
    "Modelo036PriorAltaRequiredError": ".errors",
    "Modelo036TerminalStateError": ".errors",
    ...
    "raise_catalogue_integrity_error": ".errors",
