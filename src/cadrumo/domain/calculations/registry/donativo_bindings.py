...
:mod:`domain.calculations.registry.detail_record_bindings`): a typed
...
def _validate_donativo_row_field(
    ...
    enforce (:func:`domain.calculations.registry.detail_record_bindings._validate_detail_record_row_field`):
