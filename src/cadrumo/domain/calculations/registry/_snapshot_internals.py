"""Snapshot construction internals for the registry authority.

The construction contract lives in :mod:`snapshot`; everything here is the
machinery behind it, kept private so a caller outside this package cannot bind
to a validation step or a cache the contract does not promise.
"""
