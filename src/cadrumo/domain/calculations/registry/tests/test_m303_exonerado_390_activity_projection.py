...
def _evidence(*, operaciones_terceros: bool = True) -> M303Exonerado390FilingEvidence:
...
def test_applicable_evidence_refuses_a_missing_modelo_347_reference() -> None:
...
def test_projection_identity_never_uses_json_serialisation() -> None:
    from .. import _m303_exonerado_390_projection as module
