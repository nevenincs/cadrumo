...
from ..authority import reset_registry_caches
from ..facts import providers as provider_module
from ..facts.providers import FACT_PROVIDER_REGISTRATIONS, compile_registered_fact_providers
...
def test_authority_reset_invokes_every_wave2_provider_reset(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(authority_module, "_invalidate_authority_generations", lambda: None)
