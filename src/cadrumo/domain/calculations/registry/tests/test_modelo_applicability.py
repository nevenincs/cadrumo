...
from ....deadlines.models import EntityType, FiscalResidency, IVARegime, IrpfEstimationRegime, IrpfIncomeCategory, IrpfSpecialRegime, LegalEntityForm, TaxpayerProfile
