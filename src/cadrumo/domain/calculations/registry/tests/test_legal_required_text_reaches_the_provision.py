...
_HEADING_ONLY_CEILING: Final[int] = 36
...
The tail decides priority. The largest remaining is ``ley-37-1992:art-89``
at 4,836 characters, grounded by a phrase that survives any truncation of it.
...
def test_the_measurement_would_notice_a_body_phrase() -> None:
    ...
    be selected. ``ley-37-1992:art-89`` is the uncorrected side, at 4,836
    ...
    assert "ley-37-1992:art-89" in selected, (
