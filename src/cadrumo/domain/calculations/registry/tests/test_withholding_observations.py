"""Contract tests for Modelo 190 and Modelo 193 withholding observations.

Validates pydantic field constraints and deterministic tipo-2 row builders for
withholding-perceptor detail records.
"""
