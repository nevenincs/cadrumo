...
_MONTHLY_DEADLINES = {
    2022: (
        ("2022-02-21", "2022-02-16"), ("2022-03-21", "2022-03-16"),
        ("2022-04-20", "2022-04-15"), ("2022-05-20", "2022-05-15"),
        ("2022-06-20", "2022-06-15"), ("2022-07-20", "2022-07-15"),
        ("2022-08-22", "2022-08-17"), ("2022-09-20", "2022-09-15"),
        ("2022-10-20", "2022-10-15"), ("2022-11-21", "2022-11-16"),
        ("2022-12-20", "2022-12-15"), ("2023-01-20", "2023-01-15"),
    ),
    2023: (
        ("2023-02-20", "2023-02-15"), ("2023-03-20", "2023-03-15"),
        ("2023-04-20", "2023-04-15"), ("2023-05-22", "2023-05-17"),
        ("2023-06-20", "2023-06-15"), ("2023-07-20", "2023-07-15"),
        ("2023-08-21", "2023-08-16"), ("2023-09-20", "2023-09-15"),
        ("2023-10-20", "2023-10-15"), ("2023-11-20", "2023-11-15"),
        ("2023-12-20", "2023-12-15"), ("2024-01-22", "2024-01-17"),
    ),
    2024: (
        ("2024-02-20", "2024-02-15"), ("2024-03-20", "2024-03-15"),
        ("2024-04-22", "2024-04-17"), ("2024-05-20", "2024-05-15"),
        ("2024-06-20", "2024-06-17"), ("2024-07-22", "2024-07-17"),
        ("2024-08-20", "2024-08-15"), ("2024-09-20", "2024-09-17"),
        ("2024-10-21", "2024-10-16"), ("2024-11-20", "2024-11-15"),
        ("2024-12-20", "2024-12-17"), ("2025-01-20", "2025-01-15"),
    ),
    2025: (
        ("2025-02-20", "2025-02-17"), ("2025-03-20", "2025-03-17"),
        ("2025-04-21", "2025-04-15"), ("2025-05-20", "2025-05-15"),
        ("2025-06-20", "2025-06-17"), ("2025-07-21", "2025-07-16"),
        ("2025-08-20", "2025-08-15"), ("2025-09-22", "2025-09-17"),
        ("2025-10-20", "2025-10-15"), ("2025-11-20", "2025-11-17"),
        ("2025-12-22", "2025-12-17"), ("2026-01-20", "2026-01-15"),
    ),
    2026: (
        ("2026-02-20", "2026-02-17"), ("2026-03-20", "2026-03-16"),
        ("2026-04-20", "2026-04-15"), ("2026-05-20", "2026-05-15"),
        ("2026-06-22", "2026-06-17"), ("2026-07-20", "2026-07-15"),
        ("2026-08-20", "2026-08-17"), ("2026-09-21", "2026-09-16"),
        ("2026-10-20", "2026-10-15"), ("2026-11-20", "2026-11-17"),
        ("2026-12-21", "2026-12-16"), ("2027-01-20", None),
    ),
}
...
def test_modelo_111_supported_year_deadline_census_dates_sources_and_ownership(
    ...
    for filing_year in range(2022, 2027):
        ...
        expected = {
            **{
                f"{month:02d}": values
                for month, values in enumerate(_MONTHLY_DEADLINES[filing_year], start=1)
            },
            **{
                f"{quarter}T": values
                for quarter, values in enumerate(_QUARTERLY_DEADLINES[filing_year], start=1)
            },
        }
