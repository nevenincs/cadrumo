...
def _declared_trabajo_inputs() -> dict[CasillaId, Decimal]:
    ...
    the deducible Seguridad Social and the discapacidad reduccion that the scenario
    actually consumes. Each locator points at the line stating the figure the
