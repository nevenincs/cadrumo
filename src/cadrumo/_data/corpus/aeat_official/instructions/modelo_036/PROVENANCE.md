...
| ---- | ----- | -------- | ---- |
| `aeat-modelo-036-procedure.html` | 36079 | 2026-05-08 | AEAT Sede HTML — procedure landing |
| `files/anexo-03-instrucciones-modelo-036.html` | 10007 | 2026-05-27 | AEAT Sede HTML — anexo 3 index |
| `files/instrucciones-cumplimentacion-pagina-1.html` | 17271 | 2026-05-27 | AEAT Sede HTML — cumplimentación page 1 |
| `files/presentacion-papel-modelo-036.html` | 31296 | 2026-05-27 | AEAT Sede HTML — paper presentation |
| `files/Folleto_Censos.pdf` | 245570 | 2026-05-27 | AEAT PDF — folleto censos |
| `files/Folleto_Censos.pdf.extracted.json` | — | 2026-05-27 | Extracted machine-readable text from the AEAT PDF |
| `files/Folleto_Censos.pdf.extracted.md` | — | 2026-05-27 | Extracted Markdown text from the AEAT PDF |
