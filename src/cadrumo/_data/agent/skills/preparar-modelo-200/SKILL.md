...
This skill diffs against `preparar-modelo-100` (the other large annual form
with heavy manual/profile-sourced sections and its own under-declaration
advisory) and `preparar-modelo-303` (the shared lifecycle spine). The spine
...
`pyme-sociedad` for the itinerary that sequences Modelo 200 alongside
