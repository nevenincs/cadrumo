"""Layer-3 write-guard for aeat.sede (#239).
...
class TestNoCallContextWriteVerbs:
    """Forbidden verbs must never appear as a call-site in aeat.sede."""
    ...
    def test_verb_never_called(self, verb: str) -> None:
        ...
        assert not offenders, f"Forbidden write verb {verb!r} used in a call context inside aeat.sede:\n" + "\n".join(
            offenders
        )
