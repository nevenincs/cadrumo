...
schema, encoding, envelope, and required-header set are identical
to the 2024 variant. Keeping 2025 as its own module means a future
Orden modifying 303 for 2026+ can publish a DR303e26 fixture, be
regenerated into its own module, and leave 2024-period exports
byte-identical.

The separate CLI registry entry also makes year-stamped filename
routing explicit: ``X1234567L20253T.303`` is Kent's Q3 2025
filing, not a misdirected 2024 artefact.
"""
