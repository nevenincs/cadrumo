...
3. ``python -m aeat.submission._formats._generate <json> <out.py>``
...
def generate_module_source(
    ...
    *,
    ...
    provenance_lines: list[str] = [
        f"Generated by aeat.submission._formats._generate on {stamp}.",
        "",
...
def _main() -> None:
    """CLI: ``python -m aeat.submission._formats._generate <json> <out.py>``."""
    import argparse
