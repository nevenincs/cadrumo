...
from ....persistence.storage.errors import ClassificationError
from ._models import (
    SubmissionAttempt,
    SubmissionStatus,
    SubmittedFiling,
...
class TestClassificationGate:
    ...
    def test_foreign_class_envelope_refused(self, store_dir: Path) -> None:
        from ....persistence.storage import Envelope, SensitivityClass, save_encrypted_envelope
        from ....persistence.storage._encrypted_columns import _resolve_master_key_provider
...
class TestMigrationLockedPerSubmission:
    ...
    def test_migration_blocked_by_held_lock(self, store_dir: Path, tmp_path: Path) -> None:
        from ....persistence.storage import exclusive_file_lock
