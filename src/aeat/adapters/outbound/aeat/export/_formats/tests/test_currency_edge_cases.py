...
class TestUnsignedCurrency13Byte:
    ...
    def test_round_trip_text(self) -> None:
        ...
        for value, expected_text in cases:
            encoded = encode_currency(value, length=13, encoding="cp1252")
            assert encoded == expected_text.encode("cp1252"), value
...
class TestUnsignedCurrency17Byte:
    ...
    def test_round_trip_text(self) -> None:
        ...
        for value, expected_text in cases:
            ...
            assert encoded == expected_text.encode(ISO_8859_1_ENCODING), value
