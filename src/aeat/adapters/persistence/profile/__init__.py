...
* :mod:`aeat.adapters.persistence.profile.assets` for the FINANCIAL secure-object
  actividad-económica asset and amortización ledgers.
* :mod:`aeat.adapters.persistence.profile.inventory` for FINANCIAL secure-object
  stock-valuation ledgers.
* :mod:`aeat.adapters.persistence.profile.bienes_inversion` for the FINANCIAL
  secure-object :class:`~aeat.domain.bienes_inversion.BienesInversionIvaRegister`.
* :mod:`aeat.adapters.persistence.profile.fincas` for ORM-backed finca,
