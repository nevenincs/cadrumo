...
def test_canonical_decimal_strips_trailing_zeros_from_non_zero_values() -> None:
    ...
    assert canonical_decimal(Decimal("1.0")) == "1"
    assert canonical_decimal(Decimal("1.50")) == "1.5"
    assert canonical_decimal(Decimal("-42.100")) == "-42.1"
...
def test_canonical_decimal_preserves_small_magnitudes_without_exponent() -> None:
    ...
    assert canonical_decimal(Decimal("0.000000001")) == "0.000000001"
...
def test_canonical_decimal_preserves_large_integers_without_exponent() -> None:
    ...
    assert canonical_decimal(Decimal("1234567890")) == "1234567890"
