...
def _run_engine(inputs: dict[str, Decimal], year: int, period: str) -> dict[str, Decimal]:
...
def test_m303_engine_sums_extracted_primitives_not_printed_total() -> None:
    ...
    primitive = extracted.get("iva.repercutido.general")
