"""Cover Modelo 100 Anexo D (actividades económicas) for the 2026 ejercicio.

Exercises the three régimenes — E.D. normal, E.D. simplificada, and
módulos — against the 2026 ruleset. Worked examples are externally
...
class TestModelo100AnexoDNormal:
    """Audit Anexo D régimen E.D. normal against the 2026 ruleset."""
...
class TestModelo100AnexoDSimplificada:
    """Audit Anexo D régimen E.D. simplificada against the 2026 ruleset."""
...
class TestModelo100AnexoDModulos:
    """Audit Anexo D régimen módulos against the 2026 ruleset."""
