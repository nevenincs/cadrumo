"""Unit tests for Modelo 100 Anexo N — deducciones autonómicas (ejercicio 2024).

Exercises the per-CCAA deducción aggregation chain feeding casilla
``0622`` of :data:`aeat.domain.formulas._rulesets.MODELO_100_2024`,
anchored to LIRPF art. 46 bis and the AEAT manual práctico Renta 2024
