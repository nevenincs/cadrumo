"""Cover Modelo 100 Anexo D (actividades económicas) for the 2025 ejercicio.

Exercises the three régimenes — E.D. normal, E.D. simplificada, and
módulos — against the 2025 ruleset. Worked examples are externally
...
def _baseline_zero_other_anexos() -> dict[str, Decimal]:
    ...
    Casilla 0021 (LIRPF art. 20 reducción del trabajo) is held at
...
class TestModelo100AnexoDNormal:
    """Audit Anexo D régimen E.D. normal against the 2025 ruleset."""
...
class TestModelo100AnexoDSimplificada:
    """Audit Anexo D régimen E.D. simplificada against the 2025 ruleset."""
...
class TestModelo100AnexoDModulos:
    """Audit Anexo D régimen módulos against the 2025 ruleset."""
