...
FORMULAS = (
    formula(
        casilla_id="0220",
        formula_id="modelo_100.2026.d_simplificada.rendimiento_neto_pre_cap",
        body=clamp_pos(sub_op(ref("0210"), ref("0215"))),
    ),
    formula(
        casilla_id="0225",
        formula_id="modelo_100.2026.d_simplificada.gastos_dificil_justificacion",
        body=_GASTOS_DIFICIL_BODY,
    ),
    formula(
        casilla_id="0230",
        formula_id="modelo_100.2026.d_simplificada.rendimiento_neto_previo",
        body=clamp_pos(sub_op(ref("0220"), ref("0225"))),
    ),
    formula(
        casilla_id="0240",
        formula_id="modelo_100.2026.d_simplificada.rendimiento_neto_reducido",
