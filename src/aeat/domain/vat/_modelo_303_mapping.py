...
classifier (:func:`aeat.domain.vat.classify_vat`) and the
...
The casilla layout matches the :mod:`aeat.domain.formulas` Modelo 303
rulesets, which cover casillas 01-09, 28-45, 64-71. Categories whose contributions
