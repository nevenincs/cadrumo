"""Public surface for the content-addressed attachment service.
...
Callers must import attachment types, errors, and helpers exclusively from
``aeat.financial.attachments`` and must not reach into the private
underscored modules inside this package.
"""
