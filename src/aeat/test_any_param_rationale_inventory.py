...
_KNOWN_VIOLATING_LINES: frozenset[tuple[str, int]] = frozenset(
    {
        ...
        ("application/live/_borrador_100.py", 310),
        ("application/live/_borrador_100.py", 319),
        ("application/live/_censo.py", 400),
        ("application/live/_expedientes.py", 160),
        ("application/live/_notifications.py", 175),
        ("application/live/_snapshot_base.py", 214),
        ("application/live/_snapshot_base.py", 239),
        ("application/live/_snapshot_base.py", 349),
        ("application/live/_snapshot_base.py", 353),
