...
Every error raised from :mod:`aeat.models` derives from
...
class ModeloRegistryError(AeatError):
    """Base class for every error raised from :mod:`aeat.models`."""
...
class RegistryIntegrityError(ModeloRegistryError):
    ...
    :func:`aeat.models._registry._finalise_registry` and therefore
