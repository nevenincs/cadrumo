...
_DECLARED_ERROR_CODES: tuple[tuple[str, ErrorCode], ...] = (
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.REFUSED,
            default_message_es="La confirmacion de envio en vivo fue rechazada.",
            default_message_en="Raised when the operator does not type the exact live-submit phrase.",
            default_message_hu="Az elo bekuldes megerositese el lett utasitva.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.REFUSED,
            default_message_es="El envio en vivo de AEAT no esta habilitado.",
            default_message_en="Raised when the live-submit env gate is not enabled.",
            default_message_hu="Az AEAT elo bekuldes nincs engedelyezve.",
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.REFUSED,
            default_message_es="El transporte de envio en vivo no esta disponible.",
            default_message_en="Raised when a live write is requested on a stubbed transport.",
            default_message_hu="Az AEAT elo atviteli csatorna nem erheto el.",
            default_suggestion="aeat submission preflight",
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.REFUSED,
            default_message_es="Pytest rechazo una escritura en vivo de AEAT.",
            default_message_en="Raised when pytest reaches a live-capable submission call.",
            default_message_hu="A pytest elutasitotta az AEAT elo irasi hivast.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
