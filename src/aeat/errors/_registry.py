...
_DECLARED_ERROR_CODES: tuple[tuple[str, ErrorCode], ...] = (
    ...
    (
        "aeat.storage.errors.DecryptionError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.EncryptionError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.EnvelopeVersionError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.KeyDerivationError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.NonceCollisionError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.PathContainmentError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.PersistenceError",
        ErrorCode(
    ...
    (
        ...
        ErrorCode(
            ...
            default_message_en="Live AEAT submission is not enabled.",
    ...
    (
        ...
        ErrorCode(
            ...
            default_message_en="The live AEAT submission transport is unavailable.",
