...
_DECLARED_ERROR_CODES: tuple[tuple[str, ErrorCode], ...] = (
    (
        "aeat._pdf_import._errors.PdfFilingImportError",
        ErrorCode(
    ...
    (
        "aeat._pdf_import._scrub.ScrubError",
        ErrorCode(
    ...
    (
        "aeat.auth._authenticator._PersistedSessionInvalidError",
        ErrorCode(
            code="AUTH_AUTH_AUTHENTICATOR_PERSISTED_SESSION_INVALID",
            category=ErrorCategory.AUTH,
            default_message_es="Error de   persisted sesion invalid.",
            default_message_en="Raised when a persisted AEAT browser session cannot be trusted.",
            default_message_hu="  persisted munkamenet invalid hiba.",
            default_suggestion=None,
            retryable=True,
            runbook_id=None,
        ),
    ...
    (
        "aeat.auth._clave_movil.ClaveMovilApprovalTimeoutError",
        ErrorCode(
            code="AUTH_AUTH_CLAVE_MOVIL_CLAVE_MOVIL_APPROVAL_TIMEOUT",
            category=ErrorCategory.AUTH,
            default_message_es="Clave movil aprobacion agoto el tiempo de espera.",
    ...
    (
        "aeat.auth._clave_movil.ClaveMovilConfigurationError",
        ErrorCode(
    ...
    (
        "aeat.auth.certificate.AeatLiveReadNotEnabledError",
        ErrorCode(
            code="AUTH_AUTH_CERTIFICATE_AEAT_LIVE_READ_NOT_ENABLED",
            category=ErrorCategory.AUTH,
            default_message_es="Error de aeat en vivo read no enabled.",
            default_message_en="Raised when live-read access is required but the gate is shut.",
            default_message_hu="Aeat elo read nem enabled hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.auth.certificate.AeatLoginAssertionError",
        ErrorCode(
            code="AUTH_AUTH_CERTIFICATE_AEAT_LOGIN_ASSERTION",
            category=ErrorCategory.AUTH,
            default_message_es="Error de aeat inicio de sesion assertion.",
            default_message_en="Raised when a post-auth verification attempt cannot be produced.",
            default_message_hu="Aeat bejelentkezes assertion hiba.",
    ...
    (
        "aeat.auth.certificate.AeatSessionExpiredError",
        ErrorCode(
    ...
    (
        "aeat.auth.certificate.CertificateError",
        ErrorCode(
    ...
    (
        "aeat.auth.certificate.CertificateExpiredError",
        ErrorCode(
            code="AUTH_AUTH_CERTIFICATE_EXPIRED",
            category=ErrorCategory.AUTH,
            default_message_es="Certificado caducado.",
            default_message_en="Raised when a loaded certificate's ``not_after`` is in the past.",
    ...
    (
        "aeat.auth.certificate.CertificateHandshakeError",
        ErrorCode(
    ...
    (
        "aeat.auth.certificate.CertificateLoadError",
        ErrorCode(
    ...
    (
        "aeat.auth.certificate.CertificateNifParseError",
        ErrorCode(
    ...
    (
        "aeat.auth.certificate.CertificatePasswordError",
        ErrorCode(
            code="AUTH_AUTH_CERTIFICATE_PASSWORD",
            category=ErrorCategory.AUTH,
            default_message_es="Error de certificado contrasena.",
    ...
    (
        "aeat.auth.certificate.CertificatePreExpiryError",
        ErrorCode(
    ...
    (
        "aeat.borrador._errors.ArtefactNotRecognisedError",
        ErrorCode(
            code="ERROR_BORRADOR_ARTEFACT_NOT_RECOGNISED",
            category=ErrorCategory.ERROR,
            default_message_es="Error de artefacto no recognised.",
            default_message_en="Raised when the PDF does not match any known Modelo 100 artefact shape.",
            default_message_hu="Artefaktum nem recognised hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.borrador._errors.BorradorParseError",
        ErrorCode(
            code="FAIL_BORRADOR_PARSE",
            category=ErrorCategory.FAIL,
            default_message_es="No se pudo analizar borrador.",
            default_message_en="Raised when a Modelo 100 PDF cannot be parsed into a :class:`BorradorFiling`.",
    ...
    (
        "aeat.browser.session.BrowserError",
        ErrorCode(
    ...
    (
        "aeat.casillas.errors.CasillaError",
        ErrorCode(
            code="ERROR_CASILLAS_CASILLA",
            category=ErrorCategory.ERROR,
            default_message_es="Error de casilla.",
            default_message_en="Base class for every error raised by :mod:`aeat.",
    ...
    (
        "aeat.casillas.errors.CasillaParseError",
        ErrorCode(
    ...
    (
        "aeat.casillas.errors.CrossReferenceError",
        ErrorCode(
    ...
    (
        "aeat.casillas.errors.MissingFieldError",
        ErrorCode(
    ...
    (
        "aeat.casillas.errors.UnreviewedRecordError",
        ErrorCode(
    ...
    (
        "aeat.casillas.errors.VerifyError",
        ErrorCode(
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.AUTH,
            default_message_es="Error de no configured proveedor.",
            default_message_en="No auth provider is configured and no default was specified.",
            default_message_hu="No configured szolgaltato hiba.",
    ...
    (
        "aeat.cli.auth._registry.ProviderNotImplementedError",
        ErrorCode(
            code="AUTH_CLI_AUTH_REGISTRY_PROVIDER_NOT_IMPLEMENTED",
            category=ErrorCategory.AUTH,
            default_message_es="Error de proveedor no implemented.",
            default_message_en="The provider kind is known but no implementation has shipped yet.",
            default_message_hu="Szolgaltato nem implemented hiba.",
    ...
    (
        "aeat.cli.auth._registry.UnknownProviderError",
        ErrorCode(
    ...
    (
        "aeat.cli.auth._session.CorruptAuthSessionError",
        ErrorCode(
    ...
    (
        "aeat.deadlines._errors.DeadlineError",
        ErrorCode(
    ...
    (
        "aeat.deadlines._errors.ProfileError",
        ErrorCode(
            code="ERROR_DEADLINES_PROFILE",
            category=ErrorCategory.ERROR,
            default_message_es="Error de perfil.",
            default_message_en="Raised when an :class:`AutonomoProfile` cannot be loaded or validated.",
    ...
    (
        "aeat.deadlines._errors.ScheduleComputationError",
        ErrorCode(
            code="ERROR_DEADLINES_SCHEDULE_COMPUTATION",
            category=ErrorCategory.ERROR,
            default_message_es="Error de planificacion calculo.",
            default_message_en="Raised when :meth:`DeadlineEngine.",
    ...
    (
        "aeat.declaracion._errors.DeclaracionParseError",
        ErrorCode(
            code="FAIL_DECLARACION_PARSE",
            category=ErrorCategory.FAIL,
            default_message_es="No se pudo analizar declaracion.",
            default_message_en="Raised when a PDF cannot be parsed into a :class:`DeclaracionFiling`.",
    ...
    (
        "aeat.declaracion._errors.NoExtractorRegisteredError",
        ErrorCode(
            code="ERROR_DECLARACION_NO_EXTRACTOR_REGISTERED",
            category=ErrorCategory.ERROR,
            default_message_es="Error de no extractor registered.",
            default_message_en="Raised when no concrete extractor exists for the detected template.",
            default_message_hu="No kinyero registered hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.declaracion._errors.TemplateNotDetectedError",
        ErrorCode(
            code="ERROR_DECLARACION_TEMPLATE_NOT_DETECTED",
            category=ErrorCategory.ERROR,
            default_message_es="Error de plantilla no detected.",
            default_message_en="Raised when :func:`detect_template_revision` cannot identify the PDF.",
            default_message_hu="Sablon nem detected hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.errors.AeatObservabilityError",
        ErrorCode(
    ...
    (
        "aeat.errors.AmbiguousPeriodError",
        ErrorCode(
    ...
    (
        "aeat.errors.DeprecatedAliasError",
        ErrorCode(
    ...
    (
        "aeat.errors.FilingFixtureError",
        ErrorCode(
    ...
    (
        "aeat.errors.FixtureProvisioningError",
        ErrorCode(
    ...
    (
        "aeat.errors.FormulasError",
        ErrorCode(
            code="ERROR_FORMULAS",
            category=ErrorCategory.ERROR,
            default_message_es="Error de formulas.",
            default_message_en="Base error for the :mod:`aeat.",
    ...
    (
        "aeat.errors.MissingRulesetError",
        ErrorCode(
    ...
    (
        "aeat.errors.RulesetValidationError",
        ErrorCode(
    ...
    (
        "aeat.errors.WorkspaceLockedError",
        ErrorCode(
    ...
    (
        "aeat.filing._errors.FilingAmendmentError",
        ErrorCode(
    ...
    (
        "aeat.filing._errors.FilingAmendmentValidationError",
        ErrorCode(
    ...
    (
        "aeat.filing._errors.FilingBuilderError",
        ErrorCode(
    ...
    (
        "aeat.filing._errors.FilingComputationError",
        ErrorCode(
    ...
    (
        "aeat.filing._errors.FilingDraftError",
        ErrorCode(
            code="ERROR_FILING_DRAFT",
            category=ErrorCategory.ERROR,
            default_message_es="Error de presentacion draft.",
            default_message_en="Base class for every error raised inside :mod:`aeat.",
            default_message_hu="Beadas draft hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.filing._errors.FilingImportError",
        ErrorCode(
    ...
    (
        "aeat.filing._errors.FilingValidationError",
        ErrorCode(
    ...
    (
        "aeat.financial.attachments._errors.AttachmentError",
        ErrorCode(
    ...
    (
        "aeat.financial.attachments._errors.AttachmentNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.financial.attachments._errors.AttachmentPersistenceError",
        ErrorCode(
            code="FAIL_FINANCIAL_ATTACHMENTS_ATTACHMENT_PERSISTENCE",
            category=ErrorCategory.FAIL,
            default_message_es="No se pudo persistir adjunto.",
            default_message_en="Raised when the attachment store cannot read or write bytes or manifests.",
    ...
    (
        "aeat.financial.attachments._errors.AttachmentValidationError",
        ErrorCode(
    ...
    (
        "aeat.financial.invoices._errors.InvoiceCatalogueError",
        ErrorCode(
    ...
    (
        "aeat.financial.invoices._errors.InvoiceError",
        ErrorCode(
    ...
    (
        "aeat.financial.invoices._errors.InvoiceLinkError",
        ErrorCode(
    ...
    (
        "aeat.financial.invoices._errors.InvoiceLinkInconsistencyError",
        ErrorCode(
    ...
    (
        "aeat.financial.invoices._errors.InvoiceNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.financial.invoices._errors.InvoicePersistenceError",
        ErrorCode(
    ...
    (
        "aeat.financial.providers._base.FinancialProviderError",
        ErrorCode(
    ...
    (
        "aeat.financial.providers._base.InvalidFinancialSourceError",
        ErrorCode(
    ...
    (
        "aeat.financial.providers._base.UnsupportedFinancialSourceError",
        ErrorCode(
            code="ERROR_FINANCIAL_PROVIDERS_BASE_UNSUPPORTED_FINANCIAL_SOURCE",
            category=ErrorCategory.ERROR,
            default_message_es="Error de no soportado financiero origen.",
            default_message_en="Raised when no provider can interpret a source document.",
            default_message_hu="Nem tamogatott penzugyi forras hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.financial.transactions._errors.TransactionCatalogueError",
        ErrorCode(
    ...
    (
        "aeat.financial.transactions._errors.TransactionError",
        ErrorCode(
    ...
    (
        "aeat.financial.transactions._errors.TransactionNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.financial.transactions._errors.TransactionPersistenceError",
        ErrorCode(
    ...
    (
        "aeat.financial.usage_ratios._errors.UsageRatioError",
        ErrorCode(
    ...
    (
        "aeat.financial.usage_ratios._errors.UsageRatioPersistenceError",
        ErrorCode(
            code="FAIL_FINANCIAL_USAGE_RATIOS_USAGE_RATIO_PERSISTENCE",
            category=ErrorCategory.FAIL,
            default_message_es="No se pudo persistir uso ratio.",
            default_message_en="Raised when the usage-ratio profile cannot be read or written.",
    ...
    (
        "aeat.financial.vat.errors.VatCatalogueError",
        ErrorCode(
    ...
    (
        "aeat.financial.vat.errors.VatCategoryNotFoundError",
        ErrorCode(
            code="ERROR_FINANCIAL_VAT_CATEGORY_NOT_FOUND",
            category=ErrorCategory.ERROR,
            default_message_es="No se encontro iva category.",
            default_message_en="Raised when a lookup against :data:`VAT_CATALOGUE_2025` misses.",
            default_message_hu="Afa category nem talalhato.",
    ...
    (
        "aeat.financial.vat.errors.VatClassificationError",
        ErrorCode(
            code="ERROR_FINANCIAL_VAT_CLASSIFICATION",
            category=ErrorCategory.ERROR,
            default_message_es="Error de iva clasificacion.",
            default_message_en="Raised when :func:`classify_vat` cannot return a deterministic match.",
    ...
    (
        "aeat.financial.vat.errors.VatError",
        ErrorCode(
            code="ERROR_FINANCIAL_VAT",
            category=ErrorCategory.ERROR,
            default_message_es="Error de iva.",
            default_message_en="Base error for every ``aeat.",
    ...
    (
        "aeat.financial.vat.errors.VatRateNotFoundError",
        ErrorCode(
            code="ERROR_FINANCIAL_VAT_RATE_NOT_FOUND",
            category=ErrorCategory.ERROR,
            default_message_es="No se encontro iva tipo.",
            default_message_en="Raised when ``lookup_rate`` cannot resolve a rate.",
    ...
    (
        "aeat.financial.vat.errors.VatRateOverlapError",
        ErrorCode(
            code="ERROR_FINANCIAL_VAT_RATE_OVERLAP",
            category=ErrorCategory.ERROR,
            default_message_es="Error de iva tipo solapamiento.",
            default_message_en="Raised when two :class:`VATRate` records share an active window.",
    ...
    (
        "aeat.justificante._errors.JustificanteCsvNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.justificante._errors.JustificanteError",
        ErrorCode(
    ...
    (
        "aeat.justificante._errors.JustificanteParseError",
        ErrorCode(
            code="FAIL_JUSTIFICANTE_PARSE",
            category=ErrorCategory.FAIL,
            default_message_es="No se pudo analizar justificante.",
            default_message_en="Raised when a PDF cannot be parsed into a :class:`Justificante`.",
    ...
    (
        "aeat.justificante._errors.JustificanteVerificationError",
        ErrorCode(
    ...
    (
        "aeat.llm._errors.LLMCacheError",
        ErrorCode(
            code="FAIL_LLM_L_M_CACHE",
            category=ErrorCategory.FAIL,
            default_message_es="Error de l l m cache.",
            default_message_en="Raised when a cache entry cannot be read, written, or parsed.",
            default_message_hu="L l m cache hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.llm._errors.LLMError",
        ErrorCode(
            code="FAIL_LLM_L_M",
            category=ErrorCategory.FAIL,
            default_message_es="Error de l l m.",
            default_message_en="Base exception for LLM package failures.",
            default_message_hu="L l m hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.llm._errors.LLMProviderError",
        ErrorCode(
            code="FAIL_LLM_L_M_PROVIDER",
            category=ErrorCategory.FAIL,
            default_message_es="Error de l l m proveedor.",
            default_message_en="Raised when a provider returns an unrecoverable error.",
            default_message_hu="L l m szolgaltato hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.llm._errors.LLMRateLimitError",
        ErrorCode(
            code="FAIL_LLM_L_M_RATE_LIMIT",
            category=ErrorCategory.FAIL,
            default_message_es="Error de l l m tipo limit.",
            default_message_en="Raised when a provider rejects a request because of rate limits.",
            default_message_hu="L l m kulcs limit hiba.",
            default_suggestion=None,
            retryable=True,
            runbook_id=None,
        ),
    ...
    (
        "aeat.manuals.errors.ManifestError",
        ErrorCode(
            code="INTEGRITY_MANUALS_MANIFEST",
            category=ErrorCategory.INTEGRITY,
            default_message_es="Error de manifiesto.",
            default_message_en="Raised when a ``manifest.",
    ...
    (
        "aeat.manuals.errors.ManualError",
        ErrorCode(
    ...
    (
        "aeat.manuals.errors.ManualNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.manuals.errors.ManualParseError",
        ErrorCode(
    ...
    (
        "aeat.manuals.errors.ManualReviewRequiredError",
        ErrorCode(
    ...
    (
        "aeat.manuals.errors.RuleExtractionError",
        ErrorCode(
            code="ERROR_MANUALS_RULE_EXTRACTION",
            category=ErrorCategory.ERROR,
            default_message_es="Error de regla extraction.",
            default_message_en="Raised by the LLM-dependent CLI phases until ``#21`` lands.",
    ...
    (
        "aeat.models._errors.ModeloRegistryError",
        ErrorCode(
            code="ERROR_MODELS_MODELO_REGISTRY",
            category=ErrorCategory.ERROR,
            default_message_es="Error de modelo registro.",
            default_message_en="Base class for every error raised from :mod:`aeat.",
    ...
    (
        "aeat.models._errors.RegistryIntegrityError",
        ErrorCode(
    ...
    (
        "aeat.models._errors.UnknownModeloError",
        ErrorCode(
            code="ERROR_MODELS_UNKNOWN_MODELO",
            category=ErrorCategory.ERROR,
            default_message_es="Modelo desconocido.",
            default_message_en="Raised by :func:`aeat.",
    ...
    (
        "aeat.normatives.errors.NormativeError",
        ErrorCode(
    ...
    (
        "aeat.normatives.errors.NormativeNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.normatives.errors.NormativeParseError",
        ErrorCode(
    ...
    (
        "aeat.observability._errors.AeatCorpusDriftError",
        ErrorCode(
            code="INTEGRITY_OBSERVABILITY_AEAT_CORPUS_DRIFT",
            category=ErrorCategory.INTEGRITY,
            default_message_es="Error de aeat corpus drift.",
            default_message_en="Raised when replay detects that ``corpus_sha256`` has drifted.",
    ...
    (
        "aeat.observability._errors.RunContextMissingError",
        ErrorCode(
    ...
    (
        "aeat.portals._errors.PortalIntegrityError",
        ErrorCode(
    ...
    (
        "aeat.portals._errors.PortalRegistryError",
        ErrorCode(
    ...
    (
        "aeat.portals._errors.UnknownPortalError",
        ErrorCode(
    ...
    (
        "aeat.review._errors.ReviewError",
        ErrorCode(
            code="ERROR_REVIEW",
            category=ErrorCategory.ERROR,
    ...
    (
        "aeat.review._errors.ReviewKindReservedError",
        ErrorCode(
    ...
    (
        "aeat.review._errors.ReviewSourceLoadError",
        ErrorCode(
    ...
    (
        "aeat.schema._errors.SchemaCacheError",
        ErrorCode(
            code="FAIL_SCHEMA_CACHE",
            category=ErrorCategory.FAIL,
            default_message_es="Error de esquema cache.",
            default_message_en="Raised when on-disk schema persistence fails.",
            default_message_hu="Sema cache hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.schema._errors.SchemaError",
        ErrorCode(
            code="ERROR_SCHEMA",
            category=ErrorCategory.ERROR,
            default_message_es="Error de esquema.",
            default_message_en="Base class for every :mod:`aeat.",
    ...
    (
        "aeat.schema._errors.SchemaEvaluationError",
        ErrorCode(
            code="ERROR_SCHEMA_EVALUATION",
            category=ErrorCategory.ERROR,
            default_message_es="Error de esquema evaluacion.",
            default_message_en="Raised when :func:`evaluate` cannot compute a formula AST.",
    ...
    (
        "aeat.schema._errors.SchemaExtractionError",
        ErrorCode(
            code="ERROR_SCHEMA_EXTRACTION",
            category=ErrorCategory.ERROR,
            default_message_es="Error de esquema extraction.",
            default_message_en="Raised when an :class:`Extractor` fails to parse its source.",
            default_message_hu="Sema extraction hiba.",
    ...
    (
        "aeat.schema._errors.SchemaValidationError",
        ErrorCode(
            code="INTEGRITY_SCHEMA_VALIDATION",
            category=ErrorCategory.INTEGRITY,
            default_message_es="La validacion de esquema fallo.",
            default_message_en="Raised when a cached :class:`Modelo` JSON blob fails validation.",
    ...
    (
        "aeat.sede._errors.ExpedienteNotFoundError",
        ErrorCode(
    ...
    (
        "aeat.sede._errors.JustificanteFetchError",
        ErrorCode(
    ...
    (
        "aeat.sede._errors.SedeNavigationError",
        ErrorCode(
    ...
    (
        "aeat.sede._errors.SedeParseError",
        ErrorCode(
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.REFUSED,
            default_message_es="Error de configuracion aborted.",
            default_message_en="Raised when the user explicitly aborts the wizard.",
            default_message_hu="Beallitas aborted hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.setup._errors.SetupAnswersError",
        ErrorCode(
            code="ERROR_SETUP_ANSWERS",
            category=ErrorCategory.ERROR,
            default_message_es="Error de configuracion respuestas.",
            default_message_en="Raised when a :class:`SetupAnswers` payload cannot be loaded or validated.",
    ...
    (
        "aeat.setup._errors.SetupVerifyError",
        ErrorCode(
    ...
    (
        "aeat.storage.errors.RepositoryError",
        ErrorCode(
            code="FAIL_STORAGE_REPOSITORY",
            category=ErrorCategory.FAIL,
            default_message_es="Error de repositorio.",
            default_message_en="Raised when a repository operation fails (not-found, integrity, etc.",
    ...
    (
        "aeat.storage.errors.StorageError",
        ErrorCode(
            code="FAIL_STORAGE",
            category=ErrorCategory.FAIL,
    ...
    (
        "aeat.submission._errors.AeatLiveConfirmationDeclinedError",
        ErrorCode(
            code="REFUSED_SUBMISSION_AEAT_LIVE_CONFIRMATION_DECLINED",
            category=ErrorCategory.REFUSED,
            default_message_es="Error de aeat en vivo confirmacion declined.",
            default_message_en="Raised when the operator does not type the exact live-submit phrase.",
            default_message_hu="Aeat elo megerosites declined hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.submission._errors.AeatLiveSubmitNotEnabledError",
        ErrorCode(
            code="REFUSED_SUBMISSION_AEAT_LIVE_SUBMIT_NOT_ENABLED",
            category=ErrorCategory.REFUSED,
            default_message_es="Error de aeat en vivo submit no enabled.",
            default_message_en="Raised when the live-submit env gate is not enabled.",
            default_message_hu="Aeat elo submit nem enabled hiba.",
            default_suggestion="aeat submission preflight",
            retryable=False,
            runbook_id=None,
        ),
    ),
    (
        "aeat.submission._errors.AeatLiveTransportUnavailableError",
        ErrorCode(
            code="REFUSED_SUBMISSION_AEAT_LIVE_TRANSPORT_UNAVAILABLE",
            category=ErrorCategory.REFUSED,
            default_message_es="Error de aeat en vivo transporte unavailable.",
            default_message_en="Raised when a live write is requested on a stubbed transport.",
            default_message_hu="Aeat elo atvitel unavailable hiba.",
            default_suggestion="aeat submission preflight",
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.submission._errors.AeatPytestLiveWriteRefusedError",
        ErrorCode(
            code="REFUSED_SUBMISSION_AEAT_PYTEST_LIVE_WRITE_REFUSED",
            category=ErrorCategory.REFUSED,
            default_message_es="Error de aeat pytest en vivo write refused.",
            default_message_en="Raised when pytest reaches a live-capable submission call.",
            default_message_hu="Aeat pytest elo write refused hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.submission._errors.SubmissionError",
        ErrorCode(
    ...
    (
        ...
        ErrorCode(
            ...
            category=ErrorCategory.ERROR,
            default_message_es="Error de envio preflight.",
            default_message_en="Raised when preflight gating rejects a draft before any browser work.",
            default_message_hu="Bekuldes elokeszites hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.submission._errors.SubmissionRejectionError",
        ErrorCode(
            code="ERROR_SUBMISSION_REJECTION",
            category=ErrorCategory.ERROR,
            default_message_es="Error de envio rechazo.",
            default_message_en="Raised when AEAT rejects the filled form during the live submit leg.",
            default_message_hu="Bekuldes elutasitas hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.sync._errors.DivergenceClassificationError",
        ErrorCode(
    ...
    (
        "aeat.sync._errors.DivergenceRepositoryError",
        ErrorCode(
    ...
    (
        "aeat.sync._errors.HealingError",
        ErrorCode(
    ...
    (
        "aeat.sync._errors.WireValidationError",
        ErrorCode(
    ...
    (
        "aeat.verification._errors.VerificationError",
        ErrorCode(
    ...
    (
        "aeat.workflow._errors.WorkflowAbortedError",
        ErrorCode(
            code="REFUSED_WORKFLOW_ABORTED",
            category=ErrorCategory.REFUSED,
            default_message_es="Error de flujo de trabajo aborted.",
            default_message_en="Raised only when a caller explicitly opts in to exception-on-abort.",
            default_message_hu="Munkafolyamat aborted hiba.",
            default_suggestion=None,
            retryable=False,
            runbook_id=None,
        ),
    ...
    (
        "aeat.workflow._errors.WorkflowComponentError",
        ErrorCode(
    ...
    (
        "aeat.workflow._errors.WorkflowError",
        ErrorCode(
            code="ERROR_WORKFLOW",
            category=ErrorCategory.ERROR,
            default_message_es="Error de flujo de trabajo.",
            default_message_en="Base exception for all :mod:`aeat.",
