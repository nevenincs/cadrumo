...
The helper is shared between :mod:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.auth._authenticator`
and :mod:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.auth._clave_movil` so the
