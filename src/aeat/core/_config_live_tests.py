...
"""Settings field backing the pytest-only live-read opt-in on :class:`~aeat.core.config.Settings`."""
...
"""Settings field backing the pytest-only Google live-test opt-in on :class:`~aeat.core.config.Settings`."""
...
def strict_live_test_opt_in(value: str) -> bool:
    ...
    :class:`~aeat.core.config.Settings` uses this for both
