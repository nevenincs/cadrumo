...
_DECLARED_ERROR_CODES: tuple[tuple[str, ErrorCode], ...] = (
    ...
    (
        ...
        ErrorCode(
            ...
            default_suggestion="aeat config bucket import <path> --conflict overwrite",
            retryable=False,
            runbook_id=None,
        ),
    ),
    (
        ...
        ErrorCode(
            ...
            default_suggestion="aeat config auth configure --provider certificate --certificate-path PATH",
            retryable=False,
            runbook_id=None,
        ),
    ),
    ...
    (
        ...
        ErrorCode(
            ...
            default_suggestion="aeat config init --profile NAME --tax-id NIF --activity TEXT --iva-regime REGIME",
            retryable=False,
            runbook_id=None,
        ),
    ),
