...
from .application.wizard import _catalogue as _wizard_catalogue  # noqa: F401  # wizard catalogue registration side effect
from .application.wizard import _persistence as _wizard_persistence  # noqa: F401  # wizard persistence registration side effect
