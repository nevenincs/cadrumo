...
This skill diffs against `preparar-modelo-390`: Modelo 190 is to Modelo 111
...
- **No trabajo-en-especie / manual-block distinction at this layer.**
  ...
  Modelo 111 quarter (see `preparar-modelo-111`), not on the 190.
