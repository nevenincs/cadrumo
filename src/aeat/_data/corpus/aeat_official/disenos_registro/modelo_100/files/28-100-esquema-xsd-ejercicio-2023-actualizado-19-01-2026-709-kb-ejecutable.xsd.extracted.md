# 28-100-esquema-xsd-ejercicio-2023-actualizado-19-01-2026-709-kb-ejecutable.xsd
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" elementFormDefault="unqualified" attributeFormDefault="unqualified">
	...
	<xs:simpleType name="tipo_Integer2019">
		<xs:restriction base="xs:integer">
	...
	<xs:simpleType name="tipo_Integer2020a2021">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2020"/>
			<xs:maxInclusive value="2021"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_Integer2019a2022">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2019"/>
	...
	<xs:simpleType name="tipo_Integer2021a2023">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2021"/>
			<xs:maxInclusive value="2023"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_Integer2020a2023">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2020"/>
			<xs:maxInclusive value="2023"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_Integer2019a2023">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2019"/>
			<xs:maxInclusive value="2023"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_Integer2010a2022">
		<xs:restriction base="xs:integer">
	...
	<xs:simpleType name="tipo_Opciones2010a2022">
		<xs:restriction base="xs:string">
	...
	<xs:simpleType name="tipo_Opciones1998a2022">
		<xs:restriction base="xs:string">
			<xs:enumeration value="1998"/>
			<xs:enumeration value="1999"/>
			<xs:enumeration value="2000"/>
	...
	<xs:simpleType name="tipo_Opciones2009a2022">
		<xs:restriction base="xs:string">
			<xs:enumeration value="2009"/>
			<xs:enumeration value="2010"/>
			<xs:enumeration value="2011"/>
	...
	<xs:simpleType name="tipo_OpcionesEDNyEDSyEO">
		<xs:restriction base="xs:string">
												...
												<xs:element name="DeduccionDeclarante" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															...
															<xs:element name="ANOMOMATERD" type="tipo_Integer2020a2023" minOccurs="0" maxOccurs="1"/>
														</xs:sequence>
													</xs:complexType>
												</xs:element>
												<xs:element name="DeduccionConyuge" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															...
															<xs:element name="ANOMOMATERC" type="tipo_Integer2020a2023" minOccurs="0" maxOccurs="1"/>
														</xs:sequence>
													</xs:complexType>
												</xs:element>
	...
	<xs:complexType name="tipo_OtraDeclaracion">
		<xs:sequence>
			<xs:element name="IngresosYDevolucionesPrevias" type="tipo_IngresosYDevolucionesPrevias" minOccurs="1" maxOccurs="1"/>
			<xs:choice>
				<xs:element name="Complementaria" type="tipo_Complementaria" minOccurs="0" maxOccurs="1"/>
				<xs:element name="SolicitudRectificacion" type="tipo_SolicitudRectificacion" minOccurs="0"/>
			</xs:choice>
		</xs:sequence>
	</xs:complexType>
	<xs:complexType name="tipo_IngresosYDevolucionesPrevias">
		<xs:sequence>
			<xs:element name="DEVSOLICITADAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="DEVACORDADAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="INGPREVIOS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
	<xs:complexType name="tipo_Complementaria">
		<xs:choice>
			<xs:sequence>
				<xs:element name="Z9" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
				<xs:element name="DEVSOL" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			</xs:sequence>
			<xs:sequence>
				...
				<xs:element name="INGCOMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				<xs:element name="DEVCOMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			</xs:sequence>
		</xs:choice>
	</xs:complexType>
	<xs:complexType name="tipo_SolicitudRectificacion">
		<xs:sequence>
			<xs:element name="ZRECT" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
			<xs:element name="ING2DLG" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="DEV2DLG" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="JUSTFDLG" type="tipo_String13LNumeros" minOccurs="1" maxOccurs="1"/>
			<xs:choice>
				<xs:element name="IBAN2DLG" type="tipo_Iban" minOccurs="0" maxOccurs="1"/>
				<xs:element name="DLGRECTSEPA">
					<xs:complexType>
						<xs:sequence>
							<xs:element name="SEPA2DLG" type="tipo_Iban" minOccurs="0" maxOccurs="1"/>
							<xs:element name="SWIFT2DLG" type="tipo_swift" minOccurs="0" maxOccurs="1"/>
						</xs:sequence>
					</xs:complexType>
				</xs:element>
				<xs:element name="DLGRECTNOSEPA">
					<xs:complexType>
						<xs:sequence>
							<xs:element name="VCUENTAOTROS"  type="tipo_Iban" minOccurs="0" maxOccurs="1"/>
							<xs:element name="VSWIFTOTROS"   type="tipo_swift" minOccurs="0" maxOccurs="1"/>
							<xs:element name="VNOMBREBANCO" type="tipo_String70L"  minOccurs="0" maxOccurs="1"/>
							<xs:element name="VDIRBANCO" type="tipo_String35L" minOccurs="0" maxOccurs="1"/>
							<xs:element name="VCIUDADBANCO"  type="tipo_String30L"  minOccurs="0" maxOccurs="1"/>
							<xs:element name="VPAISBANCO" type="tipo_StringLetras2L"  minOccurs="0" maxOccurs="1"/>
						</xs:sequence>
					</xs:complexType>
				</xs:element>
			</xs:choice>
	...
	<xs:complexType name="tipo_RegularizacionRes">
		<xs:choice>
			<xs:sequence>
				<xs:element name="COMPING" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				<xs:element name="COMPDEV" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				<xs:element name="RESCOMP" type="tipo_ImpNegativo" minOccurs="1" maxOccurs="1"/>
			</xs:sequence>
			<xs:sequence>
				<xs:element name="RECING" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				<xs:element name="RECDEV" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				<xs:element name="RESREC" type="tipo_ImpNegativo" minOccurs="1" maxOccurs="1"/>
				<xs:element name="PJUSTIFICANTE" type="tipo_String13LNumeros" minOccurs="1" maxOccurs="1"/>
			<xs:choice>
				<xs:element name="IBANREC" type="tipo_Iban" minOccurs="0" maxOccurs="1"/>
				<xs:element name="RECTSEPA">
					<xs:complexType>
						<xs:sequence>
							<xs:element name="SEPAREC" type="tipo_Iban" minOccurs="0" maxOccurs="1"/>
							<xs:element name="SWIFTREC" type="tipo_swift" minOccurs="0" maxOccurs="1"/>
						</xs:sequence>
					</xs:complexType>
				</xs:element>
				<xs:element name="RECTNOSEPA">
					<xs:complexType>
						<xs:sequence>
							<xs:element name="PCUENTAOTROS"  type="tipo_Iban" minOccurs="0" maxOccurs="1"/>
							<xs:element name="PSWIFTOTROS"   type="tipo_swift" minOccurs="0" maxOccurs="1"/>
							<xs:element name="PNOMBREBANCO" type="tipo_String70L"  minOccurs="0" maxOccurs="1"/>
							<xs:element name="PDIRBANCO" type="tipo_String35L" minOccurs="0" maxOccurs="1"/>
							<xs:element name="PCIUDADBANCO"  type="tipo_String30L"  minOccurs="0" maxOccurs="1"/>
							<xs:element name="PPAISBANCO" type="tipo_StringLetras2L"  minOccurs="0" maxOccurs="1"/>
						</xs:sequence>
					</xs:complexType>
				</xs:element>
			</xs:choice>
	...
	<xs:complexType name="tipo_AnexoARes">
		<xs:sequence>
			...
			<xs:element name="ReservaInversionesCanariasRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="M24EM5S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM5ANO" type="tipo_Integer2019" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM5A" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM5CD" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	  					<xs:element name="M24EM4S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM4ANO" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM4P" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM3S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM3ANO" type="tipo_Integer2020a2021" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM2ANO" type="tipo_Integer2021a2022" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM1ANO" type="tipo_Integer2022a2023" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM0ANO" type="tipo_Integer2023a2024" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="ReservaInversionesBalearesRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M24BEM0ANO" type="tipo_Integer2023a2024" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="DeduccionesInversionEmpresarialRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M21BWRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWRA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWRP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PDMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PDMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PDMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PBES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PBEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PBEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ALIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ALIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ALIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21CTLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CTLA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CTLP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21GPFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21GPFA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21GPFP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BIRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BIRA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BIRP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AERS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AERA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AERP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SUMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SUMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SUMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ESMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ESMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ESMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AVAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AVAA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AVAP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DCMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DCMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DCMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MHWS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MHWA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MHWP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CRES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CREA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CREP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SCUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SCUA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SCUP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CRSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CRSA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CRSP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MWCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MWCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MWCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21VCMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21VCMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21VCMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CROS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CROA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CROP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FCCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FCCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FANS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FANA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FANP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21NMES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21NMEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21NMEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ARDS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ARDA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ARDP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AOOS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AOOA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AOOP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HRCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HRCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HRCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MBES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MBEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MBEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CBCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CBCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CBCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCPA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCPP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21RTUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21RTUA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21RTUP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PDIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PDIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PDIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SJDS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SJDA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SJDP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21FAFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FAFA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FAFP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ADBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ADBA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ADBP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UNIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UNIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UNIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21JPAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21JPAA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21JPAP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FJSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FJSA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FJSP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APSA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APSP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21VANS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21VANA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21VANP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MPPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MPPA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MPPP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TCCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TCCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21PVES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PVEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PVEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CTES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CTEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CTEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21BAMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BAMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BAMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BECS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BECA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BECP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21RPHS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21RPHA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21RPHP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ALMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ALMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ALMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HOSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HOSA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HOSP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BMLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BMLA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BMLP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SSUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SSUA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SSUP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SILS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SILA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21SILP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21HOKS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HOKA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21HOKP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BLENS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BLENA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BLENP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21ATBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ATBA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ATBP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21BMBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BMBA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BMBP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_IngresoDevolucionRes">
		<xs:sequence>
			...
			<xs:element name="RESDECCOMP" type="tipo_ImpNegativo" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
	...
	<xs:complexType name="tipo_AragonRes">
		<xs:sequence>
			...
			<xs:element name="AR17" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="AR18" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_IBalearesRes">
		<xs:sequence>
			...
			<xs:element name="IB20" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="IB21" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CanariasRes">
		<xs:sequence>
			...
			<xs:element name="CAN6" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CantabriaRes">
		<xs:sequence>
			...
			<xs:element name="CANT3AA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CANT3P" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
	...
	<xs:complexType name="tipo_CastillaYLeonRes">
		<xs:sequence>
			...
			<xs:element name="CL11EAP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="CL11EAP14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CL11EA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="CL11EA13" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CLRDA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CatalunyaRes">
		<xs:sequence>
			...
			<xs:element name="FECHAVIUDCT6" type="tipo_Integer2021a2023" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_GaliciaRes">
		<xs:sequence>
			...
			<xs:element name="GA15" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="GA16" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="GAOD" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_MurciaRes">
		<xs:sequence>
			...
			<xs:element name="CCMU12" type="tipo_String20L" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_LaRiojaRes">
		<xs:sequence>
			...
			<xs:element name="LR11" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AnBInfAdcInstAuto">
		<xs:sequence>
			<xs:element name="CANT19VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="APL19VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="PDTE19VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
...
<!-- 					ver en especificaciones que valores puede tomar c1anem -->
							...
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RegistroB14" minOccurs="0" maxOccurs="20">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="IMP1DB14" type="tipo_ImpNegativo" minOccurs="1" maxOccurs="1"/>
											</xs:sequence>
										</xs:complexType>
									</xs:element>
								</xs:sequence>
			...
			<xs:element name="Inmueble" minOccurs="0" maxOccurs="180">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="ViviendaHabitual" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="C_DIASVH" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="ViviendaExconyuge" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="C_DIASEX" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="ViviendaAE" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="C_DIASAE" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
									<xs:element name="C_TITAE" type="tipo_Titular" minOccurs="0" maxOccurs="1"/>
									<xs:element name="C_DIASAN" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="DisposicionTitulares" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="C_DIAS" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
									...
									<xs:element name="C_DIAS_RII" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
							...
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="DatosArrendamiento" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="C_DIASARR" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
									...
									<xs:complexType>
										<xs:sequence>
											<xs:element name="V02TIP" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1">
											<xs:annotation >
												<xs:documentation xml:lang="es">
													El elemento V02TIP tomará los valores:
													["1"=Rdtos. por arrendamiento de inmuebles destinados a vivienda habitual con derecho a la reducción del 60%
													 "2"=Otros rendimientos distintos de los anteriores (rendimientos de locales, viviendas de temporada, etc.)]
												</xs:documentation>
											</xs:annotation>
											</xs:element>
											...
											<xs:element name="DIASAM1" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
											<xs:element name="DIASAM2" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
											<xs:element name="DIASAM3" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
											<xs:element name="DIASAM4" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
											<xs:element name="DIASARRAM" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
											...
											<xs:element name="AmortizacionInmuebleAccesorio" minOccurs="0" maxOccurs="3">
												<xs:complexType>
													<xs:sequence>
														<xs:element name="DIASARRAMACC" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
														<xs:element name="DIASAM1ACC" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
														<xs:element name="DIASAM2ACC" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
														<xs:element name="DIASAM3ACC" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
														<xs:element name="DIASAM4ACC" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="C_DIASARRAM" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="C_DIASACC" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="ActividadEstObj" minOccurs="0" maxOccurs="6">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="InformacionAdicionalEstObj" minOccurs="1" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="LORCADLG" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1">
									<xs:annotation >
										<xs:documentation xml:lang="es">
											El elemento LORCADLG tomará los valores:
											["1"=Actividad realizada exclusivamente en Lorca,"2"=Actividad realizada en Lorca y en otros municipios (vea la ayuda)]
										</xs:documentation>
									</xs:annotation>
									</xs:element>
									<xs:element name="PALMAEODLG" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1">
										<xs:annotation >
											<xs:documentation xml:lang="es">
												El elemento PALMAEODLG tomará los valores:
												["1"=Actividad realizada exclusivamente en la Isla de La Palma,
												"2"= Actividad realizada en la Isla de La Palma y en municipios que no estuvieran situados en la Isla de La Palma (vea la ayuda)]
											</xs:documentation>
										</xs:annotation>
									</xs:element>
						...
						<xs:element name="LORCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="PALMAEO" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="ActividadAgr" minOccurs="0" maxOccurs="6">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="InformacionAdicionalAgr" minOccurs="1" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="PALMAAGDLG" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1">
										<xs:annotation >
											<xs:documentation xml:lang="es">
												El elemento PALMAEODLG tomará los valores:
												["1"=Actividad realizada exclusivamente en la Isla de La Palma,
								...
								<xs:attribute name="clave" type="tipo_Integer1a9" use="required"/>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="REDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DesgloseREDUGAS"  minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:choice>
									<xs:sequence>
										<xs:element name="IMPREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
									<xs:sequence>
										<xs:element name="ELEMACTAGRICOLAS" minOccurs="0" maxOccurs="1">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="V03AAPREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AAAREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03PAEREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AAEREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03PREREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AREREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03PERREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AERREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												</xs:sequence>
											</xs:complexType>
										</xs:element>
										<xs:element name="ELEMACTGANADERAS" minOccurs="0" maxOccurs="1">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="V03AG1REDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AG2REDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03G1AEREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03G2AEREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												</xs:sequence>
											</xs:complexType>
										</xs:element>
										<xs:element name="V03OTSREDUGAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
								</xs:choice>
							</xs:complexType>
						</xs:element>
						<xs:element name="REDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DesgloseREDUFER"  minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:choice>
									<xs:sequence>
										<xs:element name="IMPREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
									<xs:sequence>
										<xs:element name="ELEMACTAGRICOLAS" minOccurs="0" maxOccurs="1">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="V03AAPREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AAAREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03PAEREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AAEREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03PREREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AREREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03PERREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AERREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												</xs:sequence>
											</xs:complexType>
										</xs:element>
										<xs:element name="ELEMACTGANADERAS" minOccurs="0" maxOccurs="1">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="V03AG1REDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03AG2REDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03G1AEREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
													<xs:element name="V03G2AEREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												</xs:sequence>
											</xs:complexType>
										</xs:element>
										<xs:element name="V03OTSREDUFER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
								</xs:choice>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="PALMAAG" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							...
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="AR_RendActivEconomicas" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="CBMETODO" type="tipo_OpcionesEDNyEDSyEO" minOccurs="1" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_GPAcciones">
		<xs:sequence>
			<xs:element name="EntidadAccion" minOccurs="1" maxOccurs="120">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="G2B_A" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="TRANSACCION" minOccurs="0" maxOccurs="100">
										<xs:complexType>
											<xs:sequence>
	...
	<xs:complexType name="tipo_GPOtrosCriptomonedas">
		<xs:sequence>
			<xs:element name="ElementoCriptomoneda" minOccurs="1" maxOccurs="120">
				<xs:complexType>
					<xs:sequence>
					<!-- G2DDCRIT -->
	...
	<xs:complexType name="tipo_Aragon">
		<xs:sequence>
			...
			<xs:element name="AR17" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPAR17" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="AR18" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="COMAR18" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DEC1AR18" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DEC2AR18" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NUMAR18" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="PA25" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="COM2PA25" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DEC2PA25" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="MESCO2PA25" type="tipo_Integer1a99" minOccurs="0" maxOccurs="1"/>
						<xs:element name="MESDE2PA25" type="tipo_Integer1a99" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_IBaleares">
		<xs:sequence>
			...
			<xs:element name="IB16" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="MESES1IB16" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="MESES2IB16" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="MESES3IB16" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="MESES4IB16" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="IB20" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP1IB20" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP2IB20" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="IB21" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPIB21" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		<xs:element name="IB22" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="CONVIB22" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Canarias">
		<xs:sequence>
			...
			<xs:element name="CAN6" minOccurs="0" maxOccurs="1">
				<xs:annotation >
					<xs:documentation xml:lang="es">
						Los elementos GRADO1CAN6,GRADO2CAN6,GRADO3CAN6 tomarán los valores:
						["1"=Descendiente con discapacidad igual o superior al 33% e inferior al 65%.
						 "2"=Descendiente con discapacidad igual o superior al 65%.]
					</xs:documentation>
				</xs:annotation>
				<xs:complexType>
					<xs:sequence>
						<xs:element name="GRADO1CAN6" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VAL1CAN6" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="GRADO2CAN6" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VAL2CAN6" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="GRADO3CAN6" type="tipo_Opciones1y2" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VAL3CAN6" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="CAN19" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="MENORB2CAN19" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NUMB2CAN19" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
						<xs:element name="MENORB3CAN19" type="tipo_Integer1a366" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CAN22" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP1CAN22" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CAN31" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCAN31" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
	...
	<xs:complexType name="tipo_Cantabria">
		<xs:sequence>
			...
			<xs:element name="CANT3AA" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCANT3AA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="CANT9" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="CONVCANT9" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_CastillaYLeon">
		<xs:sequence>
			...
			<xs:element name="CL11EA" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP1CL11EA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP2CL11EA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CL20" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="EJERCICIOCL20" type="tipo_Integer2019a2023" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
			...
			<xs:element name="CT6" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="FVIUDCT6" type="tipo_Integer2021a2023" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="E10" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="IMP1E10" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Galicia">
		<xs:sequence>
			...
			<xs:element name="GA7" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="HIJOSCJGA7" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="HIJOSDGA7" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="GA15" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPGA15" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="GA16" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP1GA16" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP2GA16" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="M5" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="DECM5" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="MU1" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="VP1MU1" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP2MU1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VP2MU1" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_LaRioja">
		<xs:sequence>
			...
			<xs:element name="LR11" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP1LR11" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP2LR11" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_CValenciana">
				...
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="COTIZACIONESMATERVA" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:choice>
									<xs:element name="MAY100TITVA6" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
									<xs:sequence>
		...
		<xs:element name="VA29" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP12VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP13VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="IMP22VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP23VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="IMP32VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP33VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="IMP42VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP43VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="VA41" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPVA41" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
 					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
									...
									<xs:element name="V01PP3RGEA" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												...
												<xs:complexType>
														<xs:sequence>
															<xs:element name="DatosAPCOPPE" minOccurs="0" maxOccurs="4">
																<xs:complexType>
																	<xs:sequence>
																		<xs:choice minOccurs="1" maxOccurs="1">
																		...
																		<xs:element name="RT60APCOPPE" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
												...
												<xs:complexType>
														<xs:sequence>
															<xs:element name="DatosAPCOMPS" minOccurs="0" maxOccurs="4">
																<xs:complexType>
																	<xs:sequence>
																		<xs:choice minOccurs="1" maxOccurs="1">
																		...
																		<xs:element name="RT60APCOMPS" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
												...
												<xs:element name="APCOPSE" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="DatosAPCOPSE" minOccurs="0" maxOccurs="4">
																<xs:complexType>
																	<xs:sequence>
																		<xs:choice minOccurs="1" maxOccurs="1">
																		...
																		<xs:element name="RT60APCOPSE" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AnexoA">
		<xs:sequence>
			...
			<xs:element name="ReservaInversionesCanarias" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="M24EM5S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="V01DOT1M24EM5S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="V01ANOM24EM5S" type="tipo_Integer2019" minOccurs="0" maxOccurs="1"/>
									<xs:element name="V01ABD1M24EM5S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="V01CD1M24EM5S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M24EM4S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM4S" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM3S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM3S" type="tipo_Integer2020a2021" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM2S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM2S" type="tipo_Integer2021a2022" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM1S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM1S" type="tipo_Integer2022a2023" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM0S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM0S" type="tipo_Integer2023a2024" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24BEM0S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24BEM0S" type="tipo_Integer2023a2024" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="DeduccionesInversionEmpresarial" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M21BWRS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BWRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BWRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21PDMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21PDMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21PDMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21PBES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21PBES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21PBES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ALIS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ALIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ALIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21CTLS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CTLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CTLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21GPFS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21GPFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21GPFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21BIRS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BIRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BIRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21AERS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21AERS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21AERS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21SUMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21SUMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21SUMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ESMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ESMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ESMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21AVAS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21AVAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21AVAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21DCMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21DCMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21DCMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21MHWS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21MHWS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21MHWS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CRES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CRES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CRES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21SCUS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21SCUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21SCUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CRSS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CRSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CRSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21MWCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21MWCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21MWCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21VCMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21VCMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21VCMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CROS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CROS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CROS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21FCCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21FCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21FCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21FANS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21FANS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21FANS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21NMES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21NMES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21NMES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ARDS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ARDS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ARDS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21AOOS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21AOOS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21AOOS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21HRCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21HRCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21HRCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21MBES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21MBES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21MBES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CBCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CBCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CBCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CCPS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CCPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CCPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21RTUS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21RTUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21RTUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21PDIS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21PDIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21PDIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21SJDS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21SJDS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21SJDS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21FAFS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21FAFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21FAFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21ADBS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21ADBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21ADBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21UNIS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21UNIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21UNIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21JPAS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21JPAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21JPAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21FJSS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21FJSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21FJSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21APSS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21APSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21APSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21VANS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21VANS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21VANS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21MPPS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21MPPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21MPPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21TCCS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21TCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21TCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21PVES" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21PVES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21PVES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21CTES" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21CTES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21CTES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21BAMS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21BAMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21BAMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21BECS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21BECS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21BECS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						<xs:element name="M21APCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21APCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21APCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21RPHS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21RPHS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21RPHS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ALMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ALMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ALMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21HOSS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21HOSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21HOSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21BMLS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BMLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BMLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21SSUS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21SSUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21SSUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21SILS" minOccurs="0" maxOccurs="1">
						<xs:complexType>
							<xs:sequence>
								<xs:element name="DED1M21SILS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								<xs:element name="IMP1M21SILS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
						</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21HOKS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21HOKS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21HOKS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21BLENS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BLENS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BLENS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21ATBS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ATBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ATBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21BMBS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BMBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BMBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
							...
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED01M22AFS" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="DesgloseDED01M22AFS" minOccurs="0" maxOccurs="12">
													<xs:complexType>
														<xs:sequence>
															...
															<xs:element name="ANIODED01M22AFS" type="tipo_Integer2010a2022" minOccurs="0" maxOccurs="1"/>
														</xs:sequence>
													</xs:complexType>
												</xs:element>
											</xs:sequence>
									...
									<xs:element name="DED02M22AFS" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="DesgloseDED02M22AFS" minOccurs="0" maxOccurs="3">
													<xs:complexType>
														<xs:sequence>
															...
															<xs:element name="ANIODED02M22AFS" type="tipo_Integer2019a2022" minOccurs="0" maxOccurs="1"/>
														</xs:sequence>
													</xs:complexType>
												</xs:element>
											</xs:sequence>
										...
										<xs:complexType>
											<xs:sequence>
												...
												<xs:element name="INTDEMORAESTAUT3" minOccurs="0" maxOccurs="20">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINTD3" type="tipo_Opciones2009a2022" minOccurs="1" maxOccurs="1"/>
												...
												<xs:element name="INTDEMORAEST2" minOccurs="0" maxOccurs="6">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERVAL1INTD4" type="tipo_Opciones2009a2022" minOccurs="1" maxOccurs="1"/>
										...
										<xs:complexType>
											<xs:sequence>
												<xs:element name="INTDEMORAAUT" minOccurs="0" maxOccurs="20">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINTDAUT" type="tipo_Opciones1998a2022" minOccurs="1" maxOccurs="1"/>
										...
										<xs:complexType>
											<xs:sequence>
												<xs:element name="INTDEMORAESTAUTINT33E" minOccurs="0" maxOccurs="20">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINT33E" type="tipo_Opciones2010a2022" minOccurs="1" maxOccurs="1"/>
				...
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DOBIMPINT" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="VRB1" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:choice>
									...
									<xs:element name="VRB2" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:choice>
									...
									<xs:element name="VRB3" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:choice>
	...
	<xs:element name="Declaracion">
		<xs:complexType>
			<xs:sequence>
				...
				<xs:attribute name="ejercicio" type="xs:string"  fixed="2023"/>
