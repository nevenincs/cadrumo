# 25-100-esquema-xsd-ejercicio-2020-actualizado-23-10-2024-529-kb-ejecutable.xsd
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" elementFormDefault="unqualified" attributeFormDefault="unqualified">
		...
		<xs:annotation>
			<xs:documentation xml:lang="es">
				...
				["I"= (Ingreso),
				 ...
				 "1"= (Ingreso en Banco/Caja),
 			     "2"= (Pago por transferencia),
 			     "M, A, P, H, F, E, Z, J"=(Reservados para la AEAT)]
			</xs:documentation>
		</xs:annotation>
		<xs:restriction base="xs:string">
			<xs:maxLength value="1"/>
			<xs:pattern value="I|1|2|U|M|A|P|H|F|E|Z|J|N|D|R"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_ReferenciaCatastral">
		<xs:restriction base="xs:string">
			...
			<xs:pattern value="([A-Z]|[0-9]|Ñ|Ü|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ç|\s|\.|\-|_|:|,|'|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_String4L">
		<xs:restriction base="xs:string">
			<xs:maxLength value="4"/>
			<xs:pattern value="([0-9]|[A-Z]|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|Ñ|Ç|\s|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_String5L">
		<xs:restriction base="xs:string">
	...
	<xs:simpleType name="tipo_String20L">
		<xs:restriction base="xs:string">
			<xs:maxLength value="20"/>
			<!-- <xs:pattern value="([0-9]|[A-Z]|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|Ñ|Ç|\s|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/> -->
			<xs:pattern value="([0-9]|[A-Z]|.*|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|Ñ|Ç|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_Integer2017a2018">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2017"/>
			<xs:maxInclusive value="2018"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_Integer2018a2019">
		<xs:restriction base="xs:integer">
	...
	<xs:simpleType name="tipo_Integer2019a2020">
		...
		<xs:simpleType name="tipo_Integer2016a2020">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2016"/>
			<xs:maxInclusive value="2020"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_Integer2017a2027">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2017"/>
	...
	<xs:simpleType name="tipo_Opciones1998a2019">
		<xs:restriction base="xs:string">
			<xs:enumeration value="1998"/>
			<xs:enumeration value="1999"/>
			<xs:enumeration value="2000"/>
	...
	<xs:simpleType name="tipo_Opciones2009a2015">
		<xs:restriction base="xs:string">
			<xs:enumeration value="2009"/>
			<xs:enumeration value="2010"/>
			<xs:enumeration value="2011"/>
	...
	<xs:simpleType name="tipo_Opciones2009a2019">
		<xs:restriction base="xs:string">
			<xs:enumeration value="2009"/>
			<xs:enumeration value="2010"/>
			<xs:enumeration value="2011"/>
	...
	<xs:simpleType name="tipo_String40LTexto">
		<xs:restriction base="xs:string">
			...
			<xs:pattern value="([A-Z]|[0-9]|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ä|Ë|Ï|Ö|Ü|Ñ|Ç|\s|\.|\-|/|_|:|,|'|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_String100LTexto">
		<xs:restriction base="xs:string">
			<xs:maxLength value="100"/>
			<xs:pattern value="([A-Z]|[0-9]|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|Ñ|Ç|\s|\.|\-|/|_|:|,|'|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:complexType name="tipo_DatosIdentificativos">
		<xs:sequence>
			<xs:element name="Declarante" minOccurs="1" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<!-- <xs:element name="ZRUE" type="tipo_String30L" minOccurs="0" maxOccurs="1"/> -->
			...
			<xs:element name="Conyuge" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<!-- <xs:element name="ZRUE2" type="tipo_String30L" minOccurs="0" maxOccurs="1"/> -->
			...
			<xs:element name="Hijos" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="Hijo" minOccurs="1" maxOccurs="12">
							<xs:complexType>
								<xs:sequence>
						...
						<xs:element name="Ascendiente" minOccurs="1" maxOccurs="4">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:complexType>
										<xs:sequence>
											<xs:element name="FECHA1DA" type="tipo_Fecha" minOccurs="0" maxOccurs="1"/>
											<xs:element name="FECHA2DA" type="tipo_Fecha" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Complementaria">
		<xs:choice>
			...
			<xs:sequence>
				...
				<xs:element name="ING1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				<xs:element name="DEV1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			</xs:sequence>
		</xs:choice>
	</xs:complexType>
	<xs:complexType name="tipo_SolicitudRectificacion">
		<xs:sequence>
			...
			<xs:element name="RECTFDLG" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AjustesControl">
		<xs:sequence>
			<xs:element name="AjustesMinimoPersonal" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="MPERMOTIVO" type="tipo_String100LTexto" minOccurs="0" maxOccurs="1"/>
						<xs:element name="MPERAJUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="MPERAJUSAU" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="GANNOJUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
		<xs:attribute name="titular" type="tipo_Titular" use="required"/>
		<xs:attribute name="nif" type="tipo_Nif" use="required"/>
	</xs:complexType>
	<xs:complexType name="tipo_Resultados">
		<xs:sequence>
			...
			<xs:element name="BaseLiquidableRes" type="tipo_BaseLiquidableRes" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="IrpfCCAARes" type="tipo_IrpfCCAARes" minOccurs="1" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CalculoImpuestoRes">
		<xs:sequence>
			...
			<xs:element name="DeducDescendienteDiscRes" minOccurs="0" maxOccurs="12">
				<xs:complexType>
					<xs:sequence>
	...
	<xs:complexType name="tipo_RegularizacionRes">
		<xs:sequence>
			...
			<xs:element name="RESCOMP" type="tipo_ImpNegativo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="RESREC" type="tipo_ImpNegativo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="PJUSTIFICANTE" type="tipo_String13LNumeros" minOccurs="0" maxOccurs="1"/>
			<xs:choice>
			...
			<xs:element name="DeduccionViviendaHabitualRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="ADQ_E" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="ADQ_A" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VHCONS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="CONS_E" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="CONS_A" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VHREHB" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="REHB_E" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="REHB_A" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VH_DIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DIS_E" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DIS_A" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="PAGOSPRO" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NIFPRO" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
...
<!-- 						</xs:choice> -->
			...
			<xs:element name="ReservaInversionesCanariasRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M24EM4ANO" type="tipo_Integer2016a2017" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM3ANO" type="tipo_Integer2017a2018" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM2ANO" type="tipo_Integer2018a2019" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM1ANO" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM0ANO" type="tipo_Integer1a9999" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="DED2020" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="DeduccionesInversionEmpresarialRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M21CUSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CUSA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CUSP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21GTLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21GTLA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21GTLP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DJTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DJTA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DJTP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21CVMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CVMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CVMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PFLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PFLA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PFLP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21FIIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FIIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21FIIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CMBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CMBA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CMBP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MBFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MBFA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MBFP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AVMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AVMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21AVMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TLES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TLEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TLEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CYLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CYLA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CYLP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWTA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21BWTP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21NMSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21NMSA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21NMSP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ECHS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ECHA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ECHP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UMUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UMUA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UMUP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21LNCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21LNCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21LNCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CDES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CDEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CDEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ASJS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ASJA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ASJP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCBA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCBP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DTIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DTIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21DTIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PADS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PADA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21PADP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ECTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ECTA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ECTP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCRA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCRP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TRAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TRAA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21TRAP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CLES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CLEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CLEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21EDUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21EDUA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21EDUP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ENIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ENIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ENIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CCCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UMGS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UMGA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UMGP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21COPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21COPA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21COPP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21EPIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21EPIA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21EPIP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AnexoCRes">
		<xs:sequence>
			...
			<xs:element name="ExcesosSistemasPrevisionSocialRes" minOccurs="0" maxOccurs="4">
				<xs:complexType >
					<xs:sequence>
	...
	<xs:complexType name="tipo_AndaluciaRes">
		<xs:sequence>
			...
			<xs:element name="A2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AsturiasRes">
		<xs:sequence>
			...
			<xs:element name="PA3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="PA8" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="PA20" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CantabriaRes">
		<xs:sequence>
			...
			<xs:element name="CANT12" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CastillaYLeonRes">
		<xs:sequence>
			...
			<xs:element name="CL11P" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CL15" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_LaRiojaRes">
		<xs:sequence>
			...
			<xs:element name="MUNILR16" type="tipo_Integer1a9999" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="LR18" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="NIFLR18" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CValencianaRes">
		<xs:sequence>
			...
			<xs:element name="VA24" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="CANT17VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="CANT19VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="APL17VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="PDTE17VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="CANTVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="APLVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="PDTEVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="VA30" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="VA31" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
				...
				<xs:complexType>
					<xs:sequence>
						<xs:element name="B21" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RegistroB21" minOccurs="0" maxOccurs="10">
										<xs:complexType>
											<xs:sequence>
						...
						<xs:element name="B22" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RegistroB22" minOccurs="0" maxOccurs="10">
										<xs:complexType>
											<xs:sequence>
						...
						<xs:element name="B23" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RegistroB23" minOccurs="0" maxOccurs="10">
										<xs:complexType>
											<xs:sequence>
						...
						<xs:element name="B24" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RegistroB24" minOccurs="0" maxOccurs="10">
										<xs:complexType>
											<xs:sequence>
						...
						<xs:element name="B25" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RegistroB25" minOccurs="0" maxOccurs="10">
										<xs:complexType>
											<xs:sequence>
	...
	<xs:complexType name="tipo_InfAnexoC1_Inmuebles">
		<xs:sequence>
			<xs:element name="C1ORDEN" type="tipo_Integer1a999" minOccurs="0" maxOccurs="1"/>
			<xs:element name="C1ICT" type="tipo_Titular" minOccurs="0" maxOccurs="1" />
	...
	<xs:complexType name="tipo_InfAnexoD">
		<xs:sequence>
			<xs:element name="DORDEN" type="tipo_Integer1a999" minOccurs="0" maxOccurs="1" />
			<xs:element name="DICT" type="tipo_Titular" minOccurs="0" maxOccurs="1" />
	...
	<xs:complexType name="tipo_RegEstimaDirecta">
		<xs:sequence>
			<xs:element name="ActividadEstDirecta" minOccurs="0" maxOccurs="6">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="TACT" type="tipo_Opciones1a5" minOccurs="1" maxOccurs="1">
							<xs:annotation >
								<xs:documentation xml:lang="es">
						...
						<xs:element name="IAE" type="tipo_String5L" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_RegEstimaObj">
		<xs:sequence>
			<xs:element name="ActividadEstObj" minOccurs="0" maxOccurs="6">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="InformacionAdicionalEstObj" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="IN1" type="tipo_Integer1a999" minOccurs="0" maxOccurs="1"/>
								...
								<xs:attribute name="epigrafe" type="tipo_String5L" use="required"/>
	...
	<!-- E3. Rendimientos de actividades agrÃ­colas, ganaderas y forestales en
		estimaciÃ³n objetiva -->
									...
									<xs:element name="AR_RendCapiInmobiliario" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												...
												<xs:element name="IMP3" type="tipo_ImpNegativo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="IMP4" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<!-- <xs:complexType name="tipo_F5ENTIDAD"> -->
	<!-- <xs:sequence> -->
	<!-- <xs:element name="F5ED" type="tipo_Nif" minOccurs="1" maxOccurs="1"/> -->
	<!-- <xs:element name="IMPF5EA" type="tipo_ImpPositivo" minOccurs="1" maxOccurs="1"/> -->
	<!-- </xs:sequence> -->
	<!-- </xs:complexType> -->
	<xs:complexType name="tipo_GPPremios">
		<xs:sequence>
			...
			<xs:element name="Otras" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="G10" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="G11" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="ElementoPatrimonial" minOccurs="1" maxOccurs="80">
				<xs:complexType>
					<xs:sequence>
						<xs:choice>
							<xs:sequence>
								<xs:element name="RB1" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
								<xs:element name="CLAVE2" type="tipo_Opciones1a5" minOccurs="1" maxOccurs="1">
								<xs:annotation >
									<xs:documentation xml:lang="es">
										El elemento CLAVE2 tomará los valores:
										["1"=Inmueble con referencia catastral situado en España, excepto en el País Vasco o Navarra.
										 "2"=Inmueble situado en el País Vasco.
										 "3"=Inmueble situado en Navarra.
										 "4"=Inmueble sin referencia catastral asignada por el Catastro.
								...
								<xs:element name="REFERENCIA2" type="tipo_ReferenciaCatastral" minOccurs="0" maxOccurs="1"/>
								<xs:element name="REFERENCIA2A" type="tipo_ReferenciaCatastral" minOccurs="0" maxOccurs="1"/>
								<xs:element name="REFERENCIA2B" type="tipo_ReferenciaCatastral" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
							<xs:sequence>
								<xs:element name="RB2" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
								<xs:element name="COT" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
							<xs:element name="RB3" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
							<xs:element name="RB4" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
							<xs:element name="RB5" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
							<xs:sequence>
								<xs:element name="RB6" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
								<xs:element name="CLAVE1" type="tipo_Opciones1a5" minOccurs="1" maxOccurs="1">
								<xs:annotation >
									<xs:documentation xml:lang="es">
										El elemento CLAVE1 tomará los valores:
										["1"=Inmueble con referencia catastral situado en España, excepto en el País Vasco o Navarra.
										 "2"=Inmueble situado en el País Vasco.
										 "3"=Inmueble situado en Navarra.
										 "4"=Inmueble sin referencia catastral asignada por el Catastro.
								...
								<xs:element name="REFERENCIA1" type="tipo_ReferenciaCatastral" minOccurs="0" maxOccurs="1"/>
								<xs:element name="REFERENCIA1A" type="tipo_ReferenciaCatastral" minOccurs="0" maxOccurs="1"/>
								<xs:element name="REFERENCIA1B" type="tipo_ReferenciaCatastral" minOccurs="0" maxOccurs="1"/>
							</xs:sequence>
							<xs:element name="RB7" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						</xs:choice>
						<xs:sequence>
							<xs:choice>
								<xs:sequence>
...
<!-- -->						<xs:sequence>
 						...
 						<xs:element name="G2CL" type="tipo_Opciones1a5" minOccurs="0" maxOccurs="1">
 						<xs:annotation >
							<xs:documentation xml:lang="es">
								El elemento G2CL tomará los valores:
								["1"=Inmueble con referencia catastral situado en España, excepto en el País Vasco o Navarra.
								 "2"=Inmueble situado en el País Vasco.
								 "3"=Inmueble situado en Navarra.
								 "4"=Inmueble sin referencia catastral asignada por el Catastro.
						...
						<xs:element name="G2RC1" type="tipo_String20L" minOccurs="0" maxOccurs="1" />
						<xs:element name="G2RC2" type="tipo_String20L" minOccurs="0" maxOccurs="1" />
						<xs:element name="G2RC3" type="tipo_String20L" minOccurs="0" maxOccurs="1" />
						...
						<xs:element name="G2VTVH" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="G2EX50" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="G2EXRV" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="G2EXVH" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="InfAnexoC1" type="tipo_InfAnexoC1" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
	...
	<xs:complexType name="tipo_InfAnexoC1">
		<xs:sequence>
	...
	<xs:complexType name="tipo_InfAnexoC1_ExenVivienda">
		<xs:sequence>
			<xs:element name="C1ERGT" type="tipo_Titular" minOccurs="0" maxOccurs="1" />
	...
	<xs:complexType name="tipo_InfAnexoC1_ElemPat">
		<xs:sequence>
			<xs:element name="G2OORDEN" type="tipo_Integer1a999" minOccurs="0" maxOccurs="1" />
			<xs:element name="C1PAPT" type="tipo_Titular" minOccurs="0" maxOccurs="1" />
			...
			<xs:element name="C1G2RC1" type="tipo_String20L" minOccurs="0" maxOccurs="1" />
			<xs:element name="C1G2RC2" type="tipo_String20L" minOccurs="0" maxOccurs="1" />
			<xs:element name="C1G2RC3" type="tipo_String20L" minOccurs="0" maxOccurs="1" />
	...
	<xs:complexType name="tipo_RegimenEspecial">
		<xs:sequence>
			<xs:element name="G5RE1" type="tipo_Integer1a99" minOccurs="0" maxOccurs="1"/>
			<xs:element name="G5RE2" type="tipo_Integer1a99" minOccurs="0" maxOccurs="1"/>
			<xs:element name="NORF" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
	<!-- ANDALUCIA -->
	<xs:complexType name="tipo_Andalucia">
		<xs:sequence>
			...
			<xs:element name="A2" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECA2" type="tipo_String1L" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="A3" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="NCONA3" type="tipo_Opciones1a3" minOccurs="0" maxOccurs="1">
						<xs:annotation >
							<xs:documentation xml:lang="es">
								El elemento NCONA3 tomará los valores:
								["1"=Vivienda protegida de régimen general,"2"=Vivienda protegida en régimen especial,"3"=Vivienda protegida de precio limitado]
							</xs:documentation>
						</xs:annotation>
						</xs:element>
					</xs:sequence>
			...
			<xs:element name="A16" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPA16" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
	...
	<xs:complexType name="tipo_Aragon">
		<xs:sequence>
			...
			<xs:element name="AR3" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="C01AR3" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C02AR3" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Asturias">
		<xs:sequence>
			...
			<xs:element name="PA3" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPPA3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NUMPA3" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="PA4" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECPA4" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="PORPA4" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="PA5" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="MR1PA5" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
						<xs:choice>
						...
						<xs:element name="MR2PA5" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
						<xs:choice>
			...
			<xs:element name="PA8" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPPA8" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="PA19" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPPA19" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="PA20" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPPA20" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
	...
	<xs:complexType name="tipo_IBaleares">
		<xs:sequence>
			<xs:element name="IB1" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPIB1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="IB2" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="NUM1IB2" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NUM2IB2" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_Canarias">
		<xs:sequence>
			...
			<xs:element name="CAN5" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECCAN5" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="CAN21" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCAN21" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="CAN23" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="C01CAN23" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C02CAN23" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Cantabria">
		<xs:sequence>
			...
			<xs:element name="CANT12" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCANT12" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_CastillaYLeon">
		<xs:sequence>
			...
			<xs:element name="CL6" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCL6" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="CL14" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="VAL11CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VAL12CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NIF1CL14" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VAL21CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="VAL22CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NIF2CL14" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="CL15" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECCL15" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NUMCL15" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="CL19" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCL19" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="MATCL19" type="tipo_String7L" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="CL20" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="EJERCICIOCL20" type="tipo_Integer2016a2020" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
	...
	<xs:complexType name="tipo_Catalunya">
		<xs:sequence>
			...
			<xs:element name="CT3" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPCT3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_Extremadura">
		<xs:sequence>
			...
			<xs:element name="E3" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="C01E3" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C02E3" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C03E3" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C04E3" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Galicia">
		<xs:sequence>
			...
			<xs:element name="GA2" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="CAT1GA2" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="CAT1TGA2" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="CAT2GA2" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="CAT2TGA2" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NUMGA2" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_Murcia">
		<xs:sequence>
			...
			<xs:element name="MU4" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPMU4" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_LaRioja">
		<xs:sequence>
			...
			<xs:element name="LR18" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPLR18" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="NIFCRLR18" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
	...
	<xs:complexType name="tipo_CValenciana">
		<xs:sequence>
			<xs:element name="VA1" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="COM4VA1" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
						<xs:element name="DEC4VA1" type="tipo_Decimal012" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="VA3" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="NUM1VA3" type="tipo_Integer010" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="VA24" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECVA24" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="VA27B" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPVA27B" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="VA29" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP11VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="IMP21VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="IMP31VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="IMP41VA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="VA31" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMPVA31" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
...
<!-- 		<xs:attribute ref="codigoCA" use="required"/> -->
	</xs:complexType>
	<!-- E2. Rendimientos de actividades econÃ³micas (excepto agrÃ­colas, ganaderas y forestales en
		estimaciÃ³n objetiva -->
	...
	<xs:complexType name="tipo_RedBaseImponible">
		<xs:sequence>
				...
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="RedAportacionesParticipe" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RAOC" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="RAportacion" minOccurs="0" maxOccurs="4">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="PP2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="RedPensionesComensatoriasAlimentos" type="tipo_RedPensionesComensatoriasAlimentos" minOccurs="0" maxOccurs="2"/>
	...
	<xs:complexType name="tipo_RedPensionesComensatoriasAlimentos">
		<xs:sequence>
	...
	<xs:complexType name="tipo_RDeportistas">
		<xs:sequence>
			...
			<xs:element name="DEP_IMP1MDEX" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_DatosAdicionales">
		<xs:sequence>
			...
			<xs:element name="VIMPALIM" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:choice>
			...
			<xs:element name="IMPALIM" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	</xs:sequence>
	</xs:complexType>
						...
						<xs:element name="M24EM4S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM4S" type="tipo_Integer2016a2017" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM3S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM3S" type="tipo_Integer2017a2018" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM2S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM2S" type="tipo_Integer2018a2019" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM1S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM1S" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM0S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM0S" type="tipo_Anno" minOccurs="0" maxOccurs="1"/>
			 ...
			 <xs:element name="DeduccionesInversionEmpresarial" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M21IPCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="DED2M21IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP2M21IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21CUSS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CUSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CUSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21GTLS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21GTLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21GTLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21DJTS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21DJTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21DJTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21CVMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CVMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CVMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21PFLS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21PFLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21PFLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21FIIS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21FIIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21FIIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CMBS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CMBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CMBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21MBFS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21MBFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21MBFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21AVMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21AVMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21AVMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21TLES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21TLES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21TLES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21BWCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BWCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BWCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CYLS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CYLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CYLS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21BWTS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21BWTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21BWTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21NMSS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21NMSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21NMSS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>

						<xs:element name="M21ECHS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ECHS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ECHS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21UMUS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21UMUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21UMUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21LNCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21LNCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21LNCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CDES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CDES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CDES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ASJS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ASJS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ASJS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CCBS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CCBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CCBS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21DTIS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21DTIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21DTIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21PADS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21PADS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21PADS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ECTS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ECTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ECTS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CCRS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CCRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CCRS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21TRAS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21TRAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21TRAS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CLES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CLES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CLES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21EDUS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21EDUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21EDUS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ENIS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ENIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ENIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21CCCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CCCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21UMGS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21UMGS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21UMGS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21COPS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21COPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21COPS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21EPIS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21EPIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21EPIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M22AFS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED01M22AFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M22AFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="DED02M22AFS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M22IPCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M22IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M22IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="DED2M22IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP2M22IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="DED3M22IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP3M22IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
	...
	<xs:complexType name="tipo_DeduccionViviendaHabitual">
		<xs:sequence>
			...
			<xs:element name="CON1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="REHB1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="AMP1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="PITA" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="PAGOS1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="NIF1" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
			<xs:element name="IMPVH_DIS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
							...
							<xs:complexType>
								<xs:sequence>
										...
										<xs:complexType>
											<xs:sequence>
												...
												<xs:element name="INTDEMORAESTAUT3" minOccurs="0" maxOccurs="20">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINTD3" type="tipo_Opciones2009a2019" minOccurs="1" maxOccurs="1"/>
												...
												<xs:element name="INTDEMORAEST2" minOccurs="0" maxOccurs="6">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERVAL1INTD4" type="tipo_Opciones2009a2019" minOccurs="1" maxOccurs="1"/>
									...
									<xs:element name="InteresesDemoraAut" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="INTDEMORAAUT" minOccurs="0" maxOccurs="6">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINTDAUT" type="tipo_Opciones1998a2019" minOccurs="1" maxOccurs="1"/>
											...
											<xs:choice>
												<xs:element name="VRBG1" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:choice minOccurs="1" maxOccurs="1">
																<xs:element name="RTEXVRBG1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="ORBGEXVRBG1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="GANEXVRBG1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
															</xs:choice>
												...
												<xs:element name="VRBE1" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:choice minOccurs="1" maxOccurs="1">
																<xs:element name="RDTAHVRBE1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="GANAHVRBE1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
															</xs:choice>
											...
											<xs:choice>
												<xs:element name="VRBG2" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:choice minOccurs="1" maxOccurs="1">
																<xs:element name="RTEXVRBG2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="ORBGEXVRBG2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="GANEXVRBG2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
															</xs:choice>
												...
												<xs:element name="VRBE2" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:choice minOccurs="1" maxOccurs="1">
																<xs:element name="RDTAHVRBE2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="GANAHVRBE2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
															</xs:choice>
											...
											<xs:choice>
												<xs:element name="VRBG3" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:choice minOccurs="1" maxOccurs="1">
																<xs:element name="RTEXVRBG3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="ORBGEXVRBG3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="GANEXVRBG3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
															</xs:choice>
												...
												<xs:element name="VRBE3" minOccurs="0" maxOccurs="1">
													<xs:complexType>
														<xs:sequence>
															<xs:choice minOccurs="1" maxOccurs="1">
																<xs:element name="RDTAHVRBE3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
																<xs:element name="GANAHVRBE3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
															</xs:choice>
				...
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DeducMaternidad" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="PERIODOMATER" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:choice>
												<xs:element name="ANUALMATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
												<xs:sequence>
													<xs:element name="MES1MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES2MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES3MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES4MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES5MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES6MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES7MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES8MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES9MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES10MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES11MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
													<xs:element name="MES12MATER" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
												</xs:sequence>
											</xs:choice>
										</xs:complexType>
									</xs:element>
							...
							<xs:complexType>
								<xs:sequence>
									<xs:element name="FamiliaNumerosa" minOccurs="0" maxOccurs="3">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="VNIFN" type="tipo_String30L"/>
												<xs:choice>
												...
												<xs:element name="VVNUMFN" type="tipo_Integer010"/>
						...
						<xs:element name="RegularizacionDescendiente" minOccurs="0" maxOccurs="12">
							<xs:complexType>
								<xs:sequence>
	...
	<xs:element name="Declaracion">
		<xs:complexType>
			<xs:sequence>
				...
				<xs:attribute name="ejercicio" type="xs:string"  fixed="2020"/>
