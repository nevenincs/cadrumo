# 26-100-esquema-xsd-ejercicio-2021-actualizado-23-10-2024-606-kb-ejecutable.xsd
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" elementFormDefault="unqualified" attributeFormDefault="unqualified">
	...
	<xs:simpleType name="tipo_ReferenciaCatastral">
		<xs:restriction base="xs:string">
			...
			<xs:pattern value="([A-Z]|[0-9]|Ñ|Ü|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|\·|Â|Ê|Î|Ô|Û|Ç|\s|\.|\-|_|:|,|'|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_String4L">
		<xs:restriction base="xs:string">
			<xs:maxLength value="4"/>
			<xs:pattern value="([0-9]|[A-Z]|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|Ñ|\·|Â|Ê|Î|Ô|Û|Ç|\s|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_IndiceAgr">
		<xs:restriction base="xs:string">
			...
			<xs:pattern value="([0-9]|[A-Z]|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|\·|Â|Ê|Î|Ô|Û|Ñ|Ç|\s|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_String20L">
		<xs:restriction base="xs:string">
			<xs:maxLength value="20"/>
			<xs:pattern value="([0-9]|[A-Z]|.*|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ü|\·|Â|Ê|Î|Ô|Û|Ñ|Ç|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_String70L">
		<xs:restriction base="xs:string">
			...
			<xs:pattern value="([0-9]|[A-Z]|&quot;|Ã|Õ|Á|É|Í|Ó|Ú|À|È|Ì|Ò|Ù|Ä|Ë|Ï|Ö|Ü|\·|Â|Ê|Î|Ô|Û|Ñ|Ç|@|\+|\s|\.|&amp;|\-|,|'|/|:|;|_|\(|\))+"/>
		</xs:restriction>
	</xs:simpleType>
	...
	<xs:simpleType name="tipo_Integer2017a2021">
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="2017"/>
			<xs:maxInclusive value="2021"/>
		</xs:restriction>
	...
	<xs:simpleType name="tipo_Integer2010a2020">
		<xs:restriction base="xs:integer">
	...
	<xs:simpleType name="tipo_Opciones1998a2020">
		<xs:restriction base="xs:string">
			<xs:enumeration value="1998"/>
			<xs:enumeration value="1999"/>
			<xs:enumeration value="2000"/>
	...
	<xs:simpleType name="tipo_Opciones2009a2020">
		<xs:restriction base="xs:string">
			<xs:enumeration value="2009"/>
			<xs:enumeration value="2010"/>
			<xs:enumeration value="2011"/>
	...
	<xs:simpleType name="tipo_VivRural">
		<xs:annotation >
			<xs:documentation xml:lang="es">
				...
				[1 = Vivienda situada en zona rural en riesgo de despoblación
				 2 = Vivienda situada en el medio rural, excepto en riesgo de despoblación
				 3 = Vivienda situada en zonas distintas a las anteriores]
			</xs:documentation>
		</xs:annotation>
		<xs:restriction base="xs:integer">
			<xs:minInclusive value="1"/>
						...
						<xs:element name="ObrasEdificiosRes" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="PEXCEDIF" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
					</xs:sequence>
			...
			<xs:element name="ReservaInversionesCanariasRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M24EM5ANO" type="tipo_Integer2016a2017" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM5P" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM4S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M24EM4ANO" type="tipo_Integer2017a2018" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM3ANO" type="tipo_Integer2018a2019" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM2ANO" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM1ANO" type="tipo_Integer2020a2021" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM0ANO" type="tipo_Integer2021a2022" minOccurs="0" maxOccurs="1"/>
			...
			<xs:element name="DeduccionesInversionEmpresarialRes" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M21APMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21APMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21ASGS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ASGA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ASGP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21UNES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UNEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21UNEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21MCNS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MCNA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21MCNP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21CSCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CSCA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21CSCP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ENES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ENEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21ENEP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M21COMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21COMA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="M21COMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="PRODRG" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="FINRG" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="PRODCAN" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
						<xs:element name="FINCAN" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AnexoCRes">
		<xs:sequence>
			...
			<xs:element name="ContribucionesSistPrevisionSocialRTRes" minOccurs="0" maxOccurs="2">
				<xs:complexType >
					<xs:sequence>
						<xs:element name="C2ENCT" type="tipo_Titular" minOccurs="1" maxOccurs="1" />
						<xs:element name="C2ENCPEM5" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCAEM5" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPEM4" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCAEM4" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPFEM4" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPEM3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCAEM3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPFEM3" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPEM2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCAEM2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPFEM2" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPEM1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCAEM1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C2ENCPFEM1" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="AportacionesSistPrevisionSocialRGRes" minOccurs="0" maxOccurs="2">
				<xs:complexType >
					<xs:sequence>
						<xs:element name="ENRAPORT" type="tipo_Titular" minOccurs="1" maxOccurs="1" />
						<xs:element name="ENRAPORPER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="ENRAPORAPLI" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="ENRAPOREND" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="ContribucionesSistPrevisionSocialRGRes" minOccurs="0" maxOccurs="2">
				<xs:complexType >
					<xs:sequence>
						<xs:element name="ENRCONT" type="tipo_Titular" minOccurs="1" maxOccurs="1" />
						<xs:element name="ENRCONTPER" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="ENRCONTAPLI" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="ENRCONTPEND" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			...
			<xs:element name="GanPerCuartas" minOccurs="0" maxOccurs="36">
				<xs:complexType >
					<xs:sequence>
						...
						<xs:element name="G4AANO" type="tipo_Integer1a9999" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_CanariasRes">
		<xs:sequence>
			...
			<xs:element name="CAN27" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_AnBInfAdcInstAuto">
		<xs:sequence>
			...
			<xs:element name="CANTVHVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="APLVHVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="PDTEVHVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="CANTOTVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="APLOTVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
			<xs:element name="PDTEOTVA29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
		</xs:sequence>
	</xs:complexType>
			...
			<xs:element name="Inmueble" minOccurs="0" maxOccurs="180">
				<xs:complexType>
					<xs:sequence>
								...
								<xs:sequence>
									...
									<xs:complexType>
										<xs:sequence>
											...
											<xs:element name="VGTOALQ123" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
											<xs:element name="VNIFALQ123" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="C_GTOALQ123" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="C_NIFALQ123" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
				...
				<xs:complexType>
					<xs:sequence>
						<xs:choice>
							...
							<xs:element name="RB0" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
							<xs:sequence>
		...
		<xs:sequence>
			...
			<xs:element name="PA21" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:choice>
							<xs:element name="DECPA21" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
	...
	<xs:complexType name="tipo_Canarias">
		<xs:sequence>
			...
			<xs:element name="CAN27" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="InmueblesCAN27" minOccurs="0" maxOccurs="15">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="RESCAN27" type="tipo_SINO_Exclusivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="TITINMCAN27" type="tipo_Titularidad" minOccurs="0" maxOccurs="1"/>
									<xs:element name="PCINMCAN27" type="tipo_Porcentaje" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="VehiculosCAN27" minOccurs="0" maxOccurs="15">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="TIPOCAN27" type="tipo_Vehiculo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="TITVCCAN27" type="tipo_Titularidad" minOccurs="0" maxOccurs="1"/>
									<xs:element name="PCVCCAN27" type="tipo_Porcentaje" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
					</xs:sequence>
			...
			<xs:element name="CAN28" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="InmueblesCAN28" minOccurs="0" maxOccurs="10">
							<xs:complexType>
								<xs:sequence>
										<xs:element name="MESESCAN28" type="tipo_Integer1a99" minOccurs="0" maxOccurs="1"/>
										<xs:element name="TITCAN28" type="tipo_Titularidad" minOccurs="0" maxOccurs="1"/>
										<xs:element name="PCCAN28" type="tipo_Porcentaje" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
					</xs:sequence>
			...
			<xs:element name="CAN29" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="IMP1CAN29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						<xs:element name="IMP2CAN29" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
			<xs:element name="CAN30" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECCAN30" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
		...
		<xs:sequence>
			...
			<xs:element name="CL14" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:choice>
						<xs:sequence>
							<xs:element name="ContFallecidos2602" minOccurs="0" maxOccurs="1">
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="NIF1ACL14" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
										...
										<xs:element name="NIF2ACL14" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
								</xs:complexType>
							</xs:element>
						</xs:sequence>
							...
							<xs:element name="GuardCL14" minOccurs="0" maxOccurs="1">
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="DEDOP1CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
										...
										<xs:element name="DEDOP2CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
										...
										<xs:element name="DEDOP3CL14" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
								</xs:complexType>
							</xs:element>
						</xs:sequence>
			...
			<xs:element name="CL20" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="EJERCICIOCL20" type="tipo_Integer2017a2021" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
		</xs:sequence>
	...
	<xs:complexType name="tipo_CastillaLaMancha">
		<xs:sequence>
			...
			<xs:element name="CM17" minOccurs="0" maxOccurs="1">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="DECCM17" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
					</xs:sequence>
				</xs:complexType>
			</xs:element>
							...
							<xs:complexType>
								<xs:sequence>
									<xs:element name="V01PP1ORGEA" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="APORT1V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="APORT2V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="APORT3V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="APORT4V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="APORT5V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>

												<xs:element name="CONT1V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="CONT2V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="CONT3V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="CONT4V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="CONT5V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>

												<xs:element name="IMP11V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="IMP21V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="IMP31V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="IMP41V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
												<xs:element name="IMP51V01PP1ORGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
											</xs:sequence>
										</xs:complexType>
									</xs:element>
									...
									<xs:element name="V01PP3RGEA" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="CON2V01PP3RGEA" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
											</xs:sequence>
										</xs:complexType>
									</xs:element>
									...
									<xs:element name="RGONEMP" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM5S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM5S" type="tipo_Integer2016a2017" minOccurs="0" maxOccurs="1"/>
									...
									<xs:element name="V01PEND1M24EM5S" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M24EM4S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM4S" type="tipo_Integer2017a2018" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM3S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM3S" type="tipo_Integer2018a2019" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM2S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM2S" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM1S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM1S" type="tipo_Integer2020a2021" minOccurs="0" maxOccurs="1"/>
						...
						<xs:element name="M24EM0S" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:element name="V01ANOM24EM0S" type="tipo_Integer2021a2022" minOccurs="0" maxOccurs="1"/>
				...
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="M21IPCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DEDM21IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMPM21IPCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:choice>
										<xs:element name="PRODM21IPCS" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
										<xs:element name="FINM21IPCS" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
									</xs:choice>
									<xs:element name="NIF1M21IPCS" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									<xs:element name="NIF2M21IPCS" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									<xs:element name="NIF3M21IPCS" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21PAES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:sequence>
										<xs:element name="DEDM21PAES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
										<xs:element name="IMPM21PAES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
										<xs:choice>
											<xs:element name="PRODM21PAES" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
											<xs:element name="FINM21PAES" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
										</xs:choice>
										<xs:element name="NIF1M21PAES" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
										<xs:element name="NIF2M21PAES" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
										<xs:element name="NIF3M21PAES" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									</xs:sequence>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21APMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21APMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21APMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21ASGS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ASGS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ASGS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21UNES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21UNES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21UNES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21MCNS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21MCNS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21MCNS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21CSCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21CSCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21CSCS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						<xs:element name="M21ENES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21ENES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21ENES" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M21COMS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED1M21COMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
									<xs:element name="IMP1M21COMS" type="tipo_ImpPositivo" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
							...
							<xs:complexType>
								<xs:sequence>
									<xs:element name="DED01M22AFS" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="DesgloseDED01M22AFS" minOccurs="0" maxOccurs="11">
													<xs:complexType>
														<xs:sequence>
															...
															<xs:element name="ANIODED01M22AFS" type="tipo_Integer2010a2020" minOccurs="0" maxOccurs="1"/>
														</xs:sequence>
													</xs:complexType>
												</xs:element>
											</xs:sequence>
									...
									<xs:element name="DED02M22AFS" minOccurs="0" maxOccurs="1">
										<xs:complexType>
											<xs:sequence>
												<xs:element name="DesgloseDED02M22AFS" minOccurs="0" maxOccurs="2">
													<xs:complexType>
														<xs:sequence>
															...
															<xs:element name="ANIODED02M22AFS" type="tipo_Integer2019a2020" minOccurs="0" maxOccurs="1"/>
														</xs:sequence>
													</xs:complexType>
												</xs:element>
											</xs:sequence>
						...
						<xs:element name="M22IPCS" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:choice>
										<xs:element name="PRODM22IPCS" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
										<xs:element name="FINM22IPCS" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
									</xs:choice>
									<xs:element name="NIF1M22IPCS" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									<xs:element name="NIF2M22IPCS" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									<xs:element name="NIF3M22IPCS" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
						...
						<xs:element name="M22PAES" minOccurs="0" maxOccurs="1">
							<xs:complexType>
								<xs:sequence>
									...
									<xs:choice>
										<xs:element name="PRODM22PAES" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
										<xs:element name="FINM22PAES" type="tipo_logico" minOccurs="0" maxOccurs="1"/>
									</xs:choice>
									<xs:element name="NIF1M22PAES" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									<xs:element name="NIF2M22PAES" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
									<xs:element name="NIF3M22PAES" type="tipo_Nif" minOccurs="0" maxOccurs="1"/>
								</xs:sequence>
							</xs:complexType>
						</xs:element>
	...
	<xs:complexType name="tipo_MejorasEnergeticasViv">
		<xs:sequence>
			...
			<xs:element name="ObrasEdificios" minOccurs="0" maxOccurs="10">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="TITEDIF" type="tipo_Titular" minOccurs="0" maxOccurs="1"/>
										...
										<xs:complexType>
											<xs:sequence>
												...
												<xs:element name="INTDEMORAESTAUT3" minOccurs="0" maxOccurs="20">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINTD3" type="tipo_Opciones2009a2020" minOccurs="1" maxOccurs="1"/>
												...
												<xs:element name="INTDEMORAEST2" minOccurs="0" maxOccurs="6">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERVAL1INTD4" type="tipo_Opciones2009a2020" minOccurs="1" maxOccurs="1"/>
										...
										<xs:complexType>
											<xs:sequence>
												<xs:element name="INTDEMORAAUT" minOccurs="0" maxOccurs="6">
													<xs:complexType>
														<xs:sequence>
															<xs:element name="EJERINTDAUT" type="tipo_Opciones1998a2020" minOccurs="1" maxOccurs="1"/>
	...
	<xs:element name="Declaracion">
		<xs:complexType>
			<xs:sequence>
				...
				<xs:attribute name="ejercicio" type="xs:string"  fixed="2021"/>
