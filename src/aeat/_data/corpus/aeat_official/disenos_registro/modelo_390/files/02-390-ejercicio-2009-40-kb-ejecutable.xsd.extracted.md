# 02-390-ejercicio-2009-40-kb-ejecutable.xsd
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified" attributeFormDefault="unqualified">
	...
	<xs:complexType name="tipo_Doc">
		<xs:sequence>
			...
			<xs:element name="Ejercicio" type="xs:int" fixed="2009"/>
			<xs:element name="VER" type="tipo_IdDoc20" minOccurs="0"/>
			<xs:element name="SO" type="tipo_IdDoc20" minOccurs="0"/>
			<xs:element name="Justif" type="tipo_Justificante" minOccurs="0"/>
			<xs:element name="RefAEAT" type="tipo_IdDoc20" minOccurs="0"/>
	...
	<xs:element name="AEATIVA2009">
		<xs:complexType>
			<xs:sequence>
				...
				<xs:element name="FechaDecla" minOccurs="0">
					<xs:complexType>
						<xs:sequence>
							<xs:element name="Localidad" type="tipo_Localidad" minOccurs="0"/>
							<xs:element name="Fecha" type="tipo_Fecha" minOccurs="0"/>
						</xs:sequence>
					</xs:complexType>
				</xs:element>
								...
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="RegAgViajes" minOccurs="0">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="Tipo16" type="tipo_BaseImponible_y_Cuota"/>
												</xs:sequence>
											</xs:complexType>
										</xs:element>
							...
							<xs:element name="Deducciones" minOccurs="0">
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="RectifDeducciones" type="tipo_ImpNegativo" minOccurs="0"/>
							...
							<xs:element name="ActAgricGanadForest" minOccurs="0" maxOccurs="5">
								<xs:complexType>
									<xs:sequence minOccurs="0">
										...
										<xs:element name="IndCuota" type="tipo_InCuota"/>
										<xs:element name="CuotaDevengada" type="tipo_ImpPositivo" minOccurs="0"/>
					...
					<xs:element name="Administraciones" minOccurs="0">
						<xs:complexType>
							<xs:sequence>
								...
								<xs:element name="Alava" type="tipo_Porcentaje" minOccurs="0"/>
								<xs:element name="Guipuzcoa" type="tipo_Porcentaje" minOccurs="0"/>
								<xs:element name="Vizcaya" type="tipo_Porcentaje" minOccurs="0"/>
							...
							<xs:element name="Pro" maxOccurs="30">
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="Porc" type="tipo_ImpPositivo" minOccurs="0"/>
									</xs:sequence>
								</xs:complexType>
							</xs:element>
						</xs:sequence>
				...
				<xs:element name="IVADeducibleGrupo1" minOccurs="0">
					<xs:complexType>
						<xs:sequence>
							...
							<xs:element name="RectDeducciones" type="tipo_ImpNegativo" minOccurs="0"/>
