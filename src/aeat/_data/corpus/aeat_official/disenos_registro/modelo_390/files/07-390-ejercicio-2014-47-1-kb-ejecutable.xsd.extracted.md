# 07-390-ejercicio-2014-47-1-kb-ejecutable.xsd
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified" attributeFormDefault="unqualified">
	...
	<xs:complexType name="tipo_Doc">
		<xs:sequence>
			...
			<xs:element name="Ejercicio" type="xs:int" fixed="2014"/>
	...
	<xs:complexType name="tipo_ConcursoUltPer">
		<xs:choice>
	...
	<xs:complexType name="tipo_ConcursoAcr">
		<xs:choice>
			<xs:element name="ConcursoAcr_SI" type="tipo_ConcursoUltPer"/>
			<xs:element name="ConcursoAcr_NO">
				<xs:complexType/>
			</xs:element>
		</xs:choice>
	</xs:complexType>
					...
					<xs:complexType>
						<xs:sequence>
							...
							<xs:choice minOccurs="0">
								<xs:element name="DecSustitutiva">
									<xs:complexType/>
								</xs:element>
								<xs:element name="DecSustitutivaRectifica">
									<xs:complexType/>
								</xs:element>
							</xs:choice>
							...
							<xs:choice>
								<xs:element name="ConcursoAcreedores_SI" type="tipo_ConcursoUltPer" />
								<xs:element name="ConcursoAcreedores_NO">
									<xs:complexType/>
								</xs:element>
							</xs:choice>
							<xs:choice>
								<xs:element name="RegCriterioCaja_SI">
									<xs:complexType/>
								</xs:element>
								<xs:element name="RegCriterioCaja_NO">
									<xs:complexType/>
								</xs:element>
							</xs:choice>
							<xs:choice>
								<xs:element name="DestRegCriterioCaja_SI">
									<xs:complexType/>
								</xs:element>
								<xs:element name="DestRegCriterioCaja_NO">
									<xs:complexType/>
								</xs:element>
							</xs:choice>
						</xs:sequence>
							...
							<xs:element name="BaseImponibleyCuota" minOccurs="0">
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="RegCriterioCaja" minOccurs="0">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="Tipo4" type="tipo_BaseImponible_y_Cuota" minOccurs="0"/>
													<xs:element name="Tipo10" type="tipo_BaseImponible_y_Cuota" minOccurs="0"/>
										...
										<xs:element name="ModBasesyCuotasOpIntragrupo" minOccurs="0">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="TipoX" type="tipo_BaseImponible_y_Cuota"/>
												</xs:sequence>
							...
							<xs:element name="Deducciones" minOccurs="0">
								<xs:complexType>
									<xs:sequence>
										...
										<xs:element name="RectifOpIntragrupo" minOccurs="0">
											<xs:complexType>
												<xs:sequence>
													<xs:element name="TipoX" type="tipo_BaseImponible_y_Cuota"/>
												</xs:sequence>
				...
				<xs:element name="VolOperaciones" minOccurs="0">
					<xs:complexType>
						<xs:sequence>
							...
							<xs:element name="OpRegEspCriterioCaja" type="tipo_ImpPositivo" minOccurs="0"/>
				...
				<xs:element name="OpEspecificas" minOccurs="0">
					<xs:complexType>
						<xs:sequence>
							...
							<xs:element name="EntregasCriterioCajaBase" minOccurs="0">
								<xs:complexType>
									<xs:sequence>
										<xs:element name="TipoX" type="tipo_BaseImponible_y_Cuota"/>
									</xs:sequence>
							...
							<xs:element name="AdqCriterioCajaBase" minOccurs="0">
								<xs:complexType>
									<xs:sequence>
										<xs:element name="TipoX" type="tipo_BaseImponible_y_Cuota"/>
									</xs:sequence>
