# 17-390-y-392-ejercicio-2004-2005-y-2006-37-kb-ejecutable.xsd
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified" attributeFormDefault="unqualified">
	...
	<xs:complexType name="tipo_Doc">
		<xs:sequence>
			...
			<xs:element name="Ejercicio" type="xs:int" fixed="2006"/>
	...
	<xs:simpleType name="tipo_CDeleg">
		<xs:restriction base="xs:string">
			<xs:length value="2"/>
			<xs:pattern value="([0-9]){2}"/>
		</xs:restriction>
	</xs:simpleType>
	<xs:simpleType name="tipo_CAdmon">
		<xs:restriction base="xs:string">
			<xs:length value="3"/>
	...
	<xs:complexType name="tipo_CodAdmon">
		<xs:sequence>
			<xs:element name="CDeleg" type="tipo_CDeleg"/>
			<xs:element name="CAdmon" type="tipo_CAdmon"/>
		</xs:sequence>
	</xs:complexType>
	...
	<xs:element name="AEATIVA2006">
		<xs:complexType>
			<xs:sequence>
				<xs:element name="IdDoc" type="tipo_Doc"/>
				<xs:element name="CodAdmon" type="tipo_CodAdmon"/>
