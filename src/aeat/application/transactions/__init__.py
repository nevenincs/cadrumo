"""Transaction-classification orchestration (application layer).

Service helpers for transaction catalogues. Orchestration counterpart to
``aeat.domain.transactions`` — models, errors, and the repository remain
in the domain; only the mutation/query helpers that coordinate multiple
...
from ...domain.transactions._errors import TransactionCatalogueError, TransactionNotFoundError
from ...domain.transactions._models import ClassificationHistoryEntry, Transaction, TransactionCatalogue
