...
:func:`~aeat.application.transactions.import_ledger_with_diagnostics` evaluates
provider-emitted :class:`~aeat.domain.transactions.RawTransaction` rows against
an existing :class:`TransactionCatalogue`, returns an immutable
:class:`~aeat.application.transactions.LedgerImportResult`, and leaves catalogue
mutation, FX normalization, and bucket-event emission to
:mod:`aeat.application.ledger`. Duplicate diagnostics use the same
...
See Also:
    :class:`~aeat.application.transactions.LedgerImportDiagnostic`
    ...
    :class:`~aeat.application.transactions.LedgerImportResult`
        Immutable preview summary containing imported/skipped counts and
        diagnostics.
    :func:`~aeat.application.transactions.import_ledger_with_diagnostics`
