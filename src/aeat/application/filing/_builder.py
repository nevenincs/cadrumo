"""Builder ABC for the :mod:`aeat.filing` subpackage.

Concrete builders live under :mod:`aeat.filing._builders` and
register themselves on import. Callers from outside
:mod:`aeat.filing` MUST never import a builder directly.
"""
