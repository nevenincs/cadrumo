"""Regression: the extemporaneidad recargo advisory fires for late M303 quarters.
...
(:func:`aeat.application.modelo.modelo_work_plazo_summary` +
...
needed: a late M303 quarter already surfaces the recargo advisory.
...
carries an overdue posture plus the Art. 27 LGT recargo summary, and an in-time
