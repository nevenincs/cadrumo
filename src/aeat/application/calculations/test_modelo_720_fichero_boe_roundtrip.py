...
_INPUTS: dict[str, object] = {
    ...
    "modelo-720-2013.type_2.36-75.apellidos-y-nombre-razon-social-o-denominacion-del-declarado": ["BANQUE DE FRANCE PARIS", "LONDON SECURITIES BROKER LTD"],
    ...
    "modelo-720-2013.type_2.251-414.domicilio-de-la-entidad-o-ubicacion-del-inmueble": ["3 RUE D ANTIN PARIS 75002", "1 CANADA SQUARE LONDON E14 5AB"],
    ...
    "modelo-720-2013.type_2.432-446.valoracion-1-saldo-o-valor-a-31-de-diciembre-saldo-o-valor-e": ["060000000000000", "055000000000000"],
    "modelo-720-2013.type_2.447-461.valoracion-2-importe-o-valor-de-la-transmision-saldo-medio-u": ["000000000000000", "000000000000000"],
