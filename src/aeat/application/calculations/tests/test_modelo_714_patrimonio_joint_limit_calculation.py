...
from ....domain.calculations.registry._formula_runtime import RegistryCalculationResult, calculate_registry_snapshot
from ....domain.calculations.registry._ids import RelationId
...
def _calculate_714_from_local_m100(
    *,
    ...
    snapshot = resources().modelos.authority.snapshot(_MODELO, filing_year=scenario.filing_year, period="0A")
