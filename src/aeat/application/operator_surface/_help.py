    ...
    return HelpDocument(
        ...
        sections=(
            ...
            _section(
                ...
                _entry("aeat app ledger list", "List ledger transactions"),
                _entry("aeat app ledger read", "Read one ledger transaction"),
                _entry("aeat app ledger status", "Summarize ledger readiness"),
                _entry("aeat app ledger review", "Review ledger rows"),
                _entry("aeat app ledger edit", "Correct ledger transaction facts"),
                _entry("aeat app ledger classify", "Classify ledger transactions"),
