...
async def _default_expedientes_source(
    ...
    """Default seam: forward to the live :func:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.sede.walk_expedientes_tree`."""
...
async def _default_notifications_source(session: AeatSession) -> NotificationsSnapshot:
    """Default seam: forward to the live :func:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.sede.fetch_notifications_query`."""
...
def _period_to_year(period: str) -> int | None:
    ...
    :attr:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.sede.Expediente.ejercicio` as a separate integer year,
...
def _classify_cert_expiry(
    *,
    ...
    rich :class:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.auth.LoadedCertificate`, so it can be called from
    the workflow engine without forcing certificate-only types into the
    workflow boundary. Boundary semantics match
    :func:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.auth.evaluate_loaded_certificate_health`:
...
class WorkflowEngine:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            session: Optional authenticated :class:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.auth.AeatSession`
                used to drive the live :mod:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.sede` reader. ``None``
            ...
            expedientes_source: Test seam over
                :func:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.sede.walk_expedientes_tree`. Defaults to the
                live walker.
            notifications_source: Test seam over
                :func:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.sede.fetch_notifications_query`. Defaults to
                the live fetcher.
        """
    ...
    def _record_site_unavailable(
        ...
        *,
        ...
        composes a :class:`aeat.adapters.outbound.aeat.adapters.outbound.aeat.browser._site_health.SiteHealthAlert`
