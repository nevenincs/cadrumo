...
class WorkflowStateRepository:
    ...
    def reset_workflow_state(
        ...
        *,
        ...
        ``state``; no other namespace or row is touched. A
        ``workflow_state.reset`` bucket event is emitted with the
        envelope's row-level fingerprint in the same logical
        transaction as the delete. The fingerprint never carries
