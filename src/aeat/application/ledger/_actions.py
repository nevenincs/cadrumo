...
def split_transaction(
    *,
    ...
    - Catalogue + event are persisted atomically via
      :func:`_save_transaction_catalogue_and_events`.
    """
    ...
    parent_sign = parent_amount.is_signed()
    for index, child in enumerate(children):
        ...
        if child.amount.is_signed() != parent_sign:
            raise TransactionValidationError(
    ...
    child_ids = tuple(transaction.transaction_id for transaction in child_transactions)
