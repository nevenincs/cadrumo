...
class AuthDiagnosticPhoneStateError(CoreValidationError):
    ...
    :func:`application.auth._diagnostics.record_auth_diagnostic_phone_state`
...
class AuthDiagnosticPayloadError(CoreValidationError):
    ...
    :func:`application.auth._diagnostics._payload` (non-object JSON body)
    and :func:`application.auth._diagnostics._summary_from_payload`
