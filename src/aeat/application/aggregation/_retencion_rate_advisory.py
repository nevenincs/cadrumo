...
(:attr:`~aeat.core.aggregation.RetencionScheme.WORK_INCOME`) the withholding is a
...
(:attr:`~aeat.core.aggregation.RetencionScheme.WORK_INCOME_DIRECTOR`) the law
...
grounded in the statutory :class:`~aeat.core.aggregation.WorkIncomeRetencionTreatment`
...
def administrador_retencion_rate_advisory_observations(
    ...
    :attr:`~aeat.core.aggregation.RetencionScheme.WORK_INCOME_DIRECTOR`
