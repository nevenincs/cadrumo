"""Unit tests for Modelo 100 Anexo G — cuotas + tarifas (2026).
...
from .. import MODELO_100_2024, MODELO_100_2026
...
class TestProgressiveTarifaEstatalGeneral:
    ...
    def test_tarifa_blg_progressive_anchors(
        ...
        """
        inputs = _zero_inputs(MODELO_100_2026)
        ...
        inputs["0001"] = blg
        derived = _derived(MODELO_100_2026, inputs)
