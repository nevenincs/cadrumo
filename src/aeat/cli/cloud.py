...
def _adc() -> Any:
    ...
    from ..auth import CLOUD_PLATFORM_SCOPE, get_credentials_for_scopes
...
def functions_list() -> None:
    ...
    a single call.
    """
    from ..auth import build_cloudfunctions_client
...
def run_list() -> None:
    ...
    from ..auth import build_cloudrun_client
...
def storage_buckets() -> None:
    ...
    from ..auth import build_storage_client
