...
``aeat.financial.usage_ratios.profile.v1``.
"""
...
_HKDF_CONTEXT_USAGE_RATIOS = b"aeat.financial.usage_ratios.profile.v1"
...
def load_usage_ratios(path: Path) -> UsageRatioProfile:
    ...
    ``aeat.financial.usage_ratios.profile.v1`` at FINANCIAL class.
