"""Repository-owned, storage-free fixtures for the profile journey shell.
...
from cadrumo.application.user_profile.presentation import (
...
from cadrumo.entrypoints.tui.profile.app import ProfileJourneyScreen
...
#: Only the registry is published. The scenario enum and spec type are
#: reached through the specs themselves, and a resolver mirroring the
#: workbench module was copied here with no caller -- publishing a name
#: nothing collects is a promise, not an API.
__all__ = ["PROFILE_FIXTURES"]
