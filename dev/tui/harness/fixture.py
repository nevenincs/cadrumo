...
_STATE_ROOT = load_settings().cadrumo_local_storage_root / "development" / "tui"
...
def harness_storage(*, fresh: bool = False, namespace: str = "profile") -> Generator[Path]:
    ...
    from cadrumo.entrypoints.tui.launcher import profile_storage_scope
...
def registration_attempt(
    ...
    """
    from cadrumo.entrypoints.tui.secret.registration import build_profile_registration_attempt
