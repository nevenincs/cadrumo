...
from cadrumo.entrypoints.tui.aeat_sync.controller import AeatSyncWorkspaceController
from cadrumo.entrypoints.tui.aeat_sync.routes import resolve_aeat_sync_screen
from cadrumo.entrypoints.tui.aeat_sync.screens import (
...
from cadrumo.entrypoints.tui.declarations.models import DeclarationsDestinationIdV1
from cadrumo.entrypoints.tui.declarations.overview import DeclarationsModeloWorkspaceLauncherScreen
from cadrumo.entrypoints.tui.declarations.routes import resolve_declarations_screen
...
from cadrumo.entrypoints.tui.navigation import (
...
def _ledger_projection(scenario: WorkbenchFixtureScenario) -> LedgerWorkspaceProjectionV1:
    ...
    """
    from cadrumo.application.ledger.workspace import LedgerWorkspaceEntryRefV1
...
def _ledger_app(surface_id: str, scenario: WorkbenchFixtureScenario) -> App[Any]:
    ...
    """
    from cadrumo.entrypoints.tui.ledger.routes import resolve_ledger_screen
...
def _ledger_routes() -> tuple[tuple[str, Any, LedgerWorkspaceArea], ...]:
    from cadrumo.entrypoints.tui.ledger.classification import LedgerClassificationScreen
    from cadrumo.entrypoints.tui.ledger.entries import LedgerEntriesScreen
    from cadrumo.entrypoints.tui.ledger.evidence import LedgerEvidenceScreen
    from cadrumo.entrypoints.tui.ledger.import_flow import LedgerImportScreen
    from cadrumo.entrypoints.tui.ledger.overview import LedgerOverviewScreen
    from cadrumo.entrypoints.tui.ledger.reconciliation import LedgerReconciliationScreen
    from cadrumo.entrypoints.tui.ledger.review import LedgerReviewScreen
