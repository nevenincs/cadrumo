"""Real behavior proof for the development journal and replay modules.

These behavioral tests live with the development-only package they exercise;
the product tree contains neither their subjects nor their test support.
"""
