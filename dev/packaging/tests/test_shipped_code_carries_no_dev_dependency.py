...
to every operator, in the wheel. The ``no-dev-in-shipped`` Import Linter
contract catches a shipped module importing this repo's own ``dev/`` tree.
This test catches the
