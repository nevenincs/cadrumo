...
_INVOICE_MODELS = _ROOT / "src/cadrumo/domain/invoices/_models.py"
_IVA_CLASSIFICATION = _ROOT / "src/cadrumo/domain/iva/_classification.py"
_BULK_IMPORT = _ROOT / "src/cadrumo/application/invoices/_bulk_import.py"
