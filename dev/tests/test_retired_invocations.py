...
#: root from this file's own location: `dev/tests/<this file>`.
...
def _retired_citations() -> tuple[str, ...]:
    ...
    return tuple(context + invocation for invocation in RETIRED_INVOCATIONS for context in CITATION_CONTEXTS)
