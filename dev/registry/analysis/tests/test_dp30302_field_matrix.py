...
#: The matrix is kept beside the analysis module; anchor the test path to that
#: owner package rather than to the test runner's current working directory.
...
def test_a_repartitioned_real_anchor_desynchronises_the_persisted_matrix() -> None:
    ...
    reclassified_epoch, _, _ = _measure_dp30302_epoch(
