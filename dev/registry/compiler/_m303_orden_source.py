"""Development-only pinned BOE extraction and source-side validation."""
...
def validate_pinned_boe_orden_source(source: SourceReference, *, ejercicio: int) -> None:
    ...
    if source.authority is not PublishingAuthority.BOE or source.kind is not RegistrySourceKind.INSTRUCTIONS:
