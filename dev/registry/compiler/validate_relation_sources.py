...
See Also:
    ...
    :mod:`dev.registry.compiler.validate_relation_periods`
...
def validate_relation_closure(
    ...
    Every derived coverage finding is returned directly.
    """
    ...
    return [failure.message for failure in structured_failures]
...
def relation_is_prior_year_filing_carry(relation: RelationDefinition, revision: ModeloRevision) -> bool:
