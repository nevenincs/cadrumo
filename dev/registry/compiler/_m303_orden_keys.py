"""Development-only legal-axis keys for annual Orden compilation."""
...
def annual_orden_legal_keys(census: M303AnnualOrdenSourceCensus) -> set[str]:
    return {
        ...
        *(() if census.lorca_reduction is None else (lorca_reduction_legal_key(),)),
    }
...
def lorca_reduction_legal_key() -> str:
    return "lorca-reduction"
