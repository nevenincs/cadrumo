...
different construction contract. It lives beside the development compiler
because the compiler itself is one of the constructor sites the census must
reach.
"""
...
from cadrumo.tests.inventory import REPO_ROOT, SRC_CADRUMO
