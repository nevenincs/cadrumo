...
def validate_export_layout_section(
    *,
    ...
    validate_generated_projection_layout_bijection(failures, prefix=prefix, revision=revision)
...
def validate_embedded_envelope_source_authority(
    failures: list[str],
    *,
    prefix: str,
...
def validate_generated_projection_layout_bijection(
    failures: list[str],
    *,
    prefix: str,
    revision: ModeloRevision,
