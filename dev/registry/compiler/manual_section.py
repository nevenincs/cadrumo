"""Strict pydantic v2 records for extracted *Manual práctico* sections.

Registry compilation validates manual-section legal evidence against these
records.

A :class:`Section` holds prose paragraphs and extracted :class:`Rule` objects.
