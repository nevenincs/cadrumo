"""Development-only: a row that kept its length and naturaleza but lost its position entirely.
...
from dev.registry.compiler.record_design_pdf_state import PdfParseState
