...
def test_explicit_clear_differs_from_omitted_family(tmp_path: Path) -> None:
    ...
    modelo = _build_modelo(
        tmp_path / "cleared",
        successor_extra='cleared_families = [{ family = "constructs", cause = "official_structure_withdraws", reason = "The document governing this edition lays out no construct at all." }]\n',
    )
