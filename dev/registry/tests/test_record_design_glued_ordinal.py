"""Development-only: a row whose ordinal and position were run together, split only when pinned.
...
from dev.registry.compiler.record_design_pdf_rows import split_glued_ordinal_position
