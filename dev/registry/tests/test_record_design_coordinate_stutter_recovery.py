"""Development-only: a row whose coordinate column was damaged is rebuilt from the stutter restating it.
...
from dev.registry.compiler.record_design_pdf_repairs import recover_coordinate_stutter_rows
