"""Development-only: a row whose position lost a digit is restored from the pair restating it below.
...
from dev.registry.compiler.record_design_pdf_repairs import repair_truncated_offset_rows
