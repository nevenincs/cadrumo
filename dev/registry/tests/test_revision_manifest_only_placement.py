...
_FIELD_LITERALS: dict[str, str] = {
    ...
    "binding_source_refs": '["aeat-manual"]',
    "formula_source_refs": '["aeat-manual"]',
    "application_link_source_refs": '["aeat-manual"]',
    "applicability_source_refs": '["aeat-manual"]',
    "filing_schedule_source_refs": '["aeat-manual"]',
    "live_cross_reference_source_refs": '["aeat-manual"]',
    "extraction_profile_source_refs": '["aeat-manual"]',
    "dependency_classification_source_refs": '["aeat-manual"]',
    "construct_source_refs": '["aeat-manual"]',
    "parameter_source_refs": '["aeat-manual"]',
    "valid_to": "2025-12-31",
    "predecessor": '"2024"',
    ...
    "restated_families": (
        '[{ family = "formulas", cause = "official_structure_differs", reason = "declared for the placement refusal" }]'
    ),
}
...
def test_the_manifest_only_set_is_exactly_todays_marked_fields() -> None:
    ...
    expected = REVISION_GOVERNANCE_FIELDS | {
        "applicability_source_refs",
        "application_link_source_refs",
        "authority_grade",
        "binding_source_refs",
        "casilla_source_refs",
        "construct_source_refs",
        "dependency_classification_source_refs",
        "extraction_profile_source_refs",
        "family_dispositions",
        "filing_schedule_source_refs",
        "formula_source_refs",
        "legal_refs",
        "live_cross_reference_source_refs",
        "orden_aplicabilidad",
