...
Scope: fixed-width layouts. A revision exporting through an ``xml_dictionary``
layout does not carry per-casilla ``export_refs`` -- Modelo 100 documents that
explicitly -- so this writer is never pointed at one.
"""
