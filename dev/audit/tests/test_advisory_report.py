...
rendering, and the disk-persistence round trip. The dead-code dimension is
exercised for real in ``test_advisory_dimensions_scan``; the full
four-dimension `build_advisory_report` composition -- which includes a
