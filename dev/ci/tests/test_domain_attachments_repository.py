...
def test_un_enveloped_blob_is_refused(
    ...
    from cadrumo.adapters.persistence.storage.secure_object_namespaces import ATTACHMENT_BLOB_NAMESPACE
...
def test_foreign_bucket_manifest_is_isolated_from_load_and_listing(
    ...
    from cadrumo.adapters.persistence.storage.secure_object_namespaces import ATTACHMENT_MANIFEST_NAMESPACE
