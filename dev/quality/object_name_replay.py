...
def replay_object_name_component(
    ...
    *,
    ...
    try:
        ...
        # Generated artifacts are produced by their declared owner in the live tree.
        generator_missing_directories: list[Path] = []
        ...
        for relative in sorted(generated_paths):
            if mutation_intents.get(relative) != proposed_payloads[relative]:
