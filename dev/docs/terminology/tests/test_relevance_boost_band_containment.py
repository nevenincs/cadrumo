...
def _strongest_committed_boosts() -> dict[tuple[str, str], float]:
    ...
    """
    from dev.docs.terminology._miss_rate import relevance_mapping_path
...
def _display_class_for_kind(kind: str):
    ...
    from dev.docs.terminology._unified_record import _KIND_TO_DISPLAY_CLASS
...
def test_the_committed_corpus_actually_contains_boosts_that_would_escape() -> None:
    ...
    """
    from dev.docs.terminology._unified_record import display_class_band_ceiling
...
def test_no_contained_boost_reaches_the_floor_of_any_higher_class() -> None:
    ...
    from dev.docs.terminology._unified_record import contain_boost_in_band, display_class_base_weight
