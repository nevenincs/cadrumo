...
:func:`aeat.tests._worker_count_hook.resolve_auto_num_workers`, so every
...
from aeat.tests._worker_count_hook import resolve_auto_num_workers as _resolve_auto_num_workers
