...
- `W04.P04.S11` is left unchecked and formally deferred to the follow-up
  reference `2026-07-10-live-censo-calendar-reconciliation-reference`. Its
  positive submitted/justificante-verified proof becomes producible only once
  (a) the G313 censo launcher is re-grounded and (b) the AEAT account carries a
  filed declaration. Closing it now would overclaim against the plan's own
  no-silent-under-declaration / external-blocker-keeps-step-open discipline.
