...
<!-- FRONTMATTER RULES:
     ...
     Replace y-siguientes-verification with a kebab-case feature tag, e.g. #foo-bar.
...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### y-siguientes multi-year revision correctness verification | {level} | {summary}

     followed by a paragraph carrying the detail. y-siguientes multi-year revision correctness verification is a concise kebab-case slug,
