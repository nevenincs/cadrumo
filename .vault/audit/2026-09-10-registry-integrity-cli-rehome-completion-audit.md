...
modified: '2026-09-10'
body_schema: 'body-v2'
body_hash: 'sha256:e39c42f06a48d2836c84223a6d114550ee7af2194355ed7c5188e08be28a77ca'
related: []
---

<!-- FRONTMATTER RULES:
     tags: one directory tag (hardcoded #audit) and one feature tag.
     Replace registry-integrity-cli-rehome with a kebab-case feature tag, e.g. #foo-bar.
...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### Registry integrity CLI rehome | {level} | {summary}

     followed by a paragraph carrying the detail. Registry integrity CLI rehome is a concise kebab-case slug,
