...
# Feature tag (replace calc-engine-aeat-coverage with your feature name, e.g., #editor-demo)
...
# `calc-engine-aeat-coverage` audit: `Calc-engine hardening session — task ledger and verification snapshot`
