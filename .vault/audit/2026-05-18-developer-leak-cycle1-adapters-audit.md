...
# Feature tag (replace developer-leak-cycle1-adapters with your feature name, e.g., #editor-demo)
# Additional tags may be appended below the required pair
tags:
  - '#audit'
  - '#developer-leak-cycle1-adapters'
...
# `developer-leak-cycle1-adapters` audit: `{title}`
