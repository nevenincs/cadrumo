...
modified: '2026-08-30'
body_schema: 'body-v2'
body_hash: 'sha256:9225516ba45595183541eda158c531044dcd390542f52ddeb345de03e73a24e7'
related:
...
<!-- FRONTMATTER RULES:
     ...
     Replace tui-interface with a kebab-case feature tag, e.g. #foo-bar.
...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### Open rows whose deliverables an accepted decision retired | {level} | {summary}

     followed by a paragraph carrying the detail. Open rows whose deliverables an accepted decision retired is a concise kebab-case slug,
