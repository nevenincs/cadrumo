...
Proceed with `P06.S31` as the next open step. Keep the remaining Phase `P06` verification work limited to anti-shim and unaffected-model tests without adding new M145 behavior.
