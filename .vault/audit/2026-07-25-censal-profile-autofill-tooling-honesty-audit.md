...
The withdrawal cost nothing because it was caught, but it was produced by the author of this record and shipped here as verified. The reasoning was: run the function, observe the four keys returned as unknown, report it as directly verified rather than taken on report. What was actually verified was the function's return value. What was inferred, and never checked, was what that return value MEANS - read off the function's name and the field's name. A catalogue named like a validator, holding a field named like a gap, is a strong-looking inference and a worthless one.
