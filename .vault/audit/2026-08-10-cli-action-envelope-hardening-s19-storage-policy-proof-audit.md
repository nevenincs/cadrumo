...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### S19 storage-policy exact scenario proof | {level} | {summary}

     followed by a paragraph carrying the detail. S19 storage-policy exact scenario proof is a concise kebab-case slug,
