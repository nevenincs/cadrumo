...
- Scope: `src/aeat/auth/certificate.py`, `src/aeat/auth/test_certificate.py`, `env/.env.example`
...
- `uv run pytest src/aeat/auth/test_certificate.py tests/test_config.py src/aeat/setup/test_wizard.py -q` -> passed (`38 passed`)
