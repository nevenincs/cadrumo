...
<!-- FRONTMATTER RULES:
     ...
     The S01 and 2026-06-15-service-capabilities-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add ServiceCapability StrEnum (cloud_evidence_upload, llm_vision, google_export) in core with per-member docstrings and ## Scope

- `src/aeat/core` placeholders below are machine-filled
