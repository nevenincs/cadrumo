...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-06-05-live-censo-calendar-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rerun live Modelo 036 censo pull, compare, apply, expedientes, notifications, filed history, and justificante pulls and ## Scope

- `src/aeat/entrypoints/cli/_config/_profile_censo.py` placeholders below are machine-filled
