...
modified: '2026-08-07'
body_schema: 'body-v1'
body_hash: 'sha256:c102f61fd6a6e4113cf2811a695fc0e7ac2cdabf054968f109e531ede403dc08'
step_id: 'S79'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S79 and 2026-08-06-llm-package-split-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a representable recargo slot to the extraction draft, since the printed-total discrepancy advisory now fires with no field for the operator to resolve it into, red if a recargo-bearing document still leaves the operator no place to record it and ## Scope
