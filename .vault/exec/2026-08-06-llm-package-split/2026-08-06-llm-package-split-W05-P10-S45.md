...
modified: '2026-08-07'
body_schema: 'body-v1'
body_hash: 'sha256:edf9ceb8b0a98d0002833f028d9bffefe913e8d0daf4c2b5503f0cfe70276956'
step_id: 'S45'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S45 and 2026-08-06-llm-package-split-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Choose the local text model under the consumer-hardware constraint that binds the vision default, red if the chosen model's floor exceeds the declared hardware floor and ## Scope
