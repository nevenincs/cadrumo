...
modified: '2026-08-07'
body_schema: 'body-v1'
body_hash: 'sha256:c188a00c9d0e1b489ef1e1e9ea5b59486f54b8639c519102bbb069af11f94499'
step_id: 'S14'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-08-06-llm-package-split-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a deterministic EN16931 UBL parser, since a CII-only reader silently returns nothing for half the standard, red if a UBL document yields no record where the CII path yields one and ## Scope
