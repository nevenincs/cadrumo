...
modified: '2026-08-07'
body_schema: 'body-v1'
body_hash: 'sha256:73885bff5bf710b9414dd2f95f5fe0b4432707cd3ac427da0e81624189354031'
step_id: 'S54'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S54 and 2026-08-06-llm-package-split-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Edit the remaining mixed test modules case by case since the evidence resolver branches internally, red if a case is deleted rather than re-pointed and its coverage silently disappears and ## Scope
