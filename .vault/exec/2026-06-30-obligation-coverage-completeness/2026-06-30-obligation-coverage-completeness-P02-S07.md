...
- Modelo 369 legal grounding: `orden-hac-610-2021:art-1` (aprobación del modelo 369), `orden-hac-610-2021:art-2` (obligados a presentar, BOE-A-2021-10161, corpus-backed with required_text "Estado miembro de identificación sea España"), and `ley-37-1992:art-163-quinvicies` (LIVA régimen especial de la Unión). All three resolve in the legal catalogue; the `test_seed_modelo_applicability_legal_refs_resolve_in_registry` gate confirms it.
