...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-06-30-obligation-coverage-completeness-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Author the Modelo 190 annual deadline window with legal grounding verified against the bundled corpus. and ## Scope

- `src/aeat/_data/registry/aeat/modelos/190` placeholders below are machine-filled
