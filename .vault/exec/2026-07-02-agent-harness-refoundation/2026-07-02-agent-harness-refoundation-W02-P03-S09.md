...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-07-02-agent-harness-refoundation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the harness.load floor tool returning operator rules and the active persona via aeat.agent and ## Scope
