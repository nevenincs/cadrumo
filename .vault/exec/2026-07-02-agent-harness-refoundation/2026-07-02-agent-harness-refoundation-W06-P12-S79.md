...
<!-- FRONTMATTER RULES:
     ...
     The S79 and 2026-07-02-agent-harness-refoundation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Precompute the corpus embeddings at build time with model2vec potion-multilingual-128M and ship the numpy matrix as bundled data and ## Scope

- `src/aeat/application/corpus_search/_embed_build.py` placeholders below are machine-filled
