...
<!-- FRONTMATTER RULES:
     ...
     The S78 and 2026-07-02-agent-harness-refoundation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build the structured citation lookup keyed on citation id over the registry typed legal_refs, corpus_ref, and BOE permalink data and ## Scope

- `src/aeat/application/corpus_search/_citation_lookup.py` placeholders below are machine-filled
