...
<!-- FRONTMATTER RULES:
     ...
     The S42 and 2026-07-15-distribution-installation-readiness-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify cohort hashes evidence completeness and destination versions before any upload and ## Scope

- `dev/release/promote_python_cohort.py` placeholders below are machine-filled
