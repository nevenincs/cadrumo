...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-18-distribution-harness-identity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rename the 34 skill directories and their SKILL.md name frontmatter to the cadrumo- prefix and sweep intra-skill name cross-references, the eval scenario skill_name fields, and the skill-name generation tests in one atomic commit and ## Scope

- `src/cadrumo/_data/agent/skills/` placeholders below are machine-filled
