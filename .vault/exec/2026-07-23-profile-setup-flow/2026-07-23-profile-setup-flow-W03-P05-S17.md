...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-07-23-profile-setup-flow-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-home the verify_setup_answers cross-field checks into flow-scope validators, enrolling section scope where a check's inputs are complete at phase exit and ## Scope

- `src/cadrumo/application/wizard/_verifier.py` placeholders below are machine-filled
