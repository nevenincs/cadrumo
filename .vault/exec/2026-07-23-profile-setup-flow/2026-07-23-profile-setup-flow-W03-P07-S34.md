...
<!-- FRONTMATTER RULES:
     ...
     The S34 and 2026-07-23-profile-setup-flow-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Migrate the non-interactive quiet and accept-defaults walks onto run_scripted_flow with one shared definition builder and one coercer, preserving force-visible law and localized refusal surfaces and ## Scope
