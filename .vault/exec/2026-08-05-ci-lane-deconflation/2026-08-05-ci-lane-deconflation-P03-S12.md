...
modified: '2026-08-05'
body_schema: 'body-v1'
body_hash: 'sha256:bf3a9378634e55fd435a9759b2ba4394508d09a5200902611708e51b872c74b1'
step_id: 'S12'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-08-05-ci-lane-deconflation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Route the declaracion parser administrative-token set through the core authority, it hardcodes four tokens and is missing COMUNICACION and VARIACION from the core set it shadows and ## Scope

- `src/cadrumo/adapters/inbound/declaracion/_parser.py` placeholders below are machine-filled
