...
modified: '2026-08-05'
body_schema: 'body-v1'
body_hash: 'sha256:d932749577064b0ba7f4fece9377e6535c5af1c7826d932e705285acf2d2e4b2'
step_id: 'S04'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-08-05-ci-lane-deconflation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Move the ci-full docs build above the tooling-gates step so the terminology gates that resolve to built HTML get their artefact, blocked until the legal-entry defect stops masking the dependency and ## Scope
