...
modified: '2026-08-18'
body_schema: 'body-v1'
body_hash: 'sha256:c06f6d9f54dcc516b4c4a838c4a9d80ea3b84eca080b5c20d465ae1f105acc8b'
step_id: 'S97'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S97 and 2026-08-13-profile-password-custody-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Have Terra XHigh remove the private duplicate of the canonical bucket-identity primitive that the authority package carries beside the one being relocated into custody, since two implementations of one identity rule can disagree about which strings name the same bucket, and fold its consumers onto the surviving canonical home and ## Scope

- `src/cadrumo/application/auth/_apoderado.py` placeholders below are machine-filled
