...
<!-- FRONTMATTER RULES:
     ...
     The S16 and 2026-06-14-storage-backend-security-review-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a cross-OS transaction provenance roundtrip test proving rehydration does not mutate the persisted shape and ## Scope

- `src/aeat/domain/transactions/tests/` placeholders below are machine-filled
