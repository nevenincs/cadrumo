...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-06-14-storage-backend-security-review-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Set SQLite busy_timeout in the bucket engine connect listener so a concurrent invocation waits rather than failing immediately with database-locked and ## Scope
