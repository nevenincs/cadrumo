...
modified: '2026-08-09'
body_schema: 'body-v1'
body_hash: 'sha256:b4440cbef2498e006797047a1b9495c5ba337b652895d7590e304a9f8d84dfb2'
step_id: 'S05'
related:
  - "[[2026-08-09-cli-verb-profile-diagnostics-plan]]"
---
# Route the overview calendar refusal through the shared enrichment helper and the typed notice channel
...
- Replaced the calendar verb's inline `", ".join(warning.code ...)` summary and its Click parameter error with a single call to the shared refusal builder added in this Phase.
...
The calendar refusal now names each blocking profile fact by its operator label with the legal grounding the registry carries, and reads as a workflow-state refusal rather than as invalid operator input.
