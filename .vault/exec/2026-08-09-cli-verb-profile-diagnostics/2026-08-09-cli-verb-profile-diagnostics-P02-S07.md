...
modified: '2026-08-09'
body_schema: 'body-v1'
body_hash: 'sha256:2c5381d8f2414239fef563100913dd47cb9184a3acdcfe6d870594618de8668b'
step_id: 'S07'
related:
  - "[[2026-08-09-cli-verb-profile-diagnostics-plan]]"
---
# Route the overview backlog refusal through the shared enrichment helper and the typed notice channel
...
- Replaced the backlog verb's inline `", ".join(warning.code ...)` summary and its Click parameter error with a single call to the shared refusal builder added in this Phase.
...
The backlog refusal now names each blocking profile fact by its operator label with the legal grounding the registry carries, and reads as a workflow-state refusal rather than as invalid operator input.
