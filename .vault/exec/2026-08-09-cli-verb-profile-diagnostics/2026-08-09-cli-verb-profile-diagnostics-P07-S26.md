...
modified: '2026-08-09'
body_schema: 'body-v1'
body_hash: 'sha256:3761f07c00f04c81aae145f9943df5923412c3225f20152a005f42aa170a8b4c'
step_id: 'S26'
related:
  - "[[2026-08-09-cli-verb-profile-diagnostics-plan]]"
---
# End-to-end refusal coverage for the overview calendar verb
...
- Added the calendar invocation to the parametrised end-to-end set driven over a profile that leaves a real gating fact unanswered.
...
The calendar refusal is now covered end to end by an unanswered PROFILE FIELD, rather than by construction.
