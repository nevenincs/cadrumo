...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-06-30-ledger-add-idempotency-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a test proving a deliberate duplicate stays possible via the keyless path and via a distinct idempotency key, both yielding two distinct rows and ## Scope
