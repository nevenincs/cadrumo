...
- Modified: `src/aeat/logging.py`, `src/aeat/config.py`, `env/.env.example`,
  `src/aeat/cli/__init__.py`, `docs/coverage/kent-capabilities.md`,
  `src/aeat/cli/workflow/_test_doubles.py`
- Created: `src/aeat/cli/_schemas.py`, `src/aeat/cli/_exit_codes.py`,
  `src/aeat/cli/_tty.py`, `src/aeat/cli/_log_levels.py`,
  `src/aeat/cli/test_schemas_registry.py`, `src/aeat/cli/test_exit_codes.py`,
  `src/aeat/cli/test_tty.py`, `src/aeat/cli/test_log_levels.py`,
...
The repo-wide marker integrity failure from `src/aeat/cli/workflow/_test_doubles.py`
...
- `uv run pytest src/aeat/cli/test_schemas_registry.py src/aeat/cli/test_exit_codes.py src/aeat/cli/test_tty.py src/aeat/cli/test_log_levels.py src/aeat/test_logging_scrubbing.py tests/test_config.py`
...
`src/aeat/auth/test_clave_movil.py` timeout cases remain red. The final
