...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-05-20-calculation-source-connectivity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Derive Renta source region from TaxResidenceProfile CCAA and ## Scope

- `src/aeat/application/aggregation/_renta_ledger.py` placeholders below are machine-filled
