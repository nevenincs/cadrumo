...
<!-- FRONTMATTER RULES:
     ...
     The S62 and 2026-05-20-calculation-source-connectivity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Follow-up: extend the approval-basis source fingerprint beyond the invoice catalogue to the remaining self-loadable mesh sources (profile, previous_filing, relations) without coupling the review layer to the full source mesh and ## Scope
