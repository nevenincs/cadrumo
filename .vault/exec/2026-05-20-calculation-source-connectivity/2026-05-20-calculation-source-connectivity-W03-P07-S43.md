...
<!-- FRONTMATTER RULES:
     ...
     The S43 and 2026-05-20-calculation-source-connectivity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Test fincas and inventory resolvers emit blocked readiness diagnostics and ## Scope

- `src/aeat/application/aggregation/test_source_mesh_readiness.py` placeholders below are machine-filled
