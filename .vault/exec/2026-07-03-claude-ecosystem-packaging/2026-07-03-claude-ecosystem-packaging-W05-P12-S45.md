...
<!-- FRONTMATTER RULES:
     ...
     The S45 and 2026-07-03-claude-ecosystem-packaging-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Operator-gated: install the plugin into Cowork and resolve whether the local stdio server runs on-host or connectors execute in Anthropic's cloud (needs a real Cowork install) and ## Scope

- `docs/verification/cowork-install-proof.md` placeholders below are machine-filled
