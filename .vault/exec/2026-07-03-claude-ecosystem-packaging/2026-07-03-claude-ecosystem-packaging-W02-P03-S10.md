...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-03-claude-ecosystem-packaging-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a wheel-content test asserting the aeat wheel ships zero corpus pdf/xls/xlsx members while keeping the extracted-text, normative-html, registry and agent payload and ## Scope

- `src/aeat/tests/test_wheel_content_boundary.py` placeholders below are machine-filled
