...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-07-03-claude-ecosystem-packaging-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add an anti-tautology test that an absent companion binary surfaces a loud advisory and is never silently accepted and ## Scope
