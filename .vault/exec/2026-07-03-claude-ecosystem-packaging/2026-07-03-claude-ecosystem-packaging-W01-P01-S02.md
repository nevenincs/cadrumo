...
<!-- FRONTMATTER RULES:
     ...
     The S02 and 2026-07-03-claude-ecosystem-packaging-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Root aeat_local_storage_root at the platform user-data directory for installed runs while preserving the PROJECT_ROOT var/storage default for a source checkout and ## Scope

- `src/aeat/core/config.py` placeholders below are machine-filled
