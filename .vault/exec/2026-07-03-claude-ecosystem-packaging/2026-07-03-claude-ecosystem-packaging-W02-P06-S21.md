...
<!-- FRONTMATTER RULES:
     ...
     The S21 and 2026-07-03-claude-ecosystem-packaging-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a split-install packaging-smoke lane proving the advisory path with the core wheel alone and the byte-identical path with the companion installed and ## Scope
