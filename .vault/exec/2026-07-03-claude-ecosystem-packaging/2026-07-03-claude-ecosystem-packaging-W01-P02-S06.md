...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-07-03-claude-ecosystem-packaging-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Confirm deptry and the packaging-smoke dependency-surface gate stay clean after the demotion and ## Scope

- `dev/packaging/dependency_surface.py` placeholders below are machine-filled
