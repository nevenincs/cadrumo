...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-08-07-justificante-identity-matching-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a mutation-proof test confirming the reason-distinguishing branch fires per swallowed case and confirm the CLI report surfaces the Notice and ## Scope

- `src/cadrumo/application/live/tests and src/cadrumo/entrypoints/cli/tests` placeholders below are machine-filled
