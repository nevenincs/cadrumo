...
<!-- FRONTMATTER RULES:
     ...
     Replace emit-envelope-schema-burndown with a kebab-case feature tag, e.g. #foo-bar.
...
# migrate census_compare bare emit site to _emit_envelope using typed CensusCompareResult
