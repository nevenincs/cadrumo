...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-07-iva-prorrata-complexity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Make the shared ledger IVA apportionment regime-aware so especial routes each deducible cuota via _deductible_percentage_for (100/0/general), the general path stays byte-identical, and provenance carries the applied classification and percentage and ## Scope
