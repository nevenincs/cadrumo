...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-07-07-iva-prorrata-complexity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Orchestrate per-(ejercicio,sector) register entries and per-sector routing in the regime-aware aggregation and ## Scope
