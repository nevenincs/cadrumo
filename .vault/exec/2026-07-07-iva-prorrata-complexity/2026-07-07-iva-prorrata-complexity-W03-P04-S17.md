...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-07-07-iva-prorrata-complexity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add operator-declared sector identification (CNAE/IAE) on the contribuyente profile and the sector reference on the ledger transaction and ## Scope

- `src/aeat/domain/contribuyente/`
- `src/aeat/domain/transactions/_models.py` placeholders below are machine-filled
