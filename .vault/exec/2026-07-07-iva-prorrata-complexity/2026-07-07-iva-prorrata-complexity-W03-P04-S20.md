...
<!-- FRONTMATTER RULES:
     ...
     The S20 and 2026-07-07-iva-prorrata-complexity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify per-sector prorrata against a worked example with a greater-than-50-percentage-point sector spread and ## Scope

- `src/aeat/domain/prorrata_register/tests/` placeholders below are machine-filled
