...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-05-27-m210-irnr-phase-2-engine-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The author the complete M210 casilla set on the 2025 revision with completeness manifest, extraction-profile targets, and export parity, with casilla count and numbering taken from the fetched layout authority and ## Scope

- `src/aeat/_data/registry/aeat/modelos/210/revisions/2025/casillas` placeholders below are machine-filled
