...
Implemented the casilla catalogue feature on a new `aeat.casillas` package,
...
`src/aeat/schema/` and instead establishing a dedicated `src/aeat/casillas/`
