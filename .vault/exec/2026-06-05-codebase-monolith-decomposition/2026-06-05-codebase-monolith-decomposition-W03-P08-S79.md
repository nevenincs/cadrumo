...
SQL secure-object row models and revision crypto helpers are separated from repository orchestration without changing repository behavior or consumer-facing storage imports.

## Notes

No application, entrypoint, or domain consumer imports the new private records or crypto modules directly.
