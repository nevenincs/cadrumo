...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-06-24-m303-refund-fichero-block-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add an end-to-end refusal case asserting a refund disposition with an empty refund-account is refused, not emitted as an empty DID page and ## Scope
