...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-06-24-m303-refund-fichero-block-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the golden-SHA fichero roundtrip with a REDEME-1 plus IBAN-populated case, per-offset assertions grounded against the DR303 offsets (110, DID 12, 23, 194) and ## Scope

- `src/aeat/adapters/outbound/aeat/export/_formats/tests/test_fichero_boe_roundtrip.py` placeholders below are machine-filled
