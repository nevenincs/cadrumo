...
<!-- FRONTMATTER RULES:
     ...
     The S42 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The capture persona commands, redacted outputs, friction points, and safety observations in audit notes and ## Scope

- `.vault/audit` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# capture persona commands, redacted outputs, friction points, and safety observations in audit notes
