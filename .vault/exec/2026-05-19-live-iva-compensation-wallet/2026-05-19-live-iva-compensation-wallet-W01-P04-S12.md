...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The implement local recurrence extraction for comparison without selecting the effective value and ## Scope

- `src/aeat/application/calculations/_binding_prefill.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# implement local recurrence extraction for comparison without selecting the effective value
