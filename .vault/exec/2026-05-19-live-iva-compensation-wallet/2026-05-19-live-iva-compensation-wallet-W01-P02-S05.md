...
<!-- FRONTMATTER RULES:
     ...
     The S05 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The implement `fetch_iva_compensation_wallet` as a read-only Sede adapter and ## Scope
