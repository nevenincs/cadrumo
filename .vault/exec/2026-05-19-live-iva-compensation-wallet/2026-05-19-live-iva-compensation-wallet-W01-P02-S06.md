...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add parser coverage from captured wallet HTML fixtures and ## Scope

- `src/aeat/adapters/outbound/aeat/sede/test_iva_compensation_wallet.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# add parser coverage from captured wallet HTML fixtures
