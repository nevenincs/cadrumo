...
<!-- FRONTMATTER RULES:
     ...
     The S21 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The fail closed on AEAT representation-gate submission in wallet capture and Cl@ve verification and ## Scope

- `src/aeat/adapters/outbound/aeat/sede/_iva_compensation_wallet.py`
- `src/aeat/adapters/outbound/aeat/auth/_clave_movil.py` placeholders below are machine-filled
