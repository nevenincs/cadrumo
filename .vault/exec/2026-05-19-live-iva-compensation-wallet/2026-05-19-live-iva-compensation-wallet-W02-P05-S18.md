...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The block the wallet execute gate by static HTML inspection without running page JavaScript and ## Scope

- `src/aeat/adapters/outbound/aeat/sede/_iva_compensation_wallet.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# block the wallet execute gate by static HTML inspection without running page JavaScript
