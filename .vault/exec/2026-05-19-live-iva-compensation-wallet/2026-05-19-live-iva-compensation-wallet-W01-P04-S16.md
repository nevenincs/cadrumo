...
<!-- FRONTMATTER RULES:
     ...
     The S16 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add divergence scenario tests for match, AEAT-higher, AEAT-lower, stale wallet, missing wallet, and explicit taxpayer override and ## Scope

- `src/aeat/application/calculations/test_iva_wallet_reconciliation.py` placeholders below are machine-filled
