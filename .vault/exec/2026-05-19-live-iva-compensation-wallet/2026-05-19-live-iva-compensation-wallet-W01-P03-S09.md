...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add repository roundtrip tests for wallet observations and ## Scope

- `src/aeat/adapters/outbound/aeat/sede/test_observation_store_roundtrip.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# add repository roundtrip tests for wallet observations
