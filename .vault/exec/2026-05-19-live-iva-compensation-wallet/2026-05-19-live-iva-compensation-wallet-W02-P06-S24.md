...
<!-- FRONTMATTER RULES:
     ...
     The S24 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The move accepted action markers into external constants and guard policies and ## Scope

- `src/aeat/core/external_constants.toml`
- `src/aeat/domain/calculations/registry/_remote_state_guard.py` placeholders below are machine-filled
