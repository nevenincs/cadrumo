...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The prevent automatic output when the wallet reconciliation decision is blocked and ## Scope

- `src/aeat/application/modelo/_actions.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# prevent automatic output when the wallet reconciliation decision is blocked
