...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add backend workflow entry point for operator-approved wallet pull and ## Scope

- `src/aeat/application/live/__init__.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# add backend workflow entry point for operator-approved wallet pull
