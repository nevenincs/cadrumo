...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The run wallet, Modelo 303, Modelo 390, and relation-regression focused suites together and ## Scope

- `tests` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# run wallet, Modelo 303, Modelo 390, and relation-regression focused suites together
