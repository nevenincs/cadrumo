...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add opt-in live smoke coverage gated by `AEAT_LIVE_TESTS_ENABLED` and ## Scope

- `src/aeat/adapters/outbound/aeat/sede/test_iva_compensation_wallet_live.py` placeholders below are machine-filled
