...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The keep AEAT wallet evidence, local recurrence, filed-history observations, and explicit taxpayer overrides as separate authority sources and ## Scope

- `src/aeat/application/calculations` placeholders below are machine-filled
