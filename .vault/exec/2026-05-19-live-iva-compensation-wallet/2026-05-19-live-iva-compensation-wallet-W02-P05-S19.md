...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The remove any wallet POST allowance from the read guard and prove wallet POST is rejected and ## Scope
