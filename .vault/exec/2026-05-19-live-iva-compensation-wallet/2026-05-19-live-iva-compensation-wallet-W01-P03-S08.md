...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-05-19-live-iva-compensation-wallet-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add encrypted persistence support for wallet observations and ## Scope

- `src/aeat/adapters/outbound/aeat/sede/_observation_store.py` placeholders below are machine-filled
