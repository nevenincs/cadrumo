...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-07-17-mcp-call-latency-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Load the compiled cache when the tree fingerprint matches so warm processes skip the TOML parse, and write the cache after a fresh compile, wired through the loader and ## Scope
