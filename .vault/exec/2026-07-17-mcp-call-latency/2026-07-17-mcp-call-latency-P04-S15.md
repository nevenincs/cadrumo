...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-07-17-mcp-call-latency-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Pre-provision the MCPB environment once and launch the interpreter directly thereafter, removing the per-session uv run resolution from the manifest launch and ## Scope
