...
<!-- FRONTMATTER RULES:
     ...
     The S05 and 2026-06-19-silent-zero-base-aggregation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The fix the prorrata-porcentaje no-volume-data default from 0 to 100 (full right to deduct, LIVA art-94) so a fully-taxable trader's export unblocks, with a regression test - the correct peer-clean fix for defect C2 and ## Scope
