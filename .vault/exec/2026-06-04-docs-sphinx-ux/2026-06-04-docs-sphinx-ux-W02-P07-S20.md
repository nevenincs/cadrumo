...
<!-- FRONTMATTER RULES:
     ...
     The S20 and 2026-06-04-docs-sphinx-ux-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The prepare the route and reference review packet from a fresh local site build (docs/_build/html is a gitignored, re-derivable artifact, not a persisted deliverable) and ## Scope
