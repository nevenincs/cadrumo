...
<!-- FRONTMATTER RULES:
     ...
     The S23 and 2026-06-04-docs-sphinx-ux-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The incorporate approved reference feedback and ## Scope

- `dev/docs/cli_reference.py` placeholders below are machine-filled
