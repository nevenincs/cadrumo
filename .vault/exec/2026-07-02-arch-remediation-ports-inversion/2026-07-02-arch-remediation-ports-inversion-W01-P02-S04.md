...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-07-02-arch-remediation-ports-inversion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Move the submission verifier concrete class to adapters behind the existing protocol in one atomic commit and delete the deferral comment, discharging register item D3 and ## Scope

- `src/aeat/domain/submission/_protocols.py` placeholders below are machine-filled
