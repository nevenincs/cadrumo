...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-02-arch-remediation-ports-inversion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Relocate the submission engine persistence behind a port in one atomic commit, deleting its pinned domain-to-adapters errors entry and ## Scope

- `src/aeat/domain/submission/_engine.py` placeholders below are machine-filled
