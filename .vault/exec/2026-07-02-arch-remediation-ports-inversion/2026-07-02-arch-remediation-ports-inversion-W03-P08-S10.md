...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-02-arch-remediation-ports-inversion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Relocate the filing repository behind its domain port in one atomic commit, deleting its pinned domain-to-adapters entries and ## Scope

- `src/aeat/domain/filing/_repository.py` placeholders below are machine-filled
