...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-02-arch-remediation-ports-inversion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Relocate the filing runtime repository behind its domain port in one atomic commit, deleting its pinned domain-to-adapters runtime_repository entry and ## Scope
