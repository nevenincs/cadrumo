...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-07-02-arch-remediation-ports-inversion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Relocate the filing complementaria repository behind its domain port in one atomic commit, deleting its pinned domain-to-adapters entries and ## Scope

- `src/aeat/domain/filing/_complementaria_repository.py` placeholders below are machine-filled
