...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-07-02-arch-remediation-ports-inversion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Relocate the modelos participation index behind a port in one atomic commit after verifying its pinned edge inventory at execution time, preserving the derived-and-rebuildable invariant and ## Scope

- `src/aeat/domain/modelos/_participation_index.py` placeholders below are machine-filled
