...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-07-02-arch-remediation-modelo-surface-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Declare the calculate-path precedence ladder as ordered tier data carrying tier name, owned sources, and override disposition in the aggregation package and ## Scope
