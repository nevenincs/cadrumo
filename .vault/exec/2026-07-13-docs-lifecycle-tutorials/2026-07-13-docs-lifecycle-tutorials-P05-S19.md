...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-07-13-docs-lifecycle-tutorials-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Replay both lifecycle tutorials end-to-end against a sandbox profile and reconcile the narrated figures with real command output and ## Scope

- `docs/tutorials/irpf-lifecycle.md docs/tutorials/iva-lifecycle.md` placeholders below are machine-filled
