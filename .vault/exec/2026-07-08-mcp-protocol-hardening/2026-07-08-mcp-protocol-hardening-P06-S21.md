...
<!-- FRONTMATTER RULES:
     ...
     The S21 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add telemetry retention pruning (age and count based, newest-N protected) at server start with a documented read path and ## Scope

- `src/aeat/entrypoints/mcp/_telemetry.py` placeholders below are machine-filled
