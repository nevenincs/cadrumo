...
<!-- FRONTMATTER RULES:
     ...
     The S23 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the capability-set conformance test pinning the exact negotiated server capabilities and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_client_handshake.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Add the capability-set conformance test pinning the exact negotiated server capabilities
