...
<!-- FRONTMATTER RULES:
     ...
     The S22 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add telemetry retention tests proving pruning bounds growth and never touches the newest sessions and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_serving_gates.py` placeholders below are machine-filled
