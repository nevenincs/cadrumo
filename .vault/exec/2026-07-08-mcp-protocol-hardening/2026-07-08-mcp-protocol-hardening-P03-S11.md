...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-home the HITL confirmation-tier derivation onto the same classification table so client hints and server gates read one authority and ## Scope

- `src/aeat/entrypoints/mcp/_hitl.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Re-home the HITL confirmation-tier derivation onto the same classification table so client hints and server gates read one authority
