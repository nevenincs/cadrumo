...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Author the localized timeout and cancellation refusal strings through the locales CLI across all four catalogues and ## Scope
