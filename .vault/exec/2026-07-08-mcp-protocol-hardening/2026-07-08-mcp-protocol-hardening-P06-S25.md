...
<!-- FRONTMATTER RULES:
     ...
     The S25 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Regenerate the API reference stubs for the new modules via the apidocs CLI and ## Scope
