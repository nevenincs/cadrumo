...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Convert the silent lazy-subcommand resolution fallback into a build-time schema-coverage gate failure naming the broken verb and ## Scope

- `src/aeat/entrypoints/mcp/_input_schema.py` placeholders below are machine-filled
