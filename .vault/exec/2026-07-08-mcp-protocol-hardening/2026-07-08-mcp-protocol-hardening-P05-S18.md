...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the localization-boundary gate asserting the model-facing surface is English and the operator-facing strings ride the locale catalogues and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_localization_boundary.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Add the localization-boundary gate asserting the model-facing surface is English and the operator-facing strings ride the locale catalogues

## Scope

- `src/aeat/entrypoints/mcp/tests/test_localization_boundary.py`
