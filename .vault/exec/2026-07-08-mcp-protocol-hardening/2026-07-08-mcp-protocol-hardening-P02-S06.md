...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Support boolean off-tokens: the schema accepts explicit false and the argv renderer emits the secondary no-flag token for default-on pairs and ## Scope
