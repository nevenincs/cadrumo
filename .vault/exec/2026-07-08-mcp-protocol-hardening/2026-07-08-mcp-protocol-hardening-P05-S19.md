...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the untrusted-content gate over the live family result schemas: no raw portal markup reaches a tool result and portal-sourced free text carries its source kind and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_untrusted_content_boundary.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Add the untrusted-content gate over the live family result schemas: no raw portal markup reaches a tool result and portal-sourced free text carries its source kind

## Scope

- `src/aeat/entrypoints/mcp/tests/test_untrusted_content_boundary.py`
