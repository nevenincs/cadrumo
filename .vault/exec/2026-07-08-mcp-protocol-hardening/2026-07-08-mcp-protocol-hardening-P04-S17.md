...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the structured-summary size-budget conformance check flagging verbs over budget and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_result_size_budget.py` placeholders below are machine-filled
