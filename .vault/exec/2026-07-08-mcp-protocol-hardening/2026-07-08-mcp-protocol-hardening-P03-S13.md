...
<!-- FRONTMATTER RULES:
     ...
     The S13 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the annotation tests for openWorldHint coverage and classification-table consumption and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_annotations.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Extend the annotation tests for openWorldHint coverage and classification-table consumption
