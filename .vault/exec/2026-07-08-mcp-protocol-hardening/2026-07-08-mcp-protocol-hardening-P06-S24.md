...
<!-- FRONTMATTER RULES:
     ...
     The S24 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Pin the potion model revision to a commit hash and route the model download through the app-controlled cache directory and ## Scope
