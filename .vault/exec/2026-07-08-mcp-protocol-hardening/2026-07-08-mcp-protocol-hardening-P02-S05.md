...
<!-- FRONTMATTER RULES:
     ...
     The S05 and 2026-07-08-mcp-protocol-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Render JSON-safe real defaults (paths as strings, tuples as arrays) instead of dropping non-scalar defaults to null and ## Scope

- `src/aeat/entrypoints/mcp/_input_schema.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Render JSON-safe real defaults (paths as strings, tuples as arrays) instead of dropping non-scalar defaults to null
