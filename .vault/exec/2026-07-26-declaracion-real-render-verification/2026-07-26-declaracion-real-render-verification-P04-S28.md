...
<!-- FRONTMATTER RULES:
     ...
     The S28 and 2026-07-26-declaracion-real-render-verification-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rule whether enum is a claim about the value space or merely a hint, since the schema enforces no enum-versus-text distinction and the answer decides whether the four flagged targets are defects or documentation and ## Scope
