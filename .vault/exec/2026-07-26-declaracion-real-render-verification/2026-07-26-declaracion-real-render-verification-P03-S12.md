...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-26-declaracion-real-render-verification-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Register the fully-exposed profiles as D3 evidence gaps naming the English-render specimen class that would unblock each and ## Scope
