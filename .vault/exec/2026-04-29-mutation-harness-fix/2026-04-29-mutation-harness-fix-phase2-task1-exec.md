...
- `src/aeat/formulas/_rulesets/test_scalar_mutation.py` — added
...
`uv run pytest src/aeat/formulas/_rulesets/test_operand_swap_mutation.py
src/aeat/formulas/_rulesets/test_scalar_mutation.py
src/aeat/formulas/_rulesets/test_percent_rate_mutation.py -q` → all
green.
