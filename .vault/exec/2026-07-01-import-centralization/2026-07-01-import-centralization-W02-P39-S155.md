...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:270b80318abf6bd631c23d5281384f21c4b9de8f1328e4d64deaf14ab706e751'
step_id: 'S155'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 3 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.outbound.storage`

## Scope

- `src/aeat/adapters/outbound/google/_calc_sheets_apply.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 3 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.outbound.storage`.
