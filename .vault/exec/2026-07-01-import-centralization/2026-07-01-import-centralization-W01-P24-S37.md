...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:ddbc6be05580f4714a3baeaafd321ff5f2cbaaf88293c6bb8adcfbf5b8687aaa'
step_id: 'S37'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `canonical_decimal_string` to `aeat.domain.__all__` with eager re-exports so the 6 existing cross-package consumer site(s) can import from the facade
...
- Preserve the row intent: Promote `canonical_decimal_string` to `aeat.domain.__all__` with eager re-exports so the 6 existing cross-package consumer site(s) can import from the facade.
