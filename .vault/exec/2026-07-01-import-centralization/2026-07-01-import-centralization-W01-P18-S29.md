...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:ed1c375325b533cba7c525a77c255ca2bc76f462614f942983ab666271adb066'
step_id: 'S29'
related:
...
- Preserve the row intent: Promote `MISSING_DEDUCTIBLE_VAT_EVIDENCE_SOURCE_KIND`, `compute_ledger_filing_evidence`, `compute_ledger_filing_snapshot` to `aeat.application.aggregation.__all__` with eager re-exports so the 3 existing cross-package consumer site(s) can import from the facade.
