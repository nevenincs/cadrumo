...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:3cb7d6d65030a71f50f119eb64e553a83b3699f894a4ed46f8dcb364bd9ff5fe'
step_id: 'S285'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 9 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`, `aeat.application.workflow`, `aeat.domain.modelos`
...
- Preserve the row intent: Rewire 9 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`, `aeat.application.workflow`, `aeat.domain.modelos`.
