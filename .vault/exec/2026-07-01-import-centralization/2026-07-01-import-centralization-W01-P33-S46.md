...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:43d95b4da2f3e1dbb90f6b1aaf638f8d222b600f0ae59a876861a61f0ddd140e'
step_id: 'S46'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `clear_output_language_cache` to `aeat.core.i18n.__all__` with eager re-exports so the 5 existing cross-package consumer site(s) can import from the facade
...
- Preserve the row intent: Promote `clear_output_language_cache` to `aeat.core.i18n.__all__` with eager re-exports so the 5 existing cross-package consumer site(s) can import from the facade.
