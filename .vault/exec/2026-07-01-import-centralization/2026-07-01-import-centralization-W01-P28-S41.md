...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:b58289490dbffbdb302fa79e965d176aae610e8f1eeb2973ecf72c87336db3c3'
step_id: 'S41'
related:
...
- Preserve the row intent: Promote `RentaValidationError` to `aeat.domain.renta.__all__` with eager re-exports so the 2 existing cross-package consumer site(s) can import from the facade.
