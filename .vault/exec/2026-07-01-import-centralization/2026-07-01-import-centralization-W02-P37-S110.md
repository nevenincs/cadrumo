...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:f359a62111f70148b3f8d71b449acfe493ba55b6958ab26e8ce41f374a1a5179'
step_id: 'S110'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.crypto`

## Scope

- `src/aeat/adapters/persistence/storage/master_key/_master_key_derivation.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.crypto`.
