...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:073990519ff633ec4a68a38020e052d8a5806269de2a253e9e2ba9ea772ea65d'
step_id: 'S47'
related:
...
- Preserve the row intent: Promote `portal_host_name` to `aeat.domain.portals.__all__` with eager re-exports so the 1 existing cross-package consumer site(s) can import from the facade.
