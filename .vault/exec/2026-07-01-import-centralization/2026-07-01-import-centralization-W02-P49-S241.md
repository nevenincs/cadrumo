...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:4c8cc06e5b40dc13833f637a6206b5d0c0ad1c8a8cd8cebce85ac45fafada4a3'
step_id: 'S241'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 11 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.modelos`

## Scope

- `src/aeat/application/aggregation/_ledger_filing_snapshot.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 11 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.modelos`.
