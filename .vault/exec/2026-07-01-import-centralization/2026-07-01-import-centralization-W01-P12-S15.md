...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Promote `KNOWN_PROFILE_FLAG_ADVISORY_FIELDS`, `select_revision` to `aeat.domain.calculations.registry.__all__` with eager re-exports so the 2 existing cross-package consumer site(s) can import from the facade and ## Scope
