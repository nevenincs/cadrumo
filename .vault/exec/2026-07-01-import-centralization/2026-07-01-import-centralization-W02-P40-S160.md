...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:a39af5c08ddbde80e4701afef58433fd59b0d83d6ea58c69b86836bf41bf59fd'
step_id: 'S160'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 10 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core.time`, `aeat.domain.attachments`, `aeat.domain.buckets`, `aeat.domain.invoices`, `aeat.domain.modelos`, `aeat.domain.transactions`
...
- Preserve the row intent: Rewire 10 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core.time`, `aeat.domain.attachments`, `aeat.domain.buckets`, `aeat.domain.invoices`, `aeat.domain.modelos`, `aeat.domain.transactions`.
