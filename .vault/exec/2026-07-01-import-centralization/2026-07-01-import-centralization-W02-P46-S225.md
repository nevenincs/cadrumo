...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:e5a15d4ea57d5392bcb07c5d6564d701aa5cc780743a78c536fb579c5666ae87'
step_id: 'S225'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain`

## Scope

- `src/aeat/application/filing/_history_models.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain`.
