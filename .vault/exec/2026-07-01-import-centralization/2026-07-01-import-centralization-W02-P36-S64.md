...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:b6ecf8a49088a7f6effc356af25e007eb13165959064c1b51b2a314196a93ec0'
step_id: 'S64'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 14 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`, `aeat.domain.buckets`, `aeat.domain.iva_compensation`, `aeat.domain.modelos`
...
- Preserve the row intent: Rewire 14 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`, `aeat.domain.buckets`, `aeat.domain.iva_compensation`, `aeat.domain.modelos`.
