...
<!-- FRONTMATTER RULES:
     ...
     The S352 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 2 test-only cross-package private import site(s) across 2 test file(s) reaching into `aeat.adapters.inbound.declaracion` onto its promoted top-level facade and ## Scope

- `src/aeat/adapters/inbound/declaracion (test consumers)` placeholders below are machine-filled
