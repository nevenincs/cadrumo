...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:547913987a6d7228bbcd52b011bfa07a65f5751cef762aea35d6a5b17b46fecf'
step_id: 'S43'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `CasillaFieldKind` to `aeat.domain.calculations.__all__` with eager re-exports so the 2 existing cross-package consumer site(s) can import from the facade

## Scope

- `src/aeat/domain/calculations/__init__.py`
## Description

- Reconcile $display as an individual exec record for a W01 facade-promotion row already checked in the plan.
- Preserve the row intent: Promote `CasillaFieldKind` to `aeat.domain.calculations.__all__` with eager re-exports so the 2 existing cross-package consumer site(s) can import from the facade.
