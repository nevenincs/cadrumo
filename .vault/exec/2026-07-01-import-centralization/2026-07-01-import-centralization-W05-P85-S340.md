...
<!-- FRONTMATTER RULES:
     ...
     The S340 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 24 test-only cross-package private import site(s) across 21 test file(s) reaching into `aeat.adapters.persistence.storage.crypto` onto its promoted top-level facade and ## Scope

- `src/aeat/adapters/persistence/storage/crypto (test consumers)` placeholders below are machine-filled
