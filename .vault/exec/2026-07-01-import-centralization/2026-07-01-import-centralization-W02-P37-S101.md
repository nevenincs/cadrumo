...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:5de28803ef3990ca5080a352fbeac45effe630443e9fc64b6d93e1331b929809'
step_id: 'S101'
related:
...
- Preserve the row intent: Rewire 10 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.crypto`, `aeat.adapters.persistence.storage.envelope`, `aeat.adapters.persistence.storage.master_key`.
