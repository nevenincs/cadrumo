...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:735cb221fdbb027426de0d8257ef26712724f642178721833feef10ddf6128b3'
step_id: 'S33'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `find_invoice`, `find_unmatched` to `aeat.domain.invoices.__all__` with eager re-exports so the 4 existing cross-package consumer site(s) can import from the facade
...
- Preserve the row intent: Promote `find_invoice`, `find_unmatched` to `aeat.domain.invoices.__all__` with eager re-exports so the 4 existing cross-package consumer site(s) can import from the facade.
