...
<!-- FRONTMATTER RULES:
     ...
     The S330 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 5 test-only cross-package private import site(s) across 5 test file(s) reaching into `aeat.application.storage.calc_sheets` onto its promoted top-level facade and ## Scope

- `src/aeat/application/storage/calc_sheets (test consumers)` placeholders below are machine-filled
