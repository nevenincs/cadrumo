...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:5accd950d09d3187eaff16b2b4e2b966eafa4298d1bc290ffb1f9590b7ff0d2b'
step_id: 'S124'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.workflow`

## Scope

- `src/aeat/entrypoints/cli/_config/_capabilities_cli.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.workflow`.
