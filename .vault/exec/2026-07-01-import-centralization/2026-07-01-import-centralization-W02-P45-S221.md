...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:977d1f348b741ce555228b564c4c5102f0719031b416e670ceb6848b4020431a'
step_id: 'S221'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`

## Scope

- `src/aeat/application/auth/_operator_scope.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`.
