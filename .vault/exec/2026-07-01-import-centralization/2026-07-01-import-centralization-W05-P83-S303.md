...
<!-- FRONTMATTER RULES:
     ...
     The S303 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 26 test-only cross-package private import site(s) across 20 test file(s) reaching into `aeat.domain.transactions` onto its promoted top-level facade and ## Scope

- `src/aeat/domain/transactions (test consumers)` placeholders below are machine-filled
