...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:686c6c72bf9d7b51305e499d87a3051efa2126c46f4c0e23f7e3f3cb3fdb9116'
step_id: 'S52'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 12 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core`, `aeat.domain.modelos`, `aeat.domain.transactions`

## Scope

- `src/aeat/application/modelo/_art109_activity_income.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 12 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core`, `aeat.domain.modelos`, `aeat.domain.transactions`.
