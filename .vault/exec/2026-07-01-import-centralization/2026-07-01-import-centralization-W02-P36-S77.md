...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:6356cbdcc7c7b25635183bea2651918cbcefdd0803f2219a5d2d35ed42d55601'
step_id: 'S77'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 2 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`, `aeat.domain.modelos`

## Scope

- `src/aeat/application/modelo/_profile_readiness_gate.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 2 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.user_profile`, `aeat.domain.modelos`.
