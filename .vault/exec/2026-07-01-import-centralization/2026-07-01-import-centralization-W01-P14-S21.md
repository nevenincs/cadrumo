...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:cfd02aa712336e7e93de9ba4e0214527501437db8a8367527b564b20862e0daf'
step_id: 'S21'
related:
...
- Preserve the row intent: Promote `decrypt_encrypted_bytes_column`, `decrypt_secure_object_payload`, `encrypt_secure_object_payload`, `secure_object_payload_aad` to `aeat.adapters.persistence.storage.crypto.__all__` with eager re-exports so the 9 existing cross-package consumer site(s) can import from the facade.
