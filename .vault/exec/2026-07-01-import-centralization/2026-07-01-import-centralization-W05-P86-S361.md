...
<!-- FRONTMATTER RULES:
     ...
     The S361 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 8 test-only cross-package private import site(s) across 2 test file(s) reaching into `aeat.locales` onto its promoted top-level facade and ## Scope

- `src/aeat/locales (test consumers)` placeholders below are machine-filled
