...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:a39add57f0500c3181271c1411b7d17f596ce87ad5d4943981f83772bfae6683'
step_id: 'S121'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.portals`

## Scope

- `src/aeat/entrypoints/cli/_app_live_portals_cli.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.portals`.
