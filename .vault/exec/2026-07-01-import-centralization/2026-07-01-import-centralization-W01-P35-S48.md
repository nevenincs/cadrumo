...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:fe5459e899c34079a7eb23b1fc3f6c9d4690d7210d748d01ee8a2962a8e2ff41'
step_id: 'S48'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Decide and apply the public-surface disposition for `_command_schema_refs` (rename-to-public and promote, expose a narrower public API, or remove the reach) currently defined in `aeat.entrypoints.cli._app_contract` and consumed cross-package from `src/aeat/entrypoints/mcp/_tools.py`
...
- Preserve the row intent: Decide and apply the public-surface disposition for `_command_schema_refs` (rename-to-public and promote, expose a narrower public API, or remove the reach) currently defined in `aeat.entrypoints.cli._app_contract` and consumed cross-package from `src/aeat/entrypoints/mcp/_tools.py`.
