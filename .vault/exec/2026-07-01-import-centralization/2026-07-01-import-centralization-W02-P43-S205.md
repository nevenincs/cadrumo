...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:8e68faff87296be7817c1465479354ad77a068ee4c83b2cdeae3e04fda278f91'
step_id: 'S205'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 8 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.renta`

## Scope

- `src/aeat/application/calculations/_maritime_exemption_service.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 8 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.renta`.
