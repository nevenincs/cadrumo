...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:e3a2be3fe664088612a357c0c6f36d849bd9a7d9714f064fec207c7006e9fa30'
step_id: 'S36'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `OperatorInputScenario`, `verify_modelo_parity` to `aeat.application.storage.calc_sheets.__all__` with eager re-exports so the 2 existing cross-package consumer site(s) can import from the facade
...
- Preserve the row intent: Promote `OperatorInputScenario`, `verify_modelo_parity` to `aeat.application.storage.calc_sheets.__all__` with eager re-exports so the 2 existing cross-package consumer site(s) can import from the facade.
