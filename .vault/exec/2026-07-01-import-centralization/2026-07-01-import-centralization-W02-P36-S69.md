...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:edd7ac972fd5c17fc9653ce120e913095554bef1727abdba2153849a04d2e74d'
step_id: 'S69'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 13 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.calculations`, `aeat.application.user_profile`, `aeat.domain.iva_compensation`, `aeat.domain.modelos`
...
- Preserve the row intent: Rewire 13 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.calculations`, `aeat.application.user_profile`, `aeat.domain.iva_compensation`, `aeat.domain.modelos`.
