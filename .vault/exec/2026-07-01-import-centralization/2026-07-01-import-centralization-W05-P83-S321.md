...
<!-- FRONTMATTER RULES:
     ...
     The S321 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 1 test-only cross-package private import site(s) across 1 test file(s) reaching into `aeat.domain.auth.apoderamientos` onto its promoted top-level facade and ## Scope

- `src/aeat/domain/auth/apoderamientos (test consumers)` placeholders below are machine-filled
