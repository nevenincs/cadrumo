...
<!-- FRONTMATTER RULES:
     ...
     The S359 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 9 test-only cross-package private import site(s) across 5 test file(s) reaching into `aeat.entrypoints.cli` onto its promoted top-level facade and ## Scope

- `src/aeat/entrypoints/cli (test consumers)` placeholders below are machine-filled
