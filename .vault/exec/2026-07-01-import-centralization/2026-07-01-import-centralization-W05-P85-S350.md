...
<!-- FRONTMATTER RULES:
     ...
     The S350 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 12 test-only cross-package private import site(s) across 3 test file(s) reaching into `aeat.adapters.outbound.aeat.auth` onto its promoted top-level facade and ## Scope

- `src/aeat/adapters/outbound/aeat/auth (test consumers)` placeholders below are machine-filled
