...
<!-- FRONTMATTER RULES:
     ...
     The S329 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 18 test-only cross-package private import site(s) across 7 test file(s) reaching into `aeat.application.auth` onto its promoted top-level facade and ## Scope

- `src/aeat/application/auth (test consumers)` placeholders below are machine-filled
