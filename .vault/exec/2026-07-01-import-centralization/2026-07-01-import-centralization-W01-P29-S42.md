...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:de61b0c35f82837b3b9286b88b74c2da46ce62b0382cc2bff466c04da4ed8939'
step_id: 'S42'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `AuthState` to `aeat.application.workflow.__all__` with eager re-exports so the 1 existing cross-package consumer site(s) can import from the facade
...
- Preserve the row intent: Promote `AuthState` to `aeat.application.workflow.__all__` with eager re-exports so the 1 existing cross-package consumer site(s) can import from the facade.
