...
<!-- FRONTMATTER RULES:
     ...
     The S351 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 6 test-only cross-package private import site(s) across 2 test file(s) reaching into `aeat.adapters.outbound.llm` onto its promoted top-level facade and ## Scope

- `src/aeat/adapters/outbound/llm (test consumers)` placeholders below are machine-filled
