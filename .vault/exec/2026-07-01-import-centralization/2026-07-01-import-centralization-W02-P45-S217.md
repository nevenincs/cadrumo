...
<!-- FRONTMATTER RULES:
     ...
     The S217 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core.time` and ## Scope

- `src/aeat/application/auth/_acquisition_lock.py` placeholders below are machine-filled
