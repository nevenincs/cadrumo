...
<!-- FRONTMATTER RULES:
     ...
     The S362 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 2 test-only cross-package private import site(s) across 1 test file(s) reaching into `aeat.entrypoints.mcp` onto its promoted top-level facade and ## Scope

- `src/aeat/entrypoints/mcp (test consumers)` placeholders below are machine-filled
