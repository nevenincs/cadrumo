...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:66dd88144039723a1b80de864784fd9ad6fa373ad6cf6bf44d9b1637972759b6'
step_id: 'S94'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 10 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.buckets`, `aeat.domain.contribuyente`, `aeat.domain.modelos`

## Scope

- `src/aeat/application/modelo/_work_lifecycle.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 10 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.buckets`, `aeat.domain.contribuyente`, `aeat.domain.modelos`.
