...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:f9130558ea1475182a13350b09620da6e3c143ad267bab5498fba61e1fd3f1f1'
step_id: 'S118'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 2 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.crypto`

## Scope

- `src/aeat/adapters/persistence/storage/sql/_secure_object_integrity.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 2 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.crypto`.
