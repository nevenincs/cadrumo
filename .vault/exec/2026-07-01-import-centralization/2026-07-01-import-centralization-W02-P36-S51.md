...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:ed0314cd3bf3527b2bbdc11e40e91d716d450b34449d7bd0c592ca4929400a6b'
step_id: 'S51'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 17 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.buckets`, `aeat.domain.modelos`

## Scope

- `src/aeat/application/modelo/_amendment_actions.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 17 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.buckets`, `aeat.domain.modelos`.
