...
<!-- FRONTMATTER RULES:
     ...
     The S358 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 12 test-only cross-package private import site(s) across 11 test file(s) reaching into `aeat.core.i18n` onto its promoted top-level facade and ## Scope

- `src/aeat/core/i18n (test consumers)` placeholders below are machine-filled
