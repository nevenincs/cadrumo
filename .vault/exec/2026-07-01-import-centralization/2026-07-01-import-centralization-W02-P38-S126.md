...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:cb572539732c5e2ecac4a4698d483816fc42897badc05027cf00ee1bc17be70d'
step_id: 'S126'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 4 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.outbound.google`

## Scope

- `src/aeat/entrypoints/cli/_config/_google_folder.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 4 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.outbound.google`.
