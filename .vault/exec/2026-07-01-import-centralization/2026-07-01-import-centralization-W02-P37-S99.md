...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:e36c83b3bb86ad47c4e6be127de9a4e9eac28351055cb5f6520d8ab6807526ac'
step_id: 'S99'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 8 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.blob_store`, `aeat.adapters.persistence.storage.crypto`, `aeat.adapters.persistence.storage.envelope`, `aeat.adapters.persistence.storage.master_key`
...
- Preserve the row intent: Rewire 8 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.blob_store`, `aeat.adapters.persistence.storage.crypto`, `aeat.adapters.persistence.storage.envelope`, `aeat.adapters.persistence.storage.master_key`.
