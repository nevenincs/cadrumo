...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:5f7c5624cd9a13a1bc1be787a8ccb02d40996b407bf4c9296e34c51c3e033b69'
step_id: 'S91'
related:
...
- Preserve the row intent: Rewire 58 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.aggregation`, `aeat.application.calculations`, `aeat.application.workflow`, `aeat.core`, `aeat.domain.buckets`, `aeat.domain.calculations.registry`, `aeat.domain.iva_compensation`, `aeat.domain.modelos`, `aeat.domain.transactions`.
