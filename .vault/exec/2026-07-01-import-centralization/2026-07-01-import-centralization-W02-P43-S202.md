...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:67d250abdc25ec82a09521346d28bfa3205f821d4465159eb95320f5ce521609'
step_id: 'S202'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 3 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.iva_compensation`

## Scope

- `src/aeat/application/calculations/_iva_wallet_balance.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 3 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.iva_compensation`.
