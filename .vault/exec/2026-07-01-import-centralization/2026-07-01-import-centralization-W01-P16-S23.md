...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:832b3fc7232686534fe6428de98d08298637740eef34176b1fd2c92bc21c3bcb'
step_id: 'S23'
related:
...
- Preserve the row intent: Promote `list_profile_key_records`, `validate_profile_values` to `aeat.application.user_profile.__all__` with eager re-exports so the 5 existing cross-package consumer site(s) can import from the facade.
