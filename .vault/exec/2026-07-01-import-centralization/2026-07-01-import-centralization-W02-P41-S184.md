...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:70c40732f81a40a5c93fa7501ee1f422f9f23583cf8f33deda370083f431438c'
step_id: 'S184'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.deadlines`

## Scope

- `src/aeat/application/user_profile/_projections.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 1 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.deadlines`.
