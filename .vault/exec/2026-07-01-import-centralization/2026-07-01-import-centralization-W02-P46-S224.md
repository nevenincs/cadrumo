...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:cf3a6bd337dd2d8841829edc08e62d5aa7abbcb7233cb5b748b5fcc3d98996d6'
step_id: 'S224'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 17 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core`, `aeat.domain.calculations`, `aeat.domain.calculations.registry`, `aeat.domain.contribuyente`, `aeat.domain.submission`
...
- Preserve the row intent: Rewire 17 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.core`, `aeat.domain.calculations`, `aeat.domain.calculations.registry`, `aeat.domain.contribuyente`, `aeat.domain.submission`.
