...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:4521dd856c8e4d8db058ada3797eff55270575b8087283788f12bf97df6626d9'
step_id: 'S60'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 6 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.calculations`, `aeat.application.user_profile`, `aeat.domain.modelos`

## Scope

- `src/aeat/application/modelo/_calculation_preparation.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 6 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.application.calculations`, `aeat.application.user_profile`, `aeat.domain.modelos`.
