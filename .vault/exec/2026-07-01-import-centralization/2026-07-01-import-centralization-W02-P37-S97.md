...
<!-- FRONTMATTER RULES:
     ...
     The S97 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire 7 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.fincas` and ## Scope

- `src/aeat/adapters/persistence/profile/fincas.py` placeholders below are machine-filled
