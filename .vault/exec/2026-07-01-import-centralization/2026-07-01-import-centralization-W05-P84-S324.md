...
<!-- FRONTMATTER RULES:
     ...
     The S324 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 140 test-only cross-package private import site(s) across 106 test file(s) reaching into `aeat.application.workflow` onto its promoted top-level facade and ## Scope

- `src/aeat/application/workflow (test consumers)` placeholders below are machine-filled
