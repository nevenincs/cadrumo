...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:eeae4f2bd2614430302e2e11af7bdb497753f05bcd49b37a9cc05a93dfd30ed3'
step_id: 'S38'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Promote `is_link_only_mime_type` to `aeat.domain.attachments.__all__` with eager re-exports so the 1 existing cross-package consumer site(s) can import from the facade
...
- Preserve the row intent: Promote `is_link_only_mime_type` to `aeat.domain.attachments.__all__` with eager re-exports so the 1 existing cross-package consumer site(s) can import from the facade.
