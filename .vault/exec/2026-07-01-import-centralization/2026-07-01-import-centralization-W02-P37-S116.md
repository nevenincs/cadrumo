...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:1fc8e1c18a7d9c7e09766c1e2e50c098179bc781e2074dcc9d0c50accf5aa89c'
step_id: 'S116'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 8 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.blob_store`, `aeat.adapters.persistence.storage.crypto`, `aeat.adapters.persistence.storage.envelope`, `aeat.adapters.persistence.storage.master_key`, `aeat.core.time`
...
- Preserve the row intent: Rewire 8 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.adapters.persistence.storage.blob_store`, `aeat.adapters.persistence.storage.crypto`, `aeat.adapters.persistence.storage.envelope`, `aeat.adapters.persistence.storage.master_key`, `aeat.core.time`.
