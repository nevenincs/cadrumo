...
<!-- FRONTMATTER RULES:
     ...
     The S349 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 7 test-only cross-package private import site(s) across 4 test file(s) reaching into `aeat.adapters.persistence.storage` onto its promoted top-level facade and ## Scope

- `src/aeat/adapters/persistence/storage (test consumers)` placeholders below are machine-filled
