...
date: '2026-07-05'
modified: '2026-07-17'
body_hash: 'sha256:02ba1567b590194c6a124cdd909f3d40e40bef600e9b65fdde457dfc259e3d23'
step_id: 'S287'
related:
  - "[[2026-07-01-import-centralization-plan]]"
---

# Rewire 2 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.transactions`

## Scope

- `src/aeat/application/transactions/_import.py`
## Description

- Reconcile $display as an individual exec record for a W02 production consumer-rewrite row already checked in the plan.
- Preserve the row intent: Rewire 2 cross-package private import name(s) in this file onto the promoted facade(s) of `aeat.domain.transactions`.
