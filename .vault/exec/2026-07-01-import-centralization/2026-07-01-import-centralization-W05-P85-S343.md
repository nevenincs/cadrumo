...
<!-- FRONTMATTER RULES:
     ...
     The S343 and 2026-07-01-import-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewire the 20 test-only cross-package private import site(s) across 12 test file(s) reaching into `aeat.adapters.outbound.aeat.sede` onto its promoted top-level facade and ## Scope

- `src/aeat/adapters/outbound/aeat/sede (test consumers)` placeholders below are machine-filled
