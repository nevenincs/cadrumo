...
<!-- FRONTMATTER RULES:
     ...
     The S02 and 2026-07-11-censo-operator-manual-enrolment-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Retire the config profile censo pull/compare/apply/show verb family with its payloads and tests, deregister it from the profile app, and narrow CensoSyncService to the read-only afectacion projection the ledger still consumes and ## Scope
