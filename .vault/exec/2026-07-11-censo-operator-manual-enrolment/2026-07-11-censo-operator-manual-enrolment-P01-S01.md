...
<!-- FRONTMATTER RULES:
     ...
     The S01 and 2026-07-11-censo-operator-manual-enrolment-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Retire the sede live-censo scrape: delete the launcher drive, the G313 parser, their tests, the censo_g313_launcher constant, and the sede package exports and ## Scope
...
- `src/aeat/core/external_constants.toml` placeholders below are machine-filled
