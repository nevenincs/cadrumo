...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-09-compatibility-lifecycle-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Propagate rule sources to provider copies via vaultspec-core sync and ## Scope

- `.claude/rules` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Propagate rule sources to provider copies via vaultspec-core sync
