...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-09-compatibility-lifecycle-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add RELEASED-branch synthetic-input tests proving the future teeth (frozen floor, upgrader/fixture obligations) without flipping the constant or monkeypatching and ## Scope

- `src/aeat/core/tests/test_compatibility_lifecycle.py` placeholders below are machine-filled
