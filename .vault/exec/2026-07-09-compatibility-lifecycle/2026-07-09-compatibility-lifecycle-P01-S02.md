...
<!-- FRONTMATTER RULES:
     ...
     The S02 and 2026-07-09-compatibility-lifecycle-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Refactor the three tier lineage gates to assert floor == expected_floor(regime, key, current, floors) via the core facade, behaviour-identical while PRE_RELEASE and ## Scope

- `src/aeat/adapters/persistence/storage/tests/test_schema_lineage.py` placeholders below are machine-filled
