...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-05-cpdefix-followup-allgreen-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Brief future code-fixer agents with required vaultspec-rag grounding and no-reexport/no-destructive-git constraints and ## Scope

- `.vault/exec/2026-07-05-cpdefix-followup-allgreen/` placeholders below are machine-filled
