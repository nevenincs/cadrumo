...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-05-cpdefix-followup-allgreen-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Select the next triggered deferred detail-row family only if a current persona or operator filing need requires it and ## Scope
