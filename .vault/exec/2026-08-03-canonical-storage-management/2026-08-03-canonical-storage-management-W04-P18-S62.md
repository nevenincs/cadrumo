...
modified: '2026-08-03'
body_schema: 'body-v1'
body_hash: 'sha256:aa48fb84c94c82e2310b3fec40d8bfeaed944d4f584e31a061becc45e4460bcc'
step_id: 'S62'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S62 and 2026-08-03-canonical-storage-management-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Pin the bootstrap pre-emption itself so relocating tree materialisation out of bootstrap reds loudly rather than silently redistributing which surface answers a missing or occupied path, gated by a test naming the pre-emption as its subject and ## Scope

- `src/cadrumo/entrypoints/cli/_config/tests/` placeholders below are machine-filled
