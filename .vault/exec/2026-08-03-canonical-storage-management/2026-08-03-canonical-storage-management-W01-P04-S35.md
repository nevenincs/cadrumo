...
modified: '2026-08-03'
body_schema: 'body-v1'
body_hash: 'sha256:e3768df6b8eb9cf8ddafef83c03107696a471ebc3b2a12742330dec240ed576a'
step_id: 'S35'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S35 and 2026-08-03-canonical-storage-management-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewrite the observability run-directory byte total as a caller of the shared helper in tolerant mode, gated by the existing size-bound prune tests and ## Scope
