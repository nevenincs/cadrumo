...
<!-- FRONTMATTER RULES:
     ...
     The S237 and 2026-05-26-cross-domain-continuity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The R7-MARC-D1 ledger classify list view blocked by silent profile-completeness gate and ## Scope
...
- `src/aeat/application/ledger/` placeholders below are machine-filled
