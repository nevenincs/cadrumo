...
<!-- FRONTMATTER RULES:
     ...
     The S411 and 2026-05-26-cross-domain-continuity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add the socio-profile repeatable attribution_received.N.* fact group (entity_nif, entity_name, share_pct, base_imponible_attributed, filing_year) to the central profile schema with wizard/edit capture prompts and en/es/ca/hu locale keys through the locale CLI and ## Scope
