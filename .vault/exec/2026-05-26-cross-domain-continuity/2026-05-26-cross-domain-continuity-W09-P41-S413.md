...
<!-- FRONTMATTER RULES:
     ...
     The S413 and 2026-05-26-cross-domain-continuity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The emit per-socio M184 verify/file handoff info Notices carrying the attributed Modelo184MemberRow values and the exact socio-side profile-capture command and ## Scope
