...
<!-- FRONTMATTER RULES:
     ...
     The S302 and 2026-05-26-cross-domain-continuity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The R8-ROSA-F add regime incompatibility warnings and ## Scope
...
- `src/aeat/application/overview/` placeholders below are machine-filled
