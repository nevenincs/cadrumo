...
<!-- FRONTMATTER RULES:
     ...
     The S414 and 2026-05-26-cross-domain-continuity-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add the non-blocking M100 omission advisory that fires when attribution_received facts exist for the filing year but the atribucion casillas resolve empty (and prompts capture when an SC-membership signal exists with no facts), with an anti-tautology test and ## Scope
