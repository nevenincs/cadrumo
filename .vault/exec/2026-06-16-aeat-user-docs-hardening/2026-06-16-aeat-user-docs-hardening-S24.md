...
<!-- FRONTMATTER RULES:
     ...
     The S24 and 2026-06-16-aeat-user-docs-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Harden quickstart.md and ## Scope

- `docs/how-to/quickstart.md` placeholders below are machine-filled
