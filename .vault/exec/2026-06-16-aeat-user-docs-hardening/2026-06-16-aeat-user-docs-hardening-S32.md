...
<!-- FRONTMATTER RULES:
     ...
     The S32 and 2026-06-16-aeat-user-docs-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Harden verification-reports.md and ## Scope

- `docs/how-to/verification-reports.md` placeholders below are machine-filled
