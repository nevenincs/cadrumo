...
related:
  ...
  - '[[2026-06-03-secure-storage-production-hardening-W12-P26-S157-review]]'
---
...
- Closed `S157` through `vaultspec-core vault plan step check`.
...
- `uv run --no-sync pytest -q src/aeat/adapters/persistence/storage/bucket/test_export_header.py`
