...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-16-protected-browser-certificate-auth-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Correct maintainer contracts that still describe marker evidence or implicit browser-factory construction and ## Scope

- `src/cadrumo/adapters/outbound/aeat/auth/_authenticator.py` placeholders below are machine-filled
