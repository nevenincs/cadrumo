...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-07-16-protected-browser-certificate-auth-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Run repository-wide quality Vault documentation packaging and CI-equivalent gates and resolve the formal audit and ## Scope

- `.vault/audit/2026-07-16-protected-browser-certificate-auth-audit.md`
- `repository` placeholders below are machine-filled
