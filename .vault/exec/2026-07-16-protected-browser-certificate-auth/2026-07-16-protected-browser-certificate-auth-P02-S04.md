...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-07-16-protected-browser-certificate-auth-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Close Clave contexts and browsers when fresh-session persistence fails before ownership transfer and ## Scope

- `src/cadrumo/adapters/outbound/aeat/auth/_clave_movil.py`
- `src/cadrumo/adapters/outbound/aeat/auth/_clave_permanente.py` placeholders below are machine-filled
