...
<!-- FRONTMATTER RULES:
     ...
     The S26 and 2026-07-13-data-output-standardization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Promote one canonical public isolation fixture covering every settings dir field, with a structural coverage gate and ## Scope

- `src/cadrumo/tests/secure_sql.py` placeholders below are machine-filled
