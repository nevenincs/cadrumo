...
<!-- FRONTMATTER RULES:
     ...
     The S20 and 2026-07-13-data-output-standardization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Repair gitignore: fix dead src/aeat corpus-manual rules, add runtime-s pattern, broaden root-level scratch patterns and ## Scope

- `.gitignore` placeholders below are machine-filled
