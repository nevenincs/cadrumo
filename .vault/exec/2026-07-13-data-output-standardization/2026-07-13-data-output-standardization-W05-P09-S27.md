...
<!-- FRONTMATTER RULES:
     ...
     The S27 and 2026-07-13-data-output-standardization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Sweep the copy-pasted isolated-cli-backend fixture copies onto the canonical fixture and ## Scope

- `cli test isolation fixtures` placeholders below are machine-filled
