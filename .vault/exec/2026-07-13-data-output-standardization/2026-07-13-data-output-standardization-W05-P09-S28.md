...
<!-- FRONTMATTER RULES:
     ...
     The S28 and 2026-07-13-data-output-standardization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Sweep the isolated-storage fixture family and unify the two collection-time pytest storage roots into one cleanup-registered helper and ## Scope

- `conftest storage roots` placeholders below are machine-filled
