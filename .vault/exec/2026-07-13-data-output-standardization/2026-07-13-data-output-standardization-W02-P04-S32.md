...
<!-- FRONTMATTER RULES:
     ...
     The S32 and 2026-07-13-data-output-standardization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Wire the dormant LLM and run-trace retention prunes into production paths, narrow the usage read-path uuid refusal, and add the retention-wiring gate (W02 review remediation) and ## Scope

- `src/cadrumo/adapters/outbound/llm/_client.py` placeholders below are machine-filled
