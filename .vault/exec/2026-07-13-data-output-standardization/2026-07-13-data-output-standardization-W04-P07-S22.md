...
<!-- FRONTMATTER RULES:
     ...
     The S22 and 2026-07-13-data-output-standardization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Clean stale scratch and runtime-s directories after confirming no active-agent ownership, and document the scratch naming schema and ## Scope

- `scratch` placeholders below are machine-filled
