...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-07-27-conformance-cli-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add the dev-path isolation gate asserting no shipped module imports dev.* or embeds a dev/ path literal, with an injectable-root anti-tautology proof and ## Scope
