...
<!-- FRONTMATTER RULES:
     ...
     The S45 and 2026-07-27-conformance-cli-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The bind the registry prorrata percentage formula to the domain prorrata function with a parity gate over ratios that discriminate between the two roundings, closing the two-authorities condition that hid the rounding defect and ## Scope

- `src/cadrumo/domain/iva/_prorrata.py` placeholders below are machine-filled
