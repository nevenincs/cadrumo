...
<!-- FRONTMATTER RULES:
     ...
     The S76 and 2026-07-27-conformance-cli-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The open a follow-up feature tracking the four measurement-audit recommendations so ninety unreviewed revisions, twenty-four classification divergences and five unused schema axes have an owner rather than living as prose and ## Scope
