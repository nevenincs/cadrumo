...
<!-- FRONTMATTER RULES:
     ...
     The S43 and 2026-07-27-conformance-cli-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add a fixed lower bound to the signoff horizon so a review dated before the revision existed refuses, mirroring the ceiling that already catches the far-future sentinel and ## Scope
