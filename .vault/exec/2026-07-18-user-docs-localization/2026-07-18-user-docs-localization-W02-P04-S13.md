...
<!-- FRONTMATTER RULES:
     ...
     The S13 and 2026-07-18-user-docs-localization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Translate the how-to section catalogues to Catalan with full-page domain context and ## Scope
