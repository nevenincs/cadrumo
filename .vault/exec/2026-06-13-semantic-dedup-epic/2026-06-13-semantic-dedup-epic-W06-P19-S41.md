...
<!-- FRONTMATTER RULES:
     ...
     The S41 and 2026-06-13-semantic-dedup-epic-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The C3 Extract a single-catalogue secure repository base and route the four substitutable catalogue repos through it and ## Scope

- `src/aeat/adapters/persistence/storage/envelope/_secure_repository.py` placeholders below are machine-filled
