...
<!-- FRONTMATTER RULES:
     ...
     The S16 and 2026-07-17-ledger-evidence-atomicity-plan placeholders are machine-filled by
...
- `src/cadrumo/application/ledger/_models.py` placeholders below are machine-filled
