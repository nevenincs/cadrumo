...
modified: '2026-08-08'
body_schema: 'body-v1'
body_hash: 'sha256:cd02c433c6554302749182bb804ff9794c2b9aa8c395f81d288b486e7cedf128'
step_id: 'S08'
related:
  - "[[2026-08-08-aeat-design-relayout-boundary-plan]]"
---
# Re-key the slot-occupancy inventory on the design file rather than the parsed year
...
The occupancy signal now compares the two designs from the claimed-design sequence rather than resolving a year through a source map that kept the first design by filename sort. This is the only signal that sees a slot retired into or revived out of reserved space with no box moved and no page length changed, and it is the signal that carries the Modelo 303 2023-to-early-2024 boundary entirely on its own: four Regimen Simplificado employee-count slots at sheet DP30302 offsets 1110, 1116, 1236 and 1242. Under year-keying that boundary was measured against whichever 2024 half sorted first.
