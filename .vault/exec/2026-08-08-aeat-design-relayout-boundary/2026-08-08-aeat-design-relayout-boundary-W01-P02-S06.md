...
modified: '2026-08-08'
body_schema: 'body-v1'
body_hash: 'sha256:fae118954dce60aaf1b6ba80774d0263528ba50fd5e89023fb043e35fcc86eb3'
step_id: 'S06'
related:
  - "[[2026-08-08-aeat-design-relayout-boundary-plan]]"
---
# Re-key the box-offset design inventory on the design file rather than the parsed year
...
The box-offset signal now reads its two designs from the claimed-design sequence directly rather than from a year-keyed map of box offsets built with one setdefault per year. Where AEAT split an ejercicio mid-course the second half never entered that map, so the offsets on the far side of a mid-year boundary were compared against nothing. This is the signal that finds a relocation such as the 127-box Modelo 303 2025-to-2026 shift, and it is now also the signal that reports the eight boxes AEAT introduced at periods 09 and 3T of 2024 against the correct earlier half rather than against the previous year.
