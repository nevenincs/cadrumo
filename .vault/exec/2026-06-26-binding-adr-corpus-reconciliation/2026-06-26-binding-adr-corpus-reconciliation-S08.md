...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-06-26-binding-adr-corpus-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The REWORK: re-point the m390-iva-carry-boxes Status from the apex to the phase ADRs (child of the unified carry authority) and ## Scope

- `.vault/adr/2026-06-21-m390-iva-carry-boxes-adr.md` placeholders below are machine-filled
