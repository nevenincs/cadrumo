...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-07-13-docs-terminology-search-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Implement the upstream-schema adapter: serialize the repo PreprocessOutput to the upstream PreprocOutput JSON contract behind a python -m entry point, with unit tests against the pinned schema major and ## Scope

- `dev/docs/preprocess/` placeholders below are machine-filled
