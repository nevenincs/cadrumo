...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-07-13-docs-cli-sequences-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Implement the per-sequence sandbox runner (fresh isolated_profile_storage_root, frozen_clock, injected profile_id, English output, live tests off, invoke_cached_cli per frame) and ## Scope
