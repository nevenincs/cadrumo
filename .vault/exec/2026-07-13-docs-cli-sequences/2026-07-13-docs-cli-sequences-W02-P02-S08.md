...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-07-13-docs-cli-sequences-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Write parser unit tests covering grammar acceptance, every refusal case, capture and expect binding, and seed inlining and ## Scope

- `dev/docs/sequences/tests/test_parser.py` placeholders below are machine-filled
