...
# `P03.S09` — implement `aeat config google sync pull` Typer command
...
# implement `aeat config google sync pull` Typer command
...
- Reconcile `P03.S09` against the accepted July architecture and current code.
