...
# `P03.S12` — implement `aeat config google sync claim --file-id <id>` Typer command
...
# implement `aeat config google sync claim --file-id <id>` Typer command
...
- Reconcile `P03.S12` against the accepted July architecture and current code.
