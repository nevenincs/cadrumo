...
# `P03.S10` — implement `aeat config google sync status [--format json|text]` Typer command
...
# implement `aeat config google sync status [--format json|text]` Typer command
...
- Reconcile `P03.S10` against the accepted July architecture and current code.
