...
# `P06.S02` — implement `SecureObjectRepository.iter_all_records_raw()` returning memory-bounded generator
...
# implement `SecureObjectRepository.iter_all_records_raw()` returning memory-bounded generator
...
- Reconcile `P06.S02` against the accepted July architecture and current code.
...
Delivered by the memory-bounded raw secure-object iterator.
