...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-06-26-binding-resolver-contract-unification-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Delete the consumer-less ModeloLedgerBindingAggregation model and its test after confirming zero live consumers at HEAD and ## Scope

- `src/aeat/application/aggregation/_modelo_bindings.py` placeholders below are machine-filled
