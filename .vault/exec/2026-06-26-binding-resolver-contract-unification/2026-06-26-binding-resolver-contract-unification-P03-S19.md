...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-06-26-binding-resolver-contract-unification-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Prove the retenciones collapse is behaviour-preserving by asserting the single mesh RetencionesAggregationSourceResolver reproduces the prior per-modelo-service aggregation value exactly against a 111/115/123/180/190/193 fixture, with the landed perceptor-count result unchanged and no casilla value shift and ## Scope
