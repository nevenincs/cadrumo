...
modified: '2026-09-05'
body_schema: 'body-v2'
body_hash: 'sha256:57f33fc2edfc5d747148f675ace8b288fe46cd822b5479422ac4fb9b424825ec'
step_id: 'S07'
related:
...
- `verify:` `uv run --no-sync pytest -q -n 0 dev/quality/tests/test_clitui_ledger_capability_matrix.py` -> `pass` (176 passed)
