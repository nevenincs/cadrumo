...
- The predecessor TUI plan was independently parsed at its current concurrent baseline of **434 rows / 418 checked**. Its exact Ledger overlap remains 27 retained evidence rows, one retired-premise marker, and five displaced-and-held rows; `S411` and mixed-scope `S424` remain open and held so their checkboxes agree with their dispositions.
