...
<!-- FRONTMATTER RULES:
     ...
     The S13 and 2026-07-14-honest-all-green-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the period-gate allowlist for the landed docs sequences WorkUnit display frames per the established narrow-rule precedent and ## Scope

- `src/cadrumo/core/tests/test_period_combined_string_gate.py` placeholders below are machine-filled
