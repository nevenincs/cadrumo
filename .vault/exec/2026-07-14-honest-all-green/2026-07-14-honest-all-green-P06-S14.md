...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-07-14-honest-all-green-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Complete the landed CLI-identity rename's locale sweep so codebase-to-locale parity and the two locale-audit tests are green and ## Scope
