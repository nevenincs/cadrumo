...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-07-14-honest-all-green-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Fix the secure-object integrity diagnostics failures after master-key rotation and ## Scope

- `src/cadrumo diagnostics integrity` placeholders below are machine-filled
