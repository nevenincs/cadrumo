...
<!-- FRONTMATTER RULES:
     ...
     The S01 and 2026-07-14-honest-all-green-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Diagnose the renta binding-resolution root cause including the profile-has-economic-activity unsupplied binding and classify each failing assertion as engine defect or expectation defect with authority evidence and ## Scope
