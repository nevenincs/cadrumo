...
- `src/aeat/cli/submission/` — Typer sub-app with five subcommands
...
- `src/aeat/cli/__init__.py` — registered `submission_module.app`.

## verification

- `uv run pytest src/aeat/cli/submission -q` — passed.
