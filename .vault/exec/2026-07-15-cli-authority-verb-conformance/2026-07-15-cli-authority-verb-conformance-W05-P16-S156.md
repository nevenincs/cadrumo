...
<!-- FRONTMATTER RULES:
     ...
     The S156 and 2026-07-15-cli-authority-verb-conformance-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Assert MCP risk annotations match the operator risk table and ## Scope

- `src/cadrumo/entrypoints/mcp/tests/test_risk_table_parity.py` placeholders below are machine-filled
