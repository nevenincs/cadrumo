...
<!-- FRONTMATTER RULES:
     ...
     The S280 and 2026-07-15-cli-authority-verb-conformance-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Remove the retired evidence-bundle replay from the modelo-390 records-audit sequence prose, which contradicts its own blocked annotation and ## Scope

- `docs/_sequences/contracts/how-to/modelo-390/` placeholders below are machine-filled
