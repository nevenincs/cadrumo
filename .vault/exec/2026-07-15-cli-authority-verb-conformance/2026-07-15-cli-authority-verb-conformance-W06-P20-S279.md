...
<!-- FRONTMATTER RULES:
     ...
     The S279 and 2026-07-15-cli-authority-verb-conformance-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Refer the config CLI module size breach to the peer TUI campaign that caused it, since the module stood at 1254 lines inside budget before the manager-from-create commit added 134 and ## Scope

- `src/cadrumo/entrypoints/cli/_config/__init__.py` placeholders below are machine-filled
