...
<!-- FRONTMATTER RULES:
     ...
     The S170 and 2026-07-15-cli-authority-verb-conformance-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Regenerate authentication sequence goldens for login, logout, reset, and certificate secrets and ## Scope

- `docs/_sequences/how-to/authenticate-with-aeat/` placeholders below are machine-filled
