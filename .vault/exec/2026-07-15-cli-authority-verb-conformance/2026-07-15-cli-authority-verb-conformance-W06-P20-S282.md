...
<!-- FRONTMATTER RULES:
     ...
     The S282 and 2026-07-15-cli-authority-verb-conformance-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Remove the two Code-Stands-Alone violations, a feature tag in a hashing test docstring and vault stems in the duplication disposition fields and ## Scope

- `src/cadrumo/core/tests/test_hashing_adoption.py`
- `dev/audit/duplication_dispositions.toml` placeholders below are machine-filled
