...
<!-- FRONTMATTER RULES:
     ...
     The S275 and 2026-07-15-cli-authority-verb-conformance-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Teach the documented-command conformance parser to recognise a blocked-row marker rather than reading its prose as a command path and ## Scope
