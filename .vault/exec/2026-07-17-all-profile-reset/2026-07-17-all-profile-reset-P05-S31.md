...
<!-- FRONTMATTER RULES:
     ...
     The S31 and 2026-07-17-all-profile-reset-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Sweep the MCP identity gate off the sandbox-use grammar onto switch-based sandbox addressing, updating its identity-changing command set and docstring and ## Scope
