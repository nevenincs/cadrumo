...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-07-01-fichero-boe-parity-gate-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add an anti-tautology drift case mutating a rendered field number or order and asserting the gate panics and ## Scope
