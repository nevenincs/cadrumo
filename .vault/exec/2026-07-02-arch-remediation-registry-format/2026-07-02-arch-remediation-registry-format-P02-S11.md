...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-07-02-arch-remediation-registry-format-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Migrate the M369 inline schemas to the fragmented layout in one atomic commit gated by the equality test plus the M369 filing-grade suites and ## Scope

- `src/aeat/_data/registry/aeat/modelos/369` placeholders below are machine-filled
