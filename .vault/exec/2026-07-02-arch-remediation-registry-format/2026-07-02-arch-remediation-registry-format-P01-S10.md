...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-02-arch-remediation-registry-format-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Migrate modelo 361 inline revision to the fragmented layout in one atomic commit gated by the equality test and a green registry validator and ## Scope

- `src/aeat/_data/registry/aeat/modelos/361` placeholders below are machine-filled
