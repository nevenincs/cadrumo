...
<!-- FRONTMATTER RULES:
     ...
     The S01 and 2026-07-02-arch-remediation-registry-format-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Author the parameterised compiled-schema equality harness that captures each inline revision pre-migration ModeloRevision and asserts model equality against the post-migration fragmented shape and ## Scope

- `src/aeat/domain/calculations/registry/tests/test_inline_fragment_equality.py` placeholders below are machine-filled
