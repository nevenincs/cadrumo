...
<!-- FRONTMATTER RULES:
     ...
     The S22 and 2026-06-02-session-honest-followups-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Drive P04.S10 catalogue verification to closure and ## Scope

- `src/aeat/domain/calculations/registry/test_catalogue_verification.py` placeholders below are machine-filled
