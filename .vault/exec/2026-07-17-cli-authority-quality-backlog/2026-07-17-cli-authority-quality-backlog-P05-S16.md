...
<!-- FRONTMATTER RULES:
     ...
     The S16 and 2026-07-17-cli-authority-quality-backlog-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Route classify --auto-split and split --llm through the typed review workflow with distinct invocation origins and remove CLI-owned review branching and application source-command defaults and ## Scope

- `src/cadrumo/entrypoints/cli/_ledger_llm_cli.py` placeholders below are machine-filled
