...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-17-cli-authority-quality-backlog-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Remove duplicate namespace, version, sensitivity, catalogue-key, and custody literals from transaction, invoice, modelo participation, and bucket persistence consumers and bind them to registry definitions and ## Scope
