...
<!-- FRONTMATTER RULES:
     ...
     The S05 and 2026-06-21-crossperiod-filing-deadlock-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Update the workflow engine tests to Decision A semantics (targeted overdue admitted, closed-window FILE no longer aborts DEADLINE_PASSED) and ## Scope

- `src/aeat/application/workflow/tests/test_engine.py` placeholders below are machine-filled
