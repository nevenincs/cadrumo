...
<!-- FRONTMATTER RULES:
     ...
     The S39 and 2026-07-06-cross-period-prorrata-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The record the deferred automatic art-104.Tres exclusion classification in the ledger rollup as a follow-up (the rollup stays a reconciliation check until it lands) and ## Scope

- `.vault/exec/2026-07-06-cross-period-prorrata/` placeholders below are machine-filled
