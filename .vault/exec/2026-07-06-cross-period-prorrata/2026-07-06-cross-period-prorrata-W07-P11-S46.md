...
<!-- FRONTMATTER RULES:
     ...
     The S46 and 2026-07-06-cross-period-prorrata-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The implement the prorrata_regularizacion live source resolver with binding values, unresolved diagnostics, and provenance from the register or stamped prior observation plus current-year registry values and ## Scope
