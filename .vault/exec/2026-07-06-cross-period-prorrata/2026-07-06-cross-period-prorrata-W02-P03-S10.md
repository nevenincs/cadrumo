...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-06-cross-period-prorrata-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The implement the seed function: resolve the prior settlement revision via select_revision(M303, ejercicio-1, settlement period), read the iva.prorrata-porcentaje observation, and re-confirm its stamped_revision_id before seeding the carried_prior_definitiva entry and ## Scope
