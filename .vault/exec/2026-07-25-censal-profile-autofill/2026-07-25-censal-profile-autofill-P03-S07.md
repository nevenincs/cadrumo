...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-25-censal-profile-autofill-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Map the identity and address fields read from mis datos censales onto profile schema paths with a provenance token naming the consulta surface, the regime fields being out of scope while they have no route and ## Scope
