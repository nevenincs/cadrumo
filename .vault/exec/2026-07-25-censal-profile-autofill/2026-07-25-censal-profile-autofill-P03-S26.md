...
<!-- FRONTMATTER RULES:
     ...
     The S26 and 2026-07-25-censal-profile-autofill-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Prove by execution whether the ownership guard reads a deliberately cleared identity as a first read, and close the adoption path if it does, a cleared identity being an operator decision rather than an absent one and ## Scope

- `src/cadrumo/application/user_profile/_censo_sync.py` placeholders below are machine-filled
