...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-25-censal-profile-autofill-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify the whole path live end to end in three phases, a pull onto a blank profile that adopts, a second unchanged pull that is a no-op, and a third pull after the operator edits an adopted value that reports the divergence rather than overwriting it and ## Scope

- `src/cadrumo/application/live/tests` placeholders below are machine-filled
