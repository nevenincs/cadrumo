...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-07-25-censal-profile-autofill-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Record the per-activity modulos precondition at the divergence predicate in every revision carrying it, and the mixed-scope warning at the profile schema, so the reasoning sits where the promoting change would be made rather than in a record and ## Scope

- `src/cadrumo/_data/registry/aeat/modelos/131` placeholders below are machine-filled
