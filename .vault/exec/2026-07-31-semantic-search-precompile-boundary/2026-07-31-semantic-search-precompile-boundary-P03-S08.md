...
modified: '2026-08-01'
body_schema: 'body-v1'
body_hash: 'sha256:e45522ececf154f833917c4c3e87778a762a39fa3748309f28d3ebeaf3b032a7'
step_id: 'S08'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-07-31-semantic-search-precompile-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Delete the search optional extra with its model2vec, huggingface-hub, and numpy pins, prune the all aggregate, promote snowballstemmer into the core dependency set, and refresh the lockfile and ## Scope
