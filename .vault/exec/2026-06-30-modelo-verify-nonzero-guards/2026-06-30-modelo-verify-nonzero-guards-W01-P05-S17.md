...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-06-30-modelo-verify-nonzero-guards-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a gate-behaviour test calling evaluate_verification_predicates directly for the M210 rendimientos-integros-to-base-imponible advisory, proving FIRES on positive-rendimientos-zero-base, HOLDS on positive-rendimientos-positive-base, and trivial-HOLD on zero-or-negative-rendimientos and ## Scope

- `src/aeat/application/modelo/tests/test_verification_m210_advisory.py` placeholders below are machine-filled
