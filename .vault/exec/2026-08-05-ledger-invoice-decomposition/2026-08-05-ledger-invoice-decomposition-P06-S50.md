...
modified: '2026-08-06'
body_schema: 'body-v1'
body_hash: 'sha256:3506596ae44115600a29f03099f944530ccc8a02bb8da6057982ad5d31342d8d'
step_id: 'S50'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S50 and 2026-08-05-ledger-invoice-decomposition-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Refuse a suite of deliberately degraded invoices, each asserting its own specific refusal rather than that something failed, covering the falsified-total, netted-retencion, contradicted-operation-date, referentless-rectificativa and over-threshold-simplificada cases and ## Scope

- `src/cadrumo/domain/invoices/tests` placeholders below are machine-filled
