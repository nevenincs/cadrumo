...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-08-mcp-identity-linked-operation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the shared-spine conformance test so the success and error envelopes both carry active_profile and a profile-bound command populates it and ## Scope
