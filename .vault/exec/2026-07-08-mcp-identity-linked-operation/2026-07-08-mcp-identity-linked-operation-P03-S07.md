...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-08-mcp-identity-linked-operation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add per-session identity-read state and the block-first-mutation gate, re-armed on any profile-changing verb, refusing an unconfirmed first mutating call with an instructive localized refusal keyed off the risk table and ## Scope

- `src/aeat/entrypoints/mcp/_identity_gate.py` placeholders below are machine-filled
