...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-07-08-mcp-identity-linked-operation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add whoami tests: it is always advertised, returns the active label, and is never persona-scoped away and ## Scope

- `src/aeat/entrypoints/mcp/tests/test_harness_delivery.py` placeholders below are machine-filled
