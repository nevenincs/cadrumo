...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-07-08-mcp-identity-linked-operation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Wire the identity gate into the pre-tool-use path byte-identically on the direct and execute paths, and name the active-profile label in the CONFIRM elicitation prompt and ## Scope
