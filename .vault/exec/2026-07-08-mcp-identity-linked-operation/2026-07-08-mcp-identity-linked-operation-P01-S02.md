...
<!-- FRONTMATTER RULES:
     ...
     The S02 and 2026-07-08-mcp-identity-linked-operation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Populate active_profile at emit for profile-bound commands from the active-profile resolution, leaving the redacted bucket/profile UUIDs untouched and ## Scope

- `src/aeat/entrypoints/cli/_config/_active_profile.py` placeholders below are machine-filled
