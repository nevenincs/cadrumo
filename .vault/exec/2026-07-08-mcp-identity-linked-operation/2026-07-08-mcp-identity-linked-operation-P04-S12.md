...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-08-mcp-identity-linked-operation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the live scoring with an identity-confirmation dimension and run the scenario before and after as the acceptance gate and ## Scope

- `src/aeat/agent/eval/_live_scoring.py` placeholders below are machine-filled
