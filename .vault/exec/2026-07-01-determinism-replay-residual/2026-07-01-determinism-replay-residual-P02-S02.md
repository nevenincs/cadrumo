...
- The ledger-evidence `--format json` golden scenario the ADR pairs with this decision is enrolled in the Decision-4 determinism-conformance axis (P04), per the ADR Consequences ("content-addressed ledger ids let the ledger-evidence ... scenarios enrol in the decision-4 determinism-coverage axis") — kept there rather than duplicated here.
