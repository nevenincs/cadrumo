...
- `src/aeat/formulas/test_ruleset.py` — added a module-level
...
- `src/aeat/cli/audit/__init__.py` — `audit_app` + `rulesets_app` +
...
- `src/aeat/cli/audit/_helpers.py` — `CitationCoverageReport`
...
- `src/aeat/cli/audit/test_citations_cmd.py` — six tests covering
...
- `src/aeat/formulas/test_casilla_validator.py` — four unit tests for
  the validator: pass case, fail case, informational-skip case,
  multiple-citation pass case.
- `src/aeat/models/test_citations_source_enum.py` — four tests
...
- `src/aeat/formulas/test_casilla_validator.py` — 4 / 4 passed.
- `src/aeat/models/test_citations_source_enum.py` — 4 / 4 passed.
- `src/aeat/cli/audit/test_citations_cmd.py` — 6 / 6 passed.
- `src/aeat/formulas/_rulesets/test_all_rulesets_have_citations.py`
...
- `git diff origin/main..HEAD -- src/aeat/cli/__init__.py` — empty
