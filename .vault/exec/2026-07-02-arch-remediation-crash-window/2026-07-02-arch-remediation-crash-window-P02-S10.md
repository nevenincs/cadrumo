...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-02-arch-remediation-crash-window-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Author the rename-profile crash-injection test proving the diagnostics detect label drift and the repair re-syncs the manifest from the authoritative SQLite record and ## Scope
