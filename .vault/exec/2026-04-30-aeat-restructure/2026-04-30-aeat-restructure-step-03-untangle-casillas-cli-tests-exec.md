...
- `git mv src/aeat/casillas/_test_cli.py src/aeat/cli/_test_casillas.py`
- `git mv src/aeat/casillas/test_live_cli.py src/aeat/cli/test_live_casillas.py`
...
- `pytest --collect-only src/aeat/cli/_test_casillas.py src/aeat/cli/test_live_casillas.py` reports the moved test files at their new home; no orphans at the old paths.
