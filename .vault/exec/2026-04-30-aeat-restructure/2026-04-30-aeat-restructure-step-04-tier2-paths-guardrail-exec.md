...
Step 5 — Tooling prep (multi-day net-new build): rebase script + import-contract tests + smoke test + type-checker config + packaging tests. Each artefact is independently runnable and CI-gating before Step 6's freeze trigger fires.
