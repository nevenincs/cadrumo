...
- `src/cadrumo/domain/calculations/registry/m303_regimen_simplificado_projection.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/m303_regimen_simplificado_projection.py` already advertises only symbols it
