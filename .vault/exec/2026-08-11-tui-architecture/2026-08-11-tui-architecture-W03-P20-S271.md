...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:6f53328432fabb9a87b0a3f549347982ea1adb57ff629ea7ca7729a20a9587df'
step_id: 'S271'
related:
...
`.py` files under `src/`, `dev/` and `docs/` for DataBindingDefinition, confirmed no
consumer imports any of them from `bindings.py` (only from their real
defining module, `schema.py`), and confirmed `bindings.py` itself no
