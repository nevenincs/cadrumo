...
- `src/cadrumo/domain/calculations/registry/groi_oracle.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/groi_oracle.py` already advertises only symbols it
