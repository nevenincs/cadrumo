...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:9f9d41008c8caf07070232da19d095afd034de52b0ca27f28f28a8a67948e35f'
step_id: 'S200'
related:
  - "[[2026-08-11-tui-architecture-plan]]"
---

# Prove formula_text_inputs remains public with locally defined symbols and direct consumer imports

## Scope

- `src/cadrumo/domain/calculations/registry/formula_text_inputs.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/formula_text_inputs.py` already advertises only symbols it
