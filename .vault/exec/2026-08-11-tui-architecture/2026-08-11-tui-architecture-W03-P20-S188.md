...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:39c5ca099a81f6395673ed1a9674191f61b7b95c2634cd21dd3776c10df50860'
step_id: 'S188'
related:
...
# Prove coverage remains public with locally defined symbols and direct consumer imports

## Scope

- `src/cadrumo/domain/calculations/registry/coverage.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/coverage.py` already advertises only symbols it
