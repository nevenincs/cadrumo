...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:7ac556762846510c04db4b1343c3783133e9c94409b63f6baba78b66e792ae2f'
step_id: 'S268'
related:
...
`.py` files under `src/`, `dev/` and `docs/` for IvaLedgerObservation, OssIossLedgerObservation, RentaGastosEstimacionDirectaObservationProtocol, RentaGastosPagoFraccionadoObservationProtocol, RentaIncomeObservationProtocol, UngroundedRentaIncome, and the remaining ledger_bindings re-exports, confirmed no
consumer imports any of them from `bindings.py` (only from their real
defining module, `ledger_bindings.py`), and confirmed `bindings.py` itself no
