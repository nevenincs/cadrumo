...
- `src/cadrumo/domain/calculations/registry/period_selector_match.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/period_selector_match.py` already advertises only symbols it
