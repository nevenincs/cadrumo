...
- `src/cadrumo/domain/calculations/registry/classification_coherence.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/classification_coherence.py` already advertises only symbols it
