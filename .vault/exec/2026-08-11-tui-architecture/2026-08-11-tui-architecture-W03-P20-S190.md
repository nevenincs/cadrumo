...
- `src/cadrumo/domain/calculations/registry/deadline_coordinate.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/deadline_coordinate.py` already advertises only symbols it
