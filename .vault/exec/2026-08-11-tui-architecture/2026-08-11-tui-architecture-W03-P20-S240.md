...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:baaa1b52fd9a7275c204efc9217d5b3c657d492f54c9374f908b8f225f3427f8'
step_id: 'S240'
related:
...
# Prove schema_verification remains public with locally defined symbols and direct consumer imports

## Scope

- `src/cadrumo/domain/calculations/registry/schema_verification.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/schema_verification.py` already advertises only symbols it
