...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:f1faf17026a53f69744d4021ac367532b012546455499caf3d3d7a041d0ea7e9'
step_id: 'S237'
related:
...
# Prove schema_input_kind remains public with locally defined symbols and direct consumer imports

## Scope

- `src/cadrumo/domain/calculations/registry/schema_input_kind.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/schema_input_kind.py` already advertises only symbols it
