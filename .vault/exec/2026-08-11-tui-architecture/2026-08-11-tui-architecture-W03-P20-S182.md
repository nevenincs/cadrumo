...
- `src/cadrumo/domain/calculations/registry/casilla_membership.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/casilla_membership.py` already advertises only symbols it
