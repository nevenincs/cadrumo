...
- `src/cadrumo/domain/calculations/registry/validate_registry_scope.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/validate_registry_scope.py` already advertises only symbols it
