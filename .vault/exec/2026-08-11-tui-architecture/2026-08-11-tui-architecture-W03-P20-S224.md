...
- `src/cadrumo/domain/calculations/registry/period_offset_math.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/period_offset_math.py` already advertises only symbols it
