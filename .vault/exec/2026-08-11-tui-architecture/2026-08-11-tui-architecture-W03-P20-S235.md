...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:8454775c3828f52268e839e1063fd13a146c1e706880f5491f7196a1744a7a36'
step_id: 'S235'
related:
...
# Prove schedules remains public with locally defined symbols and direct consumer imports

## Scope

- `src/cadrumo/domain/calculations/registry/schedules.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/schedules.py` already advertises only symbols it
