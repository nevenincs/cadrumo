...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:b2d65cc72ba3459597986b96bd305b9731df3d7b042adc7f88acdd6425ef4176'
step_id: 'S220'
related:
...
# Prove m303_prorrata_activity_projection remains public with locally defined symbols and direct consumer imports

## Scope

- `src/cadrumo/domain/calculations/registry/m303_prorrata_activity_projection.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/m303_prorrata_activity_projection.py` already advertises only symbols it
