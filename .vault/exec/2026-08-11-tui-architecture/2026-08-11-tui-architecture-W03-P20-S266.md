...
modified: '2026-08-26'
body_schema: 'body-v2'
body_hash: 'sha256:dab3420cb9be2daf77d9bc5cee4264dda0b0a9ed2a24bb30c0042f012c4b746b'
step_id: 'S266'
related:
...
- `src/cadrumo/domain/calculations/registry/irnr_ledger_bindings.py`
...
`.py` files under `src/`, `dev/` and `docs/` for IrnrIncomeObservationProtocol, resolve_ledger_irnr_income_aggregation_binding_values, unsupported_ledger_irnr_income_observations, validate_ledger_irnr_income_aggregation_binding_definition, confirmed no
consumer imports any of them from `bindings.py` (only from their real
defining module, `irnr_ledger_bindings.py`), and confirmed `bindings.py` itself no
