...
- `src/cadrumo/domain/calculations/registry/formula_runtime_ops.py`
...
No source change was needed: `src/cadrumo/domain/calculations/registry/formula_runtime_ops.py` already advertises only symbols it
