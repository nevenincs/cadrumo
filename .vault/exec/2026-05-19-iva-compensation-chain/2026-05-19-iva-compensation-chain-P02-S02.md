...
<!-- STEP RECORD:
     ...
     The add Modelo 303 compensation-chain registry and calculation tests and ## Scope

- `src/aeat/domain/calculations/registry/test_modelo_303_registry.py` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# add Modelo 303 compensation-chain registry and calculation tests
...
- Reconciled the historical checked `P02.S02` row to a per-step exec record.
