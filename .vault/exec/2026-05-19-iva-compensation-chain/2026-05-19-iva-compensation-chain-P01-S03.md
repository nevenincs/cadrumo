...
<!-- STEP RECORD:
     ...
     The revise Modelo 390 annual compensation reconciliation casillas and bindings and ## Scope

- `src/aeat/_data/registry/aeat/modelos/390.toml` placeholders below are machine-filled
