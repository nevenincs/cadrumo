...
<!-- STEP RECORD:
     ...
     The revise Modelo 303 compensation casillas, formulas, relation, construct references and ## Scope

- `src/aeat/_data/registry/aeat/modelos/303.toml` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# revise Modelo 303 compensation casillas, formulas, relation, construct references
...
- Reconciled the historical checked `P01.S02` row to a per-step exec record.
