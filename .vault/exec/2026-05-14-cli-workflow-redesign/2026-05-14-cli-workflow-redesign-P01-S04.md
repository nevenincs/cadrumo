...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-05-14-cli-workflow-redesign-modelo-145-reopen-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add local corpus copy and catalogue authority for the Modelo 145 record design and ## Scope

- `corpus/aeat_official registry/aeat/legal` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# Add local corpus copy and catalogue authority for the Modelo 145 record design
...
- Reconcile the missing per-step exec record for checked row `P01.S04`.
...
- Confirm the aggregate record covers the Modelo 145 record-design corpus, manifest, and source-catalogue authority work for the P01 source/legal catalogue phase.

## Outcome

- No new source work was performed in this reconciliation pass.
- `P01.S04` now has a dedicated per-step exec record, satisfying the plan-closure record-shape requirement while preserving the original aggregate evidence.
