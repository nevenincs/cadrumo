...
modified: '2026-08-10'
body_schema: 'body-v1'
body_hash: 'sha256:a85c0f07f5ec0d0722a890bc9a3fd7620111165b5f94950fab8ec6edfcf753aa'
step_id: 'S310'
related:
...
<!-- FRONTMATTER RULES:
     ...
     The S310 and 2026-08-07-unstructured-document-ingestion-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Route the ledger evidence batch streamed progress line through the shared CLI redaction funnel, so text mode cannot emit a document name the same command's envelope arms redact and ## Scope
