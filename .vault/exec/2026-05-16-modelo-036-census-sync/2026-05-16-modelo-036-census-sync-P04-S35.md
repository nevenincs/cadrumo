...
# add CensusSyncError base plus CensusNotAvailableError CensusFieldValidationError CensusApplyConflictError

## Scope

- `src/aeat/application/profile/_census_errors.py`
