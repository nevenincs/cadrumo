...
<!-- FRONTMATTER RULES:
     ...
     The S77 and 2026-07-12-cadrumo-product-rename-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Prove no `aeat` import root, second human CLI alias, dual environment reader, namespace fallback, or state migration remains and ## Scope

- `compatibility absence gate` placeholders below are machine-filled
