...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-07-12-cadrumo-product-rename-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rename product-owned settings and CADRUMO environment parsing while retaining authority settings and ## Scope
...
- `.github/workflows`
- `justfile`
- `conftest.py` placeholders below are machine-filled
