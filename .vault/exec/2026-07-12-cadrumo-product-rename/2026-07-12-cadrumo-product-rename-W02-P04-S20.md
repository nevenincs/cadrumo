...
<!-- FRONTMATTER RULES:
     ...
     The S20 and 2026-07-12-cadrumo-product-rename-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rename product authentication-session storage without reading or moving former state and ## Scope
...
- `src/cadrumo/adapters/outbound/aeat/auth/tests/test_session_store_roundtrip.py` placeholders below are machine-filled
