...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-12-cadrumo-product-rename-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Move package-local tests and direct imports without shadow modules and ## Scope

- `src/aeat tests to src/cadrumo tests` placeholders below are machine-filled
