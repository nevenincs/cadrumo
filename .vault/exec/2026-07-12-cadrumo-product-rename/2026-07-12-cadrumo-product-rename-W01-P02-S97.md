...
- The ADR stamp already matches the current date, so no metadata rewrite is required.
- The staged marketplace README and dirty S58 record remain foreign and excluded.
