...
<!-- FRONTMATTER RULES:
     ...
     The S30 and 2026-07-12-cadrumo-product-rename-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Retarget manuals build mapping and plugin name to cadrumo_data and ## Scope

- `packaging/cadrumo_data_manuals/hatch_build.py` placeholders below are machine-filled
