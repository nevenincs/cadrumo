...
<!-- FRONTMATTER RULES:
     ...
     The S25 and 2026-06-15-bindings-interface-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The replace the --binding numeric-vs-enum try-Decimal-except heuristic with a registry-data-type-driven coercion that rejects a malformed amount instead of reclassifying it as an enum and ## Scope

- `src/aeat/application/modelo/_calculate_input.py`
- `src/aeat/entrypoints/cli/_modelo_cli_support.py` placeholders below are machine-filled
