...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-06-15-bindings-interface-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add a taxonomy parity gate asserting the canonical source-kind enum equals the registry binding source set and ## Scope

- `src/aeat/domain/calculations/registry/tests/test_binding_source_taxonomy.py` placeholders below are machine-filled
