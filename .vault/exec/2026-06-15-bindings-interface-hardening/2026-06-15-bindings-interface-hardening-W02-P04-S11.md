...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-06-15-bindings-interface-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The run every family validator from the single dispatch table inside the registry-build section validator so all families are checked at snapshot build and ## Scope
