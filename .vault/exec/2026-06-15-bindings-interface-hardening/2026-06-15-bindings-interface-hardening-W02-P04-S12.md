...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-06-15-bindings-interface-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add build-time rejection tests per family plus an anti-tautology proof asserting a malformed binding fails at build for each family, not only at resolve and ## Scope

- `src/aeat/domain/calculations/registry/tests/test_binding_build_validation.py` placeholders below are machine-filled
