...
- `2026-07-02-agent-harness-operability-followup-research` - `agent-harness-operability-followup` research: `operability and grounding completion (deferred from refoundation close)`
