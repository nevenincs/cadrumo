...
Auto-generated index of all documents tagged with `#open-work-consolidation`.

## Documents

### adr

- `2026-07-30-open-work-consolidation-adr` - `open-work-consolidation` adr: `residual open work consolidates into one operator-gated non-coding plan` | (**status:** `accepted`)
...
- `2026-07-30-open-work-consolidation-plan` - `open-work-consolidation` plan
