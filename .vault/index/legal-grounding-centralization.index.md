...
related:
  ...
  - '[[2026-06-14-legal-grounding-centralization-P01-S03]]'
  - '[[2026-06-14-legal-grounding-centralization-P02-S04]]'
  - '[[2026-06-14-legal-grounding-centralization-P03-S05]]'
  - '[[2026-06-14-legal-grounding-centralization-P03-S06]]'
  - '[[2026-06-14-legal-grounding-centralization-P03-S07]]'
...
# `legal-grounding-centralization` feature index

Auto-generated index of all documents tagged with `#legal-grounding-centralization`.

## Documents

### adr

- `2026-06-14-legal-grounding-centralization-adr` - `legal-grounding-centralization` adr: `Cross-Domain Regulatory-Value Centralization — Remediation Decisions` | (**status:** `accepted`)

### audit

- `2026-06-14-legal-grounding-centralization-audit` - `legal-grounding-centralization` audit: `Inline-and-Hardcoded Regulatory Definition Inventory — Cross-Domain Centralization Sweep`
...
- `2026-06-14-legal-grounding-centralization-plan` - `legal-grounding-centralization` plan

### research

- `2026-06-14-legal-grounding-centralization-research` - `legal-grounding-centralization` research: investigation backing the decision
