...
# `llm-invoice-read-reconciliation` feature index
...
- `2026-08-06-llm-invoice-read-reconciliation-research` - `llm-invoice-read-reconciliation` research: `What the evidence-read path does and does not know about the invoice model`
