...
- `2026-08-10-aeat-export-fragment-generator-authority-adr` - `aeat-export-fragment-generator-authority` adr: `official-binary coordinates and explicit semantic maps generate export fragments` | (**status:** `accepted`)
