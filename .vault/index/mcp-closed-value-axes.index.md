...
# `mcp-closed-value-axes` feature index

Auto-generated index of all documents tagged with `#mcp-closed-value-axes`.

## Documents

### adr

- `2026-08-09-mcp-closed-value-axes-adr` - `mcp-closed-value-axes` adr: `Closed-value CLI axes declare their enum; typed refusals remain programmatic backstops` | (**status:** `accepted`)
- `2026-08-09-mcp-closed-value-axes-iva-rate-unit-split-adr` - `mcp-closed-value-axes` adr: `The --iva-rate unit split stays, bounded on both sides` | (**status:** `accepted`)
