...
- `2026-06-10-cli-operator-surface-adr` - `cli-operator-surface` adr: `operator surface verb, lifecycle, and honesty decisions` | (**status:** `proposed` -- operator approval pending)
