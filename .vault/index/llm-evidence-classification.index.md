...
- `2026-06-10-llm-evidence-classification-adr` - `llm-evidence-classification` adr: `Evidence-aware LLM ledger classification (Stage-3): lean on the LLM multimodal read; splitting in scope` | (**status:** `accepted`)
