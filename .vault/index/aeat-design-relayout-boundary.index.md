...
- `2026-08-08-aeat-design-relayout-boundary-modelo-200-partition-adr` - `aeat-design-relayout-boundary` adr: `Modelo 200 partitions by 2024 design authority and reviewed semantic crosswalk` | (**status:** `accepted`)
...
- `2026-09-02-aeat-design-relayout-boundary-research` - `modelo-200-semantic-crosswalk` research: `authority-safe reuse across the 2024 relayout`
