...
Auto-generated index of all documents tagged with `#n26-data-source`.
...
- `2026-04-14-n26-data-source-research` - `n26-data-source` research: transaction ingest paths for the autónomo's primary bank
