...
# `filing-architecture-docs` feature index

Auto-generated index of all documents tagged with `#filing-architecture-docs`.

## Documents

### adr

- `2026-06-08-filing-architecture-docs-adr` - `filing-architecture-docs` adr: `Filing documentation taxonomy: generalized identity, lifecycle coverage` | (**status:** `accepted`)
...
- `2026-06-08-filing-architecture-docs-research` - `filing-architecture-docs` research: investigation backing the decision
