...
- `2026-07-21-aeat-user-docs-hardening-adr` - `aeat-user-docs-hardening` adr: `persona-verified imperative how-to hardening (retroactive record)` | (**status:** `accepted`)

### audit

- `2026-06-18-aeat-user-docs-hardening-audit` - `aeat-user-docs-hardening` audit: `Naive-user persona documentation and functionality review`
