...
# `silent-zero-regression-screen` feature index
...
- `2026-08-07-silent-zero-regression-screen-research` - `silent-zero-regression-screen` research: `detecting a binding whose resolved value silently regresses to zero`
