...
# `calendar-filing-semantics` feature index

Auto-generated index of all documents tagged with `#calendar-filing-semantics`.

## Documents

### adr

- `2026-06-05-calendar-filing-semantics-adr` - `calendar-filing-semantics` adr: `calendar separates local filing state from AEAT evidence state` | (**status:** `accepted`)

### audit

- `2026-06-05-calendar-filing-semantics-code-review-audit` - `calendar-filing-semantics` Code Review
...
- `2026-06-05-calendar-filing-semantics-plan` - `calendar-filing-semantics` `implementation` plan

### reference

- `2026-06-05-calendar-filing-semantics-reference` - `calendar-filing-semantics` reference: `local readiness versus AEAT submission`
