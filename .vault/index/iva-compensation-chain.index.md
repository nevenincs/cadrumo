...
Auto-generated index of all documents tagged with `#iva-compensation-chain`.
...
- `2026-05-19-iva-compensation-chain-plan` - `iva-compensation-chain` `remediation` plan

### research

- `2026-05-19-iva-compensation-chain-audit-research` - `iva-compensation-chain` research: Modelo 303/390 IVA compensation-chain grounding audit
