...
modified: '2026-09-03'
body_schema: 'body-v2'
body_hash: 'sha256:d73319fa1c78ef2141c73666313425196ec7a39a552421c36753a095d1129c9c'
related: []
---

<!-- FRONTMATTER RULES:
     tags: one directory tag (hardcoded #research) and one feature tag.
     Replace observability-replay-retirement with a kebab-case feature tag, e.g. #foo-bar.
...
# `observability-replay-retirement` research: `{topic}`

<!-- Lead: the question, why it matters to `observability-replay-retirement`, and what was
