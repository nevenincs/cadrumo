...
modified: '2026-08-06'
body_schema: 'body-v1'
body_hash: 'sha256:acec73a1a41197bc9a450f17a16117aedfa08bdcb4ec78dfd2b9fd652fe1f8b1'
related: []
---

<!-- FRONTMATTER RULES:
     tags: one directory tag (hardcoded #research) and one feature tag.
     Replace llm-invoice-read-reconciliation with a kebab-case feature tag, e.g. #foo-bar.
...
<!-- Lead: the question, why it matters to `llm-invoice-read-reconciliation`, and what was
