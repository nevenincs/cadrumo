...
modified: '2026-08-23'
body_schema: 'body-v1'
body_hash: 'sha256:d7f6e98b9cc44b4773429b9ae5c9b239afb58054df371448799891f05b84734a'
related:
...
<!-- FRONTMATTER RULES:
     ...
     Replace website-repository-boundary with a kebab-case feature tag, e.g. #foo-bar.
...
# `website-repository-boundary` research: `{topic}`

<!-- Lead: the question, why it matters to `website-repository-boundary`, and what was
