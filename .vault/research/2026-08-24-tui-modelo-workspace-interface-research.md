...
modified: '2026-08-24'
body_schema: 'body-v1'
body_hash: 'sha256:40763173fa2accca46dc799e39cc08045c53d6d9eb506b886016881a1ad43ed9'
related:
...
<!-- FRONTMATTER RULES:
     ...
     Replace tui-modelo-workspace-interface with a kebab-case feature tag, e.g. #foo-bar.
...
<!-- Lead: the question, why it matters to `tui-modelo-workspace-interface`, and what was
