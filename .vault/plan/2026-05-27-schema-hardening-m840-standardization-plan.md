...
- [ ] `P01.S02` - Mechanically split M840 into `manifest.toml` and `revisions/2003-y-siguientes` fragments using the existing generic loader layout; `src/aeat/_data/registry/aeat/modelos/840`.
- [ ] `P01.S03` - Verify M840 directory loading, registry validity, parser fixture behavior, and TOML reviewability gates; `src/aeat/domain/calculations/registry tests`.
- [ ] `P01.S04` - Record review outcome, standardization baseline, and the final remaining single-file normalization edge; `.vault/exec`.
