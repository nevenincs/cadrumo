...
modified: '2026-09-10'
body_schema: body-v2
body_hash: 'sha256:74ea31b371642676b99da51daad9ffb1a72ca351bae474af29192d87681abd46'
---
...
- [ ] `W01.P01.S02` - Implement adapters for record-design, manual, e-invoice, registry, and declared disposition records; `src/cadrumo/domain/calculations/registry/artifact_catalogue.py`.
...
- [ ] `W02.P03.S07` - Bind catalogue verification to the artifact identity join while retaining registry semantic validation; `src/cadrumo/domain/calculations/registry/corpus_catalogue.py`.
- [ ] `W02.P03.S08` - Replace three-way origin admission with catalog diagnostics for unknown and conflicting files; `src/cadrumo/domain/calculations/registry/tests/test_corpus_provenance_coverage.py`.
...
- [ ] `W02.P04.S10` - Route manifest loading, payload classification, and acquisition diagnostics through the catalog; `dev/corpus/sync_aeat_record_design_corpus.py`.
