...
- [ ] `P01.S02` - Mechanically split M360 into `manifest.toml` and `revisions/2010-y-siguientes` fragments using the existing generic loader layout; `src/aeat/_data/registry/aeat/modelos/360`.
