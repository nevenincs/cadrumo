...
- [ ] `W02.P04.S21` - Rename product logical storage namespaces without touching authority field names; `src/cadrumo persistence namespace registry/repository and cohesive consumers/tests/examples`.
