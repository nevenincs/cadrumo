...
- [x] `W03.P05.S11` - Enforce legal resolution, target-window coverage, anchor reachability, and rejection of later-year substitution; `dev/registry/tests/test_m200_2024_full_reconciliation.py`.
