...
date: '2026-08-07'
modified: '2026-08-13'
body_hash: 'sha256:40416c04e0b82008b9f5e59bcc6e7296686d376f8c00ae0e7e808244049f2f99'
tier: L2
related:
...
- [ ] `P09.S33` - Establish empirically whether pdfplumber's text layer for these sancion PDFs emits the UNE 82100 NBSP or narrow-NBSP thousands separator, and if it does, admit them in the anchored house pattern. Driven against the real function today: _parse_money refuses 1<NBSP>234,56 and 1<narrow-NBSP>234,56 while accepting 3.687,12, so the current failure direction is a refusal and not a misread. Verified by a regression pinning the accepted and refused separator forms with a mutation proof; `src/cadrumo/adapters/inbound/notificacion/tests/test_sancion_parse.py`.
