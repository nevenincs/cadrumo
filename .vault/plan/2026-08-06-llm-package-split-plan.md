...
date: '2026-08-06'
modified: '2026-08-06'
body_hash: 'sha256:d435315f10bd94af75b8967b759ebf2c9925c4bddeac5b6c0cd1935939eebfc3'
tier: L3
related:
...
## Wave `W01` - Establish the boundary before moving behaviour

Declare the llm extra with its real runtime dependencies, close the undeclared-Pillow defect, add the missing hardware-capability axis, and prove the secure-storage gates already cover the destination directory.
...
## Wave `W02` - Divide the mixed module and relocate pure inference

Move the purely-inferential members under the new subpackage and split the one module that mixes inference with core writes, leaving persistence-touching stores on the core side.
