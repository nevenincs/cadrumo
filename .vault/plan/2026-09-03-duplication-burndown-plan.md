...
modified: '2026-09-05'
body_schema: body-v2
body_hash: 'sha256:8bd8f25b55d849a446e3c10c5348dc545a243684db389466d01afb0728ca60bf'
---
...
- [x] `W02.P10.S12` - Resolve the Modelo export and review package clone without coupling distinct workflows; `src/cadrumo/entrypoints/cli`.
...
- [x] `W03.P11.S14` - Adjudicate and resolve the GROI and NIF IVA check pair without merging distinct AEAT protocol authority; `src/cadrumo/adapters/outbound/aeat/sede`.
...
- [ ] `W04.P18.S20` - Adjudicate the 35 identical-expression constant collisions the extended screen surfaces, merging each to a canonical home or recording why an existing decision keeps it local; `dev/quality/constant_value_agreement.py`.
