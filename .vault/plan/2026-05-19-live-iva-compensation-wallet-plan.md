...
- [ ] `W09.P22.S79` - Run final code review before treating live IVA grounding as production-ready. This row cannot close until S56 and S77 include a fresh operator-observed live read-only verification, or the review explicitly declares the feature provisional/not production-ready. Partial 2026-05-27: focused review of stored remote IVA reload and ledger regression fixes found and closed two HIGH issues: rule-apply failures now surface instead of being counted as no-match, and wallet secure-storage tests no longer use valid-looking taxpayer identifiers. Follow-up 2026-06-02: the persistent-failure team brief records the accepted failure split, leading wallet/cartera hypotheses, code surfaces, and acceptance criteria in `[[2026-06-02-live-iva-persistent-failure-team-brief]]`; `.vault/audit`.
