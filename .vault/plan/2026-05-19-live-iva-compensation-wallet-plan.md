...
- [ ] `W09.P22.S77` - Run focused live-auth, Sede read-only, secure-storage, Modelo 303 and 390, Modelo 130 relation, and constants-guard test gates. Follow-up 2026-06-03: focused ruff and pytest gates passed for live acquisition, wallet parser, external constants, and config surfaces. Read-only live 2026 capture succeeded with wallet success. Read-only live 2022-2026 capture succeeded with 12 Modelo 303 calculation observations and wallet success. Profile-local reload succeeded with wallet authority decision present. Remaining gates stay open for broader Modelo 390, Modelo 130, and final readiness coverage.; `tests src/aeat/application/live src/aeat/adapters/outbound/aeat/sede src/aeat/core`.
