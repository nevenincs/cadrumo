...
date: '2026-08-10'
modified: '2026-08-11'
body_hash: 'sha256:397eafaeee14536f6cfcfc1e3e854367356f00c62cc17f1e6dcda3f3445a2279'
tier: L3
related:
...
- [ ] `W04.P07.S58` - Make complete typed M303 filing-instance evidence part of encrypted immutable `CalculationRevision` creation and identity/digest: quickfile and standard creation collect it before calculation persistence, edits create a new revision, verification freezes it, and every BORRADOR author-or-replace writer, mutation command, export override, tolerant reader, and legacy surface is deleted; `src/cadrumo/domain/modelos/; src/cadrumo/application/modelo/; src/cadrumo/entrypoints/cli/; src/cadrumo/adapters/persistence/profile/`.
- [ ] `W04.P07.S59` - Establish the single annual Orden registry authority for simplified-regime activity/module rows with exact legal and official-source references, compile it into typed revision snapshots, and delete test-only rows, arbitrary producer or marker references, parallel selectors, and runtime inference; `src/cadrumo/domain/calculations/registry/; src/cadrumo/domain/iva/; src/cadrumo/application/filing/; src/cadrumo/_data/registry/`.
- [ ] `W04.P07.S55` - Close every Modelo 303 DP30301 scalar owner from A16 through A30 through explicit typed profile, filing, observation, prorrata, insolvency, applicability, and derived-volume authorities, wire admitted scalar facts through the immutable FilingProducerSnapshot and closed FilingProducerKey, and delete every default, raw key, placeholder, duplicate producer, and fallback representation; `src/cadrumo/core/; src/cadrumo/domain/deadlines/; src/cadrumo/domain/prorrata_register/; src/cadrumo/application/filing/; src/cadrumo/application/modelo/; src/cadrumo/application/calculations/`.
- [ ] `W04.P07.S56` - Add one typed ordered evidence-bearing Modelo 303 exonerado-390 activity-row owner for all six activity-code and IAE pairs, thread it through value arrival and projection, and delete raw marker, producer-reference, scalar-slot, and placeholder authority; `src/cadrumo/application/filing/; src/cadrumo/domain/calculations/registry/`.
- [ ] `W04.P07.S57` - Integrate the strict core-owned discriminated FilingProjectionRef union atomically through CasillaFieldKind.PROJECTION, projection_ref payload semantics, semantic-map and registry schemas and loaders, provenance, generator, renderer dispatch, and the S47-S50 projectors, deleting description-regex, section, slot, offset, numeric, neighbouring-field, string-key, and legacy inference; `src/cadrumo/core/; src/cadrumo/domain/calculations/registry/; src/cadrumo/application/filing/; dev/registry/`.
