...
- [x] `P02.S09` - Register route R11 for the 19 specimen-less profiles as evidence gaps rather than passes, naming what each would need to become decidable; `.vault/audit`.
