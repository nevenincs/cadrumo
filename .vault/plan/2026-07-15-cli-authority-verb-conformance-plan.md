...
- [ ] `W02.P04.S24` - Add byte-exact pointer capture, atomic restore, idempotent clear with restrictive temporary permissions and fsync, complete short writes in the hardened byte writer, and expose the core pointer API; `src/cadrumo/core/_bucket_pointer_io.py, src/cadrumo/core/atomic_write.py, src/cadrumo/core/__init__.py`.
