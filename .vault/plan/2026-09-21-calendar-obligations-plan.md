...
modified: '2026-09-21'
body_schema: body-v2
body_hash: 'sha256:7b33f108b4ed4d867080804a6b9939811965152c25341b58818653dd6e4840c2'
---
...
- [x] `P02.S06` - Project the existing conditional surcharge guidance without assessing liability or conflating sanction amounts; `src/cadrumo/application/modelo/declarations_calendar.py, src/cadrumo/application/modelo/work_plazo.py and owning tests`.
