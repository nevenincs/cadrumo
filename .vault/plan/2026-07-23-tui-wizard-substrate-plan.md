...
date: '2026-07-23'
modified: '2026-07-25'
body_hash: 'sha256:ea38fd148406cb9e8aa91b85c6770d34a027d9eb8c80c09018a5f7db29a9b3bc'
tier: L3
related:
...
- [x] `W03.P09.S27` - Land the parity regression proving the scripted, line-mode, and full-screen paths produce identical answers and validation verdicts for a shared definition; `src/cadrumo/application/flows/tests/test_frontend_parity.py`.
...
- [x] `W03.P09.S29` - Run the docs build and documented-command conformance gates green, with owner triage recorded for any unrelated peer failures; `docs/`.
- [x] `W03.P09.S30` - Run the full src collect-only and suite gates with owner-distinguished triage of the results; `src/cadrumo/`.
