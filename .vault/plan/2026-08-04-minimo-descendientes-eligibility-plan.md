...
date: '2026-08-04'
modified: '2026-08-05'
body_hash: 'sha256:29abf130260ec7d9abd8505a78cbb107ef5fbda56d31c10b219c6d7b67cd23ab'
tier: L2
related:
...
- [ ] `P04.S40` - Prorate the Art. 81.2 guarderia increment by each child qualifying months and bound it per child rather than in aggregate, because the formula applies a flat 1000 per child with no month term while the manual states the increment se calculara proporcionalmente al numero de meses and works it as 1000 divided by 12 times 2 equals 166.67, so a child with two qualifying months is granted 1000 against a correct 166.67, an over-grant of 833.33 euros reachable through the documented entry surface for every mid-year birth and every partial-year enrolment; `src/cadrumo/_data/registry/aeat/modelos/100/revisions/2024/formulas/, src/cadrumo/domain/calculations/registry/`.
