...
date: '2026-08-04'
modified: '2026-08-05'
body_hash: 'sha256:ab1e070e2d916063babe69cc95af217c3ad0e4f9e4b76717d1d2a3a132cce8d9'
tier: L2
related:
...
- [ ] `P04.S40` - Prorate the Art. 81.2 guarderia increment per child as 1000 divided by 12 times the qualifying months bounded by that child own non-subsidised spend, using the minimum of the two month counts as the best available proxy for the simultaneity the model cannot yet express, and disclose that approximation every time the increment is granted from a count rather than presenting it as exact, and refuse to prorate for a child declaring only an annual total the way the turning-three period already refuses that shape rather than assuming twelve months; `src/cadrumo/_data/registry/aeat/modelos/100/revisions/2024/formulas/, src/cadrumo/domain/contribuyente/family.py, src/cadrumo/application/modelo/_profile_binding.py, src/cadrumo/application/modelo/_calculate_input.py`.
