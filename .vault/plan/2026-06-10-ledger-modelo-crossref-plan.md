...
- [ ] `P02.S07` - Add upsert_transaction_participation helper: merge a new TransactionRevisionParticipation into the per-transaction entry in a TransactionRevisionParticipationIndex; `return updated index; no mutation of existing entries; `src/aeat/domain/modelos/_participation_index.py`.
