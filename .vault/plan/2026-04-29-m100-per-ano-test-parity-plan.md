...
Add year-scoped parity tests for the six existing non-B1 M100 anexo test modules.

## Proposed Changes

- Add B2, C, D, EF, G, and N test modules for 2024 and 2026.
...
Focused pytest target: 126 new parity tests passed. Computed-casilla audit found no missing 2024 or 2026 non-B1 computed casillas in the new files. Final verification should run `just lint`, `just typecheck`, `just test`, `just hooks`, and `just test-cov`.
