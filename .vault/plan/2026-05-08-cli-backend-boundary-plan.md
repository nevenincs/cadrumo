...
| Task | Status | Tracks | Work |
|---|---|---|---|
| W3-T1 | deferred-for-backend-gap | CLI-003, API-003 | Add invoice import workflow for JSON/CSV parsing, defaults, line synthesis, duplicate handling, and import summaries. |
