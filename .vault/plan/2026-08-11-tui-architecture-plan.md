...
modified: '2026-08-25'
body_hash: 'sha256:b274589be7b1920e9eab6eb2fa994cd1ba346cb5401eeb3fead1f82e9e7f99d2'
---
...
- [ ] `W03.P20.S159` - Expose the validated-registry atomic Workspace port with an owner-local monotonic ABA-safe epoch and S126 capture contract, directly at its canonical owner without a shim, re-export, or private grammar; `src/cadrumo/domain/calculations/registry/_authority.py`.
...
- [ ] `W03.P20.S161` - Expose the canonical bounded ModeloWorkReview atomic Workspace port with an owner-local monotonic ABA-safe epoch and S126 capture contract, directly at its canonical owner without a shim, re-export, or private grammar; `src/cadrumo/application/modelo/_work_review_projection.py`.
