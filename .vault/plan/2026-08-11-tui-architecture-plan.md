...
date: '2026-08-11'
modified: '2026-08-25'
body_hash: 'sha256:c8df960bc8b3c4a3532c46d0be7f0eb4ad2406e4d77097fac47de785bf4cda1d'
tier: L3
related:
...
- [ ] `W03.P20.S169` - Read each bare and enveloped profile singleton document and persistence revision from one SecureObjectRecord, expose the atomic WorkUnitCatalogue-plus-revision observation through the domain port and concrete adapter, and prove present/absent interleavings, real encrypted-SQL concurrency, and revision lineage without a compatibility path; `src/cadrumo/adapters/persistence/profile/_secure_enveloped_document.py, src/cadrumo/adapters/persistence/profile/_secure_model_document.py, src/cadrumo/adapters/persistence/profile/modelos_work_units.py, src/cadrumo/domain/modelos/_protocols.py, and focused real persistence tests`.
