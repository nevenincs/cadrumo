...
- [x] `P04.S27` - Audit M123 revision file for directory-mode fragmentation need; `src/aeat/_data/registry/aeat/modelos/123`.
...
- [x] `P05.S29` - Split M303 casilla and export fragments if P01 audit confirms safe boundaries; `src/aeat/_data/registry/aeat/modelos/303`.
- [x] `P05.S30` - Re-run corpus fragment headroom audit after residual pressure splits; `.vault/audit`.
