...
modified: '2026-09-10'
body_schema: body-v2
body_hash: 'sha256:bb5d6c8b26d913dce80fe69316cf0f4476e77d22d3722bb1cbf5af92e3f7cd5e'
---
...
- [ ] `W05.P15.S78` - After the schema opens, land its four blocked uses, each gated: requirement_statement carrying a qualified requirement wording (10 fields: 'Obligatorio PI' x6 in 303, 'OBLIGATORIO (persona fisica)' x4 in 390); a signed integer amount in schema and codec (modelo 714's 60 fields); a mandated value domain on a signed field (390/2025's 80 'rellenas a 0' amounts, retiring its type_column_contradiction row); and a part identity for a design cell whose own text declares sub-offsets (modelo 347's provincia/pais cell, which with the authored repeat lets both 347 trees republish and corrects the 2011 blank-region NIF binding); `src/cadrumo/domain/calculations/registry/schema_exports.py`.
