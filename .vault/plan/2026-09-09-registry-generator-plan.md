...
modified: '2026-09-10'
body_schema: body-v2
body_hash: 'sha256:80ec7387311933c9a484ecdee5b78c64c39a0fc182f6427a6e9e5fd921adeb94'
---
...
- [ ] `W05.P15.S59` - Carry modelo 390's 'OBLIGATORIO (persona fisica)' (4 cells, the sujeto pasivo nombre) as a requirement that holds only for a natural-person taxpayer. A stored wording cannot enforce it and a boolean guesses; the export must evaluate the condition against the filing's own taxpayer and refuse a blank nombre for a persona fisica. Needs a decision on where the taxpayer's legal form is authoritative at export time; `src/cadrumo/domain/calculations/registry/`.; `src/cadrumo/domain/calculations/registry/`.
