...
modified: '2026-09-10'
body_schema: body-v2
body_hash: 'sha256:bdc59479ef60377e5a0f5f57e7ae5f1cae53fb99565ba838f14d0699692b61bf'
---
...
- [ ] `W05.P15.S78` - Land the blocked uses of the opened schema. DONE: sign_position (920e6e68d8) and its two-way gate (bd68791bb3); 714's N-typed percentages ruled unsignable by value (f52f65c200); a mandated value domain on signed money (2028acbda7) adopted by 390/2025's 80 zero-mandated slots, which now agree with the type column (ef97b8dae6); the qualified requirement as required_for (beabae2335) adopted by 390's sujeto pasivo nombre, and 303's 'Obligatorio PI' read as unconditional (ef97b8dae6). OPEN: a part identity for modelo 347's provincia/pais cell, which lets both 347 trees republish and corrects the 2011 blank-region NIF binding; `src/cadrumo/domain/calculations/registry/schema_exports.py`.; `src/cadrumo/domain/calculations/registry/schema_exports.py`.
