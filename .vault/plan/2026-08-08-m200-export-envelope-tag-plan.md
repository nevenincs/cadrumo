...
- [ ] `P01.S01` - write a byte-level test asserting the M200 open-tag composite against current output, confirmed red; `src/cadrumo/application/filing/tests/test_export.py`.
- [ ] `P01.S02` - replace the offset-1 filing_year draft field with the six-component open-tag composite; `src/cadrumo/_data/registry/aeat/modelos/200/revisions/2024-y-siguientes/export/0001-modelo-200-page-000.toml`.
