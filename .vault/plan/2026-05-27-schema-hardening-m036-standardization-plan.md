...
- [ ] `P01.S02` - Mechanically split M036 into `manifest.toml` and `revisions/2025-02-03-y-siguientes` fragments using the existing generic loader layout; `src/aeat/_data/registry/aeat/modelos/036`.
- [ ] `P01.S03` - Verify M036 directory loading, census foundation behavior, event-period query behavior, extraction profile parsing, and TOML reviewability gates; `src/aeat/domain/calculations/registry tests`.
