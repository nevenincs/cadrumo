...
- [ ] `W09.P41.S304` - fix pre-existing circular import surfaced during W12.P62 dedup; src/aeat/domain/calculations/registry/_applicability.py imports from deadlines._engine which creates a cycle; one test_cross_domain_snapshot_registration test fails; unrelated to validate-helper consolidation but needs follow-up; `src/aeat/domain/calculations/registry/_applicability.py`.
