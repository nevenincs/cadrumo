...
- [ ] `W09.P41.S397` - M210 Phase 2 engine landing - full diseno-de-registro (~80 casillas across 12 tipo-de-renta variants), full Convenios Espana rate roster (~92 countries), agrupacion-anual per Orden HAC/56/2024, and any still-unauthored income variants beyond the current registry baseline (which already includes Art 25.1.b pension tariff, Art 25.1.f interest/ganancia rows, and Art 13.1.h imputed-real-estate base primitives); `tracked in the m210-irnr-phase-2-engine L3 sub-plan; concurrent ADRs may be required per substantial-new-modelo work; `.vault/plan/2026-05-27-m210-irnr-phase-2-engine-plan.md`.
