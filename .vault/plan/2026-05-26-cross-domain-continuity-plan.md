...
- [x] `W09.P41.S397` - M210 Phase 2 engine tracking pointer - decided by the 2026-07-09-m210-irnr-phase-2-engine ADR, with executable slices tracked in the m210-irnr-phase-2-engine sub-plan (close when the sub-plan W01.P01 and W01.P02 phases close); `.vault/plan/2026-05-27-m210-irnr-phase-2-engine-plan.md`.
