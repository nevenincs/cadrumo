...
- [ ] `W09.P41.S372` - add typed --row flag mechanism to work calculate for miembro M184 vinculada M232 operador M349 row types; `share ModelRowCollection base; wire rows to observation resolvers; locale keys es/en/ca/hu; oracle-grounded tests per modelo; `src/aeat/entrypoints/cli/_modelo.py`.
