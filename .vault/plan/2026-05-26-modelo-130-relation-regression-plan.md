...
- [ ] `P06.S22` - re-fetch RD 439/2007 from BOE via the corpus pipeline, identify the art. 110.5 carry-forward sentence in the consolidated text, and extend [legal."rd-439-2007:art-110"].required_text with the BOE-verbatim fragment; `src/aeat/_data/corpus/normatives/rd-439-2007.json and src/aeat/_data/registry/aeat/legal/irpf.toml`.
