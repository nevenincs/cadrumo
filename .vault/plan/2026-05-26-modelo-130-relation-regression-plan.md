...
- [ ] `P06.S30` - fix cross-campaign drift: full registry gate fails M100 2024 formula ownership and orphan-parameter checks for the 2024 minimo-contribuyente formulas and minimo family parameters; `align the formula ownership/snapshot workflow surface or remove the orphaned 2024 parameter declarations; `src/aeat/_data/registry/aeat/modelos/100/ and src/aeat/domain/calculations/registry/test_formula_modelo_registry_parity.py src/aeat/domain/calculations/registry/test_modelo_100_drift_detection.py`.
- [ ] `P06.S31` - fix cross-campaign drift: full registry gate fails Modelo 720 declaration-PDF extraction profile confidence, expecting `review_required` but registry data now resolves `strict`; `reconcile the extraction-profile confidence with fixture/specimen evidence and validator expectations; `src/aeat/_data/registry/aeat/modelos/720/ and src/aeat/domain/calculations/registry/test_modelo_720_registry.py`.
