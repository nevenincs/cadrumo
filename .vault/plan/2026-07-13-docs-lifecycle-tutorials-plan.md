...
- [ ] `P05.S18` - Retire the three stray project-management files from the docs root (ADRS.md, USERDOCS-KICKOFF-BRIEF.md, HARNESS-USERDOCS-KICKOFF-BRIEF.md) per docs-architecture ADR clause 3a; `docs/ADRS.md docs/USERDOCS-KICKOFF-BRIEF.md docs/HARNESS-USERDOCS-KICKOFF-BRIEF.md`.
