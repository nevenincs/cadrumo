...
- [ ] `P02.S11` - Migrate the M369 inline schemas to the fragmented layout in one atomic commit gated by the equality test plus the M369 filing-grade suites; `src/aeat/_data/registry/aeat/modelos/369`.
