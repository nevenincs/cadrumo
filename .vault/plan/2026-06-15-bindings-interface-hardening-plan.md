...
- [ ] `W06.P12.S33` - run a fresh-context honesty review and close audit per the campaign-close-honesty rule with full-tree owner triage, tracking every surfaced item as a new Step with a verification gate; `.vault/audit/2026-06-15-bindings-interface-hardening-close-audit.md`.
