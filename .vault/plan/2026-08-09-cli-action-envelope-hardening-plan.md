...
- [ ] `W05.P10.S92` - Remove the remaining embedded modelo work-list command prose from overview status rendering and derive any executable guidance from the shared resolved action projection; `src/cadrumo/entrypoints/cli/_overview_rendering.py; src/cadrumo/entrypoints/cli/tests`.
