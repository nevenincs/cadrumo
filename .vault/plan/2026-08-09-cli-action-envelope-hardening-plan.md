...
date: '2026-08-09'
modified: '2026-08-11'
body_hash: 'sha256:42b9bc6dd0d54e2e4e20cbd0ca83215d49a5b81f16b1bde98c4e3870b7931a27'
tier: L3
related:
...
- [ ] `W05.P10.S88` - Migrate residual root, live, and portal CLI boundary action producers, including root command-resolution and log-level failures, outside the root-guard and error-boundary owners; `src/cadrumo/entrypoints/cli/__init__.py; src/cadrumo/entrypoints/cli/_log_levels.py; src/cadrumo/entrypoints/cli/_app_diagnostics.py; src/cadrumo/entrypoints/cli/_app_diagnostics_telemetry.py; src/cadrumo/entrypoints/cli/_app_maintenance.py; src/cadrumo/entrypoints/cli/_tty.py; src/cadrumo/entrypoints/cli/_app_live.py; src/cadrumo/entrypoints/cli/_app_live_portals_cli.py`.
- [ ] `W05.P10.S89` - Migrate config CLI action producers and co-located renderers to resolved typed actions, including profile-inspect raw Notice and command drift; `src/cadrumo/entrypoints/cli/_config`.
...
- [ ] `W05.P10.S114` - Migrate residual shared CLI boundary recovery producers, including terminal-path projection and unification, outside completed root-guard and error-boundary Steps; `src/cadrumo/entrypoints/cli/_common.py; src/cadrumo/entrypoints/cli/_errors.py; src/cadrumo/entrypoints/cli/_terminal_errors.py`.
