...
date: '2026-08-09'
modified: '2026-08-11'
body_hash: 'sha256:a85e9efafcca873cb4926ea0c9bd7a2c619de396797d5bfdc82a21ee57f294a7'
tier: L3
related:
...
- [ ] `W05.P08.S56` - Retire recovery-authority comments from the first adapter registry shard and prove its 59 tuple taxonomy remains canonical, retaining historical recovery only in the S50 ledger where eight migration_required rows are exclusively owned by later producer steps; `src/cadrumo/core/errors/registry/_adapters_part1.py`.
