...
- [ ] `P01.S01` - Add continuity identifiers, evolution declarations, and opt-in flags; `src/aeat/domain/calculations/registry/_schema.py`.
...
- [ ] `P03.S07` - Produce a committed M100 continuity inventory with sampled continuous, evolved, repurposed, and retired buckets; `.vault/research`.
- [ ] `P03.S08` - Author the first minimal continuity metadata slice for an evidence-grounded M100 annual chain; `src/aeat/_data/registry/aeat/modelos/100`.
