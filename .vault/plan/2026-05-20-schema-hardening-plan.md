...
- [ ] `W06.P16.S113` - classify the remaining M200 `is_correccion_*` singleton family as missing sibling coverage, intentional singleton, or role-axis modelling debt before any further role normalization.
