...
related:
  ...
  - '[[2026-05-27-schema-hardening-m184-standardization-review]]'
---
...
- [ ] `P01.S02` - Mechanically split M193 into `manifest.toml` and `revisions/2024-y-siguientes` fragments using the existing generic loader layout; `src/aeat/_data/registry/aeat/modelos/193`.
- [ ] `P01.S03` - Verify M193 directory loading, registry integrity, annual-summary relation behavior, detail-record row behavior, and TOML reviewability gates; `src/aeat/domain/calculations/registry tests`.
