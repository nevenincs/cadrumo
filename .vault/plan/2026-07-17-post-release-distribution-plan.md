...
- [ ] `P03.S14` - Acquire root and companion distributions from PyPI and repeat installed CLI and MCP tax work (lifted from distribution W04.P10.S45) - TOOLING READY: dev/packaging/acquire_pypi.py landed ad6318eeb3 reviewed PASS with 26 offline tests, executes post-publication; `; `dev/packaging/acquire_pypi.py`.
- [ ] `P03.S15` - Acquire the exact GitHub release cohort and verify every retained digest (lifted from distribution W04.P10.S46) - TOOLING READY: dev/packaging/acquire_github_release.py (ad6318eeb3, reviewed PASS), executes post-publication; `; `dev/packaging/acquire_github_release.py`.
- [ ] `P03.S16` - Acquire Cadrumo through the public Scoop bucket and repeat installed behavior (lifted from distribution W04.P10.S47) - TOOLING READY: dev/packaging/acquire_scoop.ps1 windows-container flow (ad6318eeb3, reviewed PASS), executes post-publication; `; `dev/packaging/acquire_scoop.ps1`.
- [ ] `P03.S17` - Acquire Cadrumo through the public Homebrew tap and repeat installed behavior (lifted from distribution W04.P10.S48) - TOOLING READY: dev/packaging/acquire_homebrew.py (ad6318eeb3, reviewed PASS), executes post-publication; `; `dev/packaging/acquire_homebrew.py`.
- [ ] `P03.S18` - Acquire the public marketplace plugin through Claude and repeat the MCP tax-work call (lifted from distribution W04.P10.S49) - TOOLING READY: dev/packaging/acquire_claude_plugin.py (ad6318eeb3, reviewed PASS), executes post-publication; `; `dev/packaging/acquire_claude_plugin.py`.
- [ ] `P03.S19` - Acquire the published MCPB through each claimed client and repeat the MCP tax-work call (lifted from distribution W04.P10.S50) - TOOLING READY: dev/packaging/acquire_mcpb.py (ad6318eeb3, reviewed PASS), executes post-publication; `; `dev/packaging/acquire_mcpb.py`.
- [ ] `P03.S20` - Reacquire every public Claude artifact and verify its cadrumo- harness namespace and English and Spanish MCP product descriptions against the cohort manifest (lifted from distribution W04.P10.S70) - TOOLING READY: namespace and description capture built into acquire_claude_plugin.py and acquire_mcpb.py (ad6318eeb3, reviewed PASS), executes post-publication; ; `dev/packaging/acquire_claude_plugin.py, dev/packaging/acquire_mcpb.py`.
