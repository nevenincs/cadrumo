...
- [ ] `W01.P02.S42` - author the completeness manifest for Modelo 121 revision 2017-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 121 revision 2017-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/121/revisions/2017-y-siguientes/`.
- [ ] `W01.P02.S43` - author the completeness manifest for Modelo 122 revision 2017-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 122 revision 2017-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/122/revisions/2017-y-siguientes/`.
- [ ] `W01.P02.S44` - author the completeness manifest for Modelo 140 revision 2020-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 140 revision 2020-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/140/revisions/2020-y-siguientes/`.
- [ ] `W01.P02.S45` - author the completeness manifest for Modelo 143 revision 2014-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 143 revision 2014-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/143/revisions/2014-y-siguientes/`.
- [ ] `W01.P02.S46` - author the completeness manifest for Modelo 145 revision 2012-01-31-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 145 revision 2012-01-31-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/145/revisions/2012-01-31-y-siguientes/`.
- [ ] `W01.P02.S47` - author the completeness manifest for Modelo 270 revision 2013-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 270 revision 2013-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/270/revisions/2013-y-siguientes/`.
- [ ] `W01.P02.S48` - author the completeness manifest for Modelo 280 revision 2025 from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 280 revision 2025; `src/cadrumo/_data/registry/aeat/modelos/280/revisions/2025/`.
- [ ] `W01.P02.S49` - author the completeness manifest for Modelo 308 revision 2009-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 308 revision 2009-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/308/revisions/2009-y-siguientes/`.
- [ ] `W01.P02.S50` - author the completeness manifest for Modelo 341 revision 2000-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 341 revision 2000-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/341/revisions/2000-y-siguientes/`.
- [ ] `W01.P02.S51` - author the completeness manifest for Modelo 345 revision 2025 from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 345 revision 2025; `src/cadrumo/_data/registry/aeat/modelos/345/revisions/2025/`.
- [ ] `W01.P02.S52` - author the completeness manifest for Modelo 360 revision 2010-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 360 revision 2010-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/360/revisions/2010-y-siguientes/`.
- [ ] `W01.P02.S53` - author the completeness manifest for Modelo 361 revision 2010-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 361 revision 2010-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/361/revisions/2010-y-siguientes/`.
- [ ] `W01.P02.S54` - author the completeness manifest for Modelo 379 revision 2024-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 379 revision 2024-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/379/revisions/2024-y-siguientes/`.
- [ ] `W01.P02.S55` - author the completeness manifest for Modelo 380 revision 2005-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 380 revision 2005-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/380/revisions/2005-y-siguientes/`.
- [ ] `W01.P02.S56` - author the completeness manifest for Modelo 156 revision 2003-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 156 revision 2003-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/156/revisions/2003-y-siguientes/`.
- [ ] `W01.P02.S57` - author the completeness manifest for Modelo 165 revision 2013-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 165 revision 2013-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/165/revisions/2013-y-siguientes/`.
- [ ] `W01.P02.S58` - author the completeness manifest for Modelo 179 revision 2021-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 179 revision 2021-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/179/revisions/2021-y-siguientes/`.
- [ ] `W01.P02.S59` - author the completeness manifest for Modelo 181 revision 2009-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 181 revision 2009-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/181/revisions/2009-y-siguientes/`.
- [ ] `W01.P02.S60` - author the completeness manifest for Modelo 189 revision 2025 from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 189 revision 2025; `src/cadrumo/_data/registry/aeat/modelos/189/revisions/2025/`.
- [ ] `W01.P02.S61` - author the completeness manifest for Modelo 231 revision 2021-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 231 revision 2021-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/231/revisions/2021-y-siguientes/`.
- [ ] `W01.P02.S62` - author the completeness manifest for Modelo 233 revision 2018-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 233 revision 2018-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/233/revisions/2018-y-siguientes/`.
- [ ] `W01.P02.S63` - author the completeness manifest for Modelo 238 revision 2024-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 238 revision 2024-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/238/revisions/2024-y-siguientes/`.
- [ ] `W01.P02.S64` - author the completeness manifest for Modelo 289 revision 2025 from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 289 revision 2025; `src/cadrumo/_data/registry/aeat/modelos/289/revisions/2025/`.
- [ ] `W01.P02.S65` - author the completeness manifest for Modelo 347 revision 2008-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 347 revision 2008-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/347/revisions/2008-y-siguientes/`.
- [ ] `W01.P02.S66` - author the completeness manifest for Modelo 721 revision 2023-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 721 revision 2023-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/721/revisions/2023-y-siguientes/`.
- [ ] `W01.P02.S67` - author the completeness manifest for Modelo 848 revision 2003-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 848 revision 2003-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/848/revisions/2003-y-siguientes/`.
- [ ] `W01.P02.S68` - author the completeness manifest for Modelo 038 revision 2002-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 038 revision 2002-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/038/revisions/2002-y-siguientes/`.
- [ ] `W01.P02.S69` - author the completeness manifest for Modelo 185 revision 2025-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 185 revision 2025-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/185/revisions/2025-y-siguientes/`.
- [ ] `W01.P02.S70` - author the completeness manifest for Modelo 186 revision 2003-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 186 revision 2003-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/186/revisions/2003-y-siguientes/`.
- [ ] `W01.P02.S71` - author the completeness manifest for Modelo 220 revision 2024-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 220 revision 2024-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/220/revisions/2024-y-siguientes/`.
- [ ] `W01.P02.S72` - author the completeness manifest for Modelo 222 revision 2025-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 222 revision 2025-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/222/revisions/2025-y-siguientes/`.
- [ ] `W01.P02.S73` - author the completeness manifest for Modelo 234 revision 2021-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 234 revision 2021-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/234/revisions/2021-y-siguientes/`.
- [ ] `W01.P02.S74` - author the completeness manifest for Modelo 490 revision 2021-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 490 revision 2021-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/490/revisions/2021-y-siguientes/`.
- [ ] `W01.P02.S75` - author the completeness manifest for Modelo 576 revision 2007-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 576 revision 2007-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/576/revisions/2007-y-siguientes/`.
- [ ] `W01.P02.S76` - author the completeness manifest for Modelo 592 revision 2022-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 592 revision 2022-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/592/revisions/2022-y-siguientes/`.
- [ ] `W01.P02.S77` - author the completeness manifest for Modelo 604 revision 2021-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 604 revision 2021-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/604/revisions/2021-y-siguientes/`.
- [ ] `W01.P02.S78` - author the completeness manifest for Modelo 763 revision 2011-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 763 revision 2011-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/763/revisions/2011-y-siguientes/`.
- [ ] `W01.P02.S79` - author the completeness manifest for Modelo 840 revision 2003-y-siguientes from official sources, ground every manifest row and manifest-level legal ref, confirm every casilla id-number-segment identity, and pass focused registry validation for Modelo 840 revision 2003-y-siguientes; `src/cadrumo/_data/registry/aeat/modelos/840/revisions/2003-y-siguientes/`.
...
- [x] `W02.P03.S11` - add relations_by_target_binding as the one relation grouping and retarget the two registry query loops and the relation-prefill loop in the same commit; `src/cadrumo/domain/calculations/registry/_queries.py`.
...
- [x] `W02.P06.S21` - copy finding message_facts into Notice context on the envelope emission path so blocker codes reach the wire as data; `src/cadrumo/entrypoints/cli/_modelo_work_verification_cli.py`.
