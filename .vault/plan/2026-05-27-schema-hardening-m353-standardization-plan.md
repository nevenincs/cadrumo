...
related:
  ...
  - '[[2026-05-27-schema-hardening-m322-standardization-review]]'
---
...
- [ ] `P01.S02` - Mechanically split M353 into `manifest.toml` and `revisions/2008-y-siguientes` fragments using the existing generic loader layout; `src/aeat/_data/registry/aeat/modelos/353`.
- [ ] `P01.S03` - Verify M353 directory loading, registry integrity, IVA ledger binding behavior, and TOML reviewability gates; `src/aeat/domain/calculations/registry tests`.
