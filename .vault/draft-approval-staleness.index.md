...
related:
  ...
  - '[[2026-04-18-draft-approval-staleness-audit]]'
  - '[[2026-04-18-draft-approval-staleness-implementation-summary-exec]]'
  - '[[2026-04-18-draft-approval-staleness-phase4-ux-followup-exec]]'
  - '[[2026-04-18-draft-approval-staleness-phase5-test-policy-hardening-exec]]'
...
- `2026-04-18-draft-approval-staleness-audit` - `draft-approval-staleness` Code Review
...
- `2026-04-18-draft-approval-staleness-phase4-ux-followup-exec` - `draft-approval-staleness` `phase4` `ux-followup`
- `2026-04-18-draft-approval-staleness-phase5-test-policy-hardening-exec` - `draft-approval-staleness` `phase5` `test-policy-hardening`
