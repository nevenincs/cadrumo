...
modified: '2026-08-23'
body_schema: 'body-v1'
body_hash: 'sha256:91f5430f99099ea1d16d970549e87f6918c65045bbfed3f7bb7952bc6a2435ef'
related:
...
During closure, the full creation suite exposed an undefined notice collection
in the shared text-envelope renderer. The narrow correction routes the already
resolved notice collection through `notice_lines`; the existing text-mode
create-and-retry case now proves the first success does not become an INTERNAL
after mutation and the retry cannot create a second profile. All S07 review
findings are closed.
