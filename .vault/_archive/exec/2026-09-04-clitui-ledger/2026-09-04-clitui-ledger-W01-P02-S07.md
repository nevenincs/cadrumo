...
modified: '2026-09-05'
body_schema: 'body-v2'
body_hash: 'sha256:54f860be9e9d414e5ddefdc0c970a64a6deb4e27ead4b1df3e0df82b5eb9b21e'
step_id: 'S07'
related:
...
- `verify:` `uv run --no-sync pytest -q -n 0 dev/quality/tests/test_clitui_ledger_capability_matrix.py` -> `pass` (182 passed)
