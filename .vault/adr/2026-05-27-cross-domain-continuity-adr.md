...
# Feature tag (replace cross-domain-continuity with your feature name, e.g., #editor-demo)
...
# `cross-domain-continuity` adr: `{title}` | (**status:** `{accepted|rejected|deprecated}`)
