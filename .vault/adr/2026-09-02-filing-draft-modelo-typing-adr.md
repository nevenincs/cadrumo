...
<!-- FRONTMATTER RULES:
     ...
     Replace filing-draft-modelo-typing with a kebab-case feature tag, e.g. #foo-bar.
...
# `filing-draft-modelo-typing` adr: `Persisted draft modelo identifier is typed ModeloCode` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
