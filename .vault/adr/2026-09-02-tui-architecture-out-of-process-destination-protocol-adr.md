...
modified: '2026-09-02'
body_schema: 'body-v2'
body_hash: 'sha256:47377a1917384d7fe3c737cfa22d8a3e296f5706906b99b0d3f92ea7b1a20f44'
related:
...
# `tui-architecture` adr: `the out-of-process protocol that opens a full-screen destination` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
