...
modified: '2026-08-13'
body_schema: 'body-v1'
body_hash: 'sha256:111fce2717d280b23b4b6bd4e717097a8cc828070bca5e4a9ccc7d2b1102303e'
related:
...
<!-- FRONTMATTER RULES:
     ...
     Replace auth-certificate-lifecycle with a kebab-case feature tag, e.g. #foo-bar.
...
# `auth-certificate-lifecycle` adr: `authentication certificate lifecycle` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
