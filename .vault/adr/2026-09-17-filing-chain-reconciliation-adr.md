...
# `filing-chain-reconciliation` adr: `Filing chain with pending local entries and AEAT reconciliation` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
