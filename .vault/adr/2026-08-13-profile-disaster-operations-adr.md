...
modified: '2026-08-13'
body_schema: 'body-v1'
body_hash: 'sha256:1500875b4834ca8f93a193a5c52c0c21bf7a891ae2f12a7449c8d5e2951f2511'
related:
...
<!-- FRONTMATTER RULES:
     ...
     Replace profile-disaster-operations with a kebab-case feature tag, e.g. #foo-bar.
...
# `profile-disaster-operations` adr: `profile disaster operation boundaries` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
