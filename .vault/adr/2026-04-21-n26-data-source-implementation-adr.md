...
date: "2026-04-21"
modified: '2026-07-17'
body_hash: 'sha256:b0b65e13cf2d4d4f050fee34664675a49c5b0a3a7eb98da6324118fd1af3d66a'
related:
...
- The implementation stays inside `cadrumo.domain.transactions` and
  `cadrumo.adapters.inbound.financial.providers`, plus the minimal
  application/provider-selection changes needed for ingest.
...
- **Provider shape.** Add `SourceFormat.PDF` to `RawProvenance`, implement `PdfN26Provider` under `cadrumo.adapters.inbound.financial.providers`, and register it in the provider exports, auto-detection, and CLI provider selection.
