...
# `gate-integrity-adjudication` adr: `catalogue iteration overrides: retire `__iter__`, not the suppression` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
