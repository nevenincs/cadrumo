...
modified: '2026-09-03'
body_schema: 'body-v2'
body_hash: 'sha256:ccf8b45f9c4363787437a2f1264a3005e8fe201429d2b9191af0abec47591d5a'
related:
...
# `duplication-burndown` adr: `{title}` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
