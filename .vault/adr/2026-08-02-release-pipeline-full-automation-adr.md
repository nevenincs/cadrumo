...
modified: '2026-08-02'
body_schema: 'body-v1'
body_hash: 'sha256:2fe2e11b6c97554f16cce4077fd07be5aefbddc19798ce06e43d6a6c7bc50e9f'
related:
...
# `release-pipeline-full-automation` adr: `the release pipeline runs itself: the human approval gate is deleted, one dispatch drives bump through publish, and the mechanical guards are the whole safety net` | (**status:** `{proposed|accepted|rejected|superseded|deprecated}`)
