...
modified: '2026-09-05'
body_schema: 'body-v2'
body_hash: 'sha256:d93e1a18d4c6af767323f83d7d694b9f22a9bc3e10004fc7020bb52d9624ae15'
related:
...
| Publication revision | `s12-row-review-2` |
| Observation timestamp | `2026-09-05T12:00:00+02:00` |
| Source revision | `b61a37a1e3` |
| Contract source digest | `sha256:a22b3e56adb5728273ae08eb511495090272c775cff584fc932572e12a700a7c` |
| Accepted plan owner | `clitui-ledger` |
| Denominator revision / digest | `s12-row-review-2` / `sha256:a8e2854f6fa822824618e428a56c0390343f77b7f0233bd165985f9d0edb9f65` |
| Row-review coverage / digest | `693 / 693` / `sha256:3809546161a2164a50fa442ad5759b104092ccf231627d45f849e5b3023ccfb8` |
| Row-review attestation | `complete_with_open_gaps`; `sha256:60fd297e03e1384d3eca3d56b568a21ea0f6b913cc8c2b7f15dc6aab7e2b0ce4` |
...
| **Union** | **760 observations / 769 selected edges / 693 reviewed semantic rows; 680 TUI-applicable rows held until G3; 13 TUI-not-applicable rows unheld** | `sha256:a8e2854f6fa822824618e428a56c0390343f77b7f0233bd165985f9d0edb9f65` |
...
| --- | --- | --- | --- |
| `evidence.baseline.matrix_contract` | `dev/quality/clitui_ledger_capability_matrix.py:22` | `sha256:a22b3e56adb5728273ae08eb511495090272c775cff584fc932572e12a700a7c` | Matrix schema 4 plus union schema 4, eight axes, reviewed proof requirements, typed row-level TUI hold, source kinds, gaps, controls, evidence currentness, and G0-G4 predicates |
| `evidence.baseline.semantic_union_review` | `build_ledger_union_denominator` in `dev/quality/clitui_ledger_capability_matrix.py` | `sha256:a8e2854f6fa822824618e428a56c0390343f77b7f0233bd165985f9d0edb9f65` | Schema-v4 domain-separated union: exact 760-source observation graph; all 693 reviewed rows; owner, applicability, proof, gap, action, TUI, and registry dispositions; row-review digest and reviewed-open attestation |
