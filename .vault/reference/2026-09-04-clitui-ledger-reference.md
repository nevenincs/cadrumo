...
modified: '2026-09-04'
body_schema: 'body-v2'
body_hash: 'sha256:93624effbe4cb383f0f757793448483f7d8b14842d01f9b0cb387cc1af487059'
related:
...
| `evidence.s06.registry_route_census` | `build_ledger_registry_route_census` in `dev/quality/clitui_ledger_capability_matrix.py`, derived from `ValidatedRegistryAuthority` through `casillas_by_binding` | `sha256:247b82a244e2a8c9a6ca476cc6aa46a3e15b7357f2aa206f4148fee18175f9ac` | Strict route-census v1 root and rows; domain-separated, length-framed canonical JSON; all 546 declarations, 510 registry-bound and 36 without a registry binding/casilla edge |
