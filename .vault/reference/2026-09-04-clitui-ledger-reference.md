...
| Publication revision | `s04-cli-census-1` |
...
| `cli_suboperation` | 45 explicit behavior-distinct sub-operations across eight overloaded endpoints | Complete current CLI stream; not a union-denominator attestation | S04 complete |
...
| `evidence.s04.cli_command_census` | `src/cadrumo/entrypoints/cli/_app_ledger_command_specs.py:49` | `sha256:4a7ebd8cf910b1f10851934d19320d1bc57890f86c3f482d87c7f696e8a214ef` | Exact current CLI stream: 78 invocables, 45 supplemental behavior-distinct sub-operations, derived path/handler/schema/TUI facts, and fail-closed ownership annotations |
...
The 45 behavior-distinct supplemental sub-operation identities are `ledger.classify.direct`, `ledger.classify.m210`, `ledger.classify.iva_derive`, `ledger.classify.llm_preview`, `ledger.classify.llm_apply`, `ledger.classify.llm_reject`, `ledger.classify.llm_saturate_preview`, `ledger.classify.llm_saturate_apply`, `ledger.classify.llm_saturate_reject`, `ledger.classify.evidence_read`, `ledger.classify.auto_split`, `ledger.evidence.pull.gmail`, `ledger.evidence.pull.drive`, `ledger.evidence.pull.url`, `ledger.export.csv`, `ledger.export.jsonl`, `ledger.export.xlsx`, `ledger.history.direct`, `ledger.history.split_siblings`, `ledger.import.file`, `ledger.import.directory`, `ledger.import.dry_run`, `ledger.import.verify`, `ledger.import.provider_auto`, `ledger.import.provider_csv`, `ledger.import.provider_ofx_qfx`, `ledger.import.provider_xlsx_excel`, `ledger.import.provider_n26`, `ledger.import.provider_pdf`, `ledger.import.provider_pdf_n26`, `ledger.list.filter`, `ledger.list.group`, `ledger.list.sort`, `ledger.list.page`, `ledger.list.rejected_llm_filter`, `ledger.remove.preview`, `ledger.remove.commit`, `ledger.reset.preview`, `ledger.reset.commit`, `ledger.rule.apply.preview`, `ledger.rule.apply.commit`, `ledger.split.manual`, `ledger.split.llm_preview`, `ledger.split.llm_apply`, and `ledger.split.evidence_read`. Equivalent parser aliases (`qfx`/`ofx`, `excel`/`xlsx`) remain one capability because their importer effect is the same; enum tokens alone do not inflate the denominator.
