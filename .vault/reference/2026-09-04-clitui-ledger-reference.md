...
| --- | --- | --- |
| G0 denominator and ownership freeze | **CLOSED** | Two independent `ACCEPT` rulings bind the same frozen 693-row candidate; the exact G0 receipt and current external acceptance-record anchor pass live evaluation |
