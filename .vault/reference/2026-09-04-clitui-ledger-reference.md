...
modified: '2026-09-05'
body_schema: 'body-v2'
body_hash: 'sha256:23f725ea33ea3c347e25a4c049ec26b04d1a83ec6ece787abb9151442e2fd48c'
related:
...
A future G0 closure requires a fresh independent `ACCEPT` attestation, receipt, and external acceptance anchor bound to this exact candidate.
...
| --- | --- | --- |
| G0 denominator and ownership freeze | **OPEN** | The current 694-row candidate is preacceptance-only: its ruling is `REJECT`, it has zero accepted receipts, and no external acceptance anchor |
