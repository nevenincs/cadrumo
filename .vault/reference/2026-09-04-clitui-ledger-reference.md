...
modified: '2026-09-05'
body_schema: 'body-v2'
body_hash: 'sha256:e18dce1847f570398bbb9dffd082fb786a4a674e987cf2f2dc7702acb6948e01'
related:
...
| TUI census / source set | `sha256:ce8316795e12434b915bca29b29f42e4ac66a1b3a9738e2899643598c3376380` / `sha256:23f6690df3fef9b9a0131f5bdbba1c6daf7ae2c462b3262cf6b2b77b570143e6` |
| Union / row review | `761` observations / `770` edges / `694` rows; union `sha256:2895cbcff0d09c7562c314413984fdb360f3cb7cbffbe0d0cc754fc252ac4ca5`; row review `sha256:953cc5d70c492640bc81a04426a9d5fc5abaa012a21ad65f22197cb8b76a07cf`; attestation `sha256:1df9648852ee481066107ea1d9665b4c364b4616f95679905257ac56445ab148` |
| Matrix / preacceptance attestation | `sha256:514b30b8e099c263113fb6eaed71f63d2bfb07f7addb1d3eca23ea7707313b81` / `sha256:d08c2247f990ef1a53e8e3e659f5977ee9e77377d16e2fe626ec770b0da0121f` |
...
| `backend_only` | 63 | `sha256:429e44e9197403df8d20a716fdffea1d08d19481cb3366158fa3478ce5ae98a7` |
...
| `supported_surface` | 7 | `sha256:999ea39fbe44390f6556b27ef0a2f351551124138ca8877aaf286364e9009a9a` |
...
| --- | --- | --- | --- |
| `evidence.baseline.matrix_contract` | `dev/quality/clitui_ledger_capability_matrix.py:22` | `sha256:00c2e083744dfb8ddd7d9039a281233e15d5088d2f3bcb4eab353505bee68b30` | Matrix schema 4 plus union schema 4, eight axes, reviewed proof requirements, typed row-level TUI hold, source kinds, gaps, controls, evidence currentness, G0-G4 predicates, and the required public import-preparation census operation |
| `evidence.baseline.semantic_union_review` | `build_ledger_union_denominator` in `dev/quality/clitui_ledger_capability_matrix.py` | `sha256:2895cbcff0d09c7562c314413984fdb360f3cb7cbffbe0d0cc754fc252ac4ca5` | Schema-v4 domain-separated union: exact 761-source observation graph; all 694 reviewed rows; owner, applicability, proof, gap, action, TUI, and registry dispositions; row-review digest and reviewed-open attestation |
...
| `evidence.s07.tui_supported_surface` | `build_ledger_tui_supported_surface_census` in `dev/quality/clitui_ledger_capability_matrix.py` | `sha256:ce8316795e12434b915bca29b29f42e4ac66a1b3a9738e2899643598c3376380` | Strict supported-surface census v1; Overview installed read-only, six component-only routes, one outer destination, two injected read-action references, zero installed mutation doors, zero installed message consumers, 78 CLI `not-implemented` declarations, and six focused harness files with 65 test functions |
...
`LedgerTuiSupportedSurfaceCensusV1` is the committed projection owner. Its source selector currently yields 126 repository-relative files: every production Python module below `src/cadrumo/entrypoints/tui/` except tests and devtools; the three dedicated Ledger harness files; the three installed generation/workbench/launcher harness files; four application workspace/search-generation sources; and every `_app_ledger*_command_specs.py` module. Sorted paths and raw bodies are each framed with an unsigned eight-byte big-endian length after the `cadrumo:ledger-tui-supported-surface-source-set:v1` NUL-terminated domain; the current source-set digest is `sha256:23f6690df3fef9b9a0131f5bdbba1c6daf7ae2c462b3262cf6b2b77b570143e6`. The canonical ASCII JSON projection is independently length-framed after `cadrumo:ledger-tui-supported-surface-census:v1` and retains digest `sha256:ce8316795e12434b915bca29b29f42e4ac66a1b3a9738e2899643598c3376380`.
