...
- The suite’s real safety problem is not accidental live submission; it is the continued presence of submission-boundary doubles in unit tests, which weakens confidence in the hardening around `aeat.submission`.
