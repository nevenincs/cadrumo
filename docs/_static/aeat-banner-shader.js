(function () {
  ...
  var fragmentSource = [
    ...
    "  vec2 leftCenter = vec2(0.18 + sin(t) * 0.12, 0.25 + cos(t * 0.72) * 0.10);",
    "  vec2 rightCenter = vec2(0.84 + cos(t * 0.84) * 0.12, 0.72 + sin(t * 0.68) * 0.10);",
    "  vec2 lowCenter = vec2(0.46 + sin(t * 0.52) * 0.10, 0.04 + cos(t * 0.61) * 0.08);",
    "  float diagonal = smoothstep(-0.08, 1.08, uv.x * 0.64 + (1.0 - uv.y) * 0.36 + sin(t + uv.y * 2.4) * 0.07);",
    ...
    "  vec3 lightInk = mix(lightBase, coolBlue, glowA * (0.24 + pulse * 0.14) + diagonal * 0.18);",
    "  lightInk = mix(lightInk, lightGlow, glowB * (0.20 + pulse * 0.14));",
    "  lightInk = mix(lightInk, brandBlue, glowC * (0.06 + pulse * 0.08));",
    "  vec3 darkInk = mix(darkBase, darkGlow, glowA * (0.48 + pulse * 0.24) + diagonal * 0.30);",
    "  darkInk = mix(darkInk, coolBlue, glowB * (0.12 + pulse * 0.16) + glowC * 0.14);",
