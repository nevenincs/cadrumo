...
This matrix was last updated on **2026-04-22** (EPIC #305 waves 54–61b closure — 2024 backfill rulesets for Modelos 111/115/123/131/180, Modelo 303 formula-ruleset column flip, 11 external-anchored worked examples, zero-boundary coverage across all 18 rulesets, operand-swap mutation harness, exhaustive-audit waves 48/53/58/60 remediations). Future updates land via [#241](https://github.com/wgergely/aeat/issues/241) monthly-audit PRs. Do not edit this file out-of-band — the audit PR is the single source of truth.
