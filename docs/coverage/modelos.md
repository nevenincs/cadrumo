...
This matrix was last updated on **2026-04-22** (EPIC #305 waves 54–63d closure — 2024 backfill rulesets for Modelos 111/115/123/131/180, Modelo 303 formula-ruleset column flip, 13 external-anchored worked examples (arts. fixed in wave 63a: RIRPF 110.1.a, LIRPF 79 + 99), zero-boundary coverage across all 18 rulesets, operand-swap mutation harness expanded to 15 parametrized cases across Modelos 130/131/200/303/202 covering every sub_op chain, exhaustive-audit waves 48/53/58/60/62 remediations). Future updates land via [#241](https://github.com/wgergely/aeat/issues/241) monthly-audit PRs. Do not edit this file out-of-band — the audit PR is the single source of truth.
