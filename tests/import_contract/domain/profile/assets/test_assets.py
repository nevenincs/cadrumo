...
from aeat.domain.formulas import LIS_ART_12_LINEAL_TABLE, AssetClass
from aeat.domain.profile.errors import BasisCapExceededError
from aeat.domain.profile.assets import (
    AmortizationEntry,
    AmortizationLedger,
    AssetRecord,
