...
<<<<<<<< HEAD:src/aeat/application/filing/testing/test_testing.py
from .. import FilingDraftStatus
from ....core.errors import FilingFixtureError
from . import (
========
from aeat.application.filing import FilingDraftStatus
from aeat.core.errors import FilingFixtureError
from aeat.domain.testing import (
>>>>>>>> chore/eliminate-shims:tests/import_contract/domain/testing/test_testing.py
...
def test_malformed_json_raises_filing_fixture_error(tmp_path: Path) -> None:
    from aeat.domain.testing._loader import _load_one
