...
The test lives at the top-level ``tests/`` directory rather than
colocated under ``src/aeat/`` because it validates project-meta
files that do not belong to any ``aeat.*`` subpackage. The exception
