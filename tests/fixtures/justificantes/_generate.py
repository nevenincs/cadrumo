...
for Modelo 130, Modelo 303, and Modelo 100 under
``tests/fixtures/justificantes/``. The PDFs are hand-modelled on the public
...
suite. Run manually with ``uv run python tests/fixtures/justificantes/_generate.py``.
"""
