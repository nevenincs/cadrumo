...
Synthetic HTML fixtures for the `aeat.status._site_health_parsers`
...
see `tests/fixtures/aeat-pages/README.md` for the project-wide scrub
procedure this corpus follows.
