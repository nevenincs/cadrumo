...
`cadrumo-data-manuals` is version-locked to the `cadrumo` distribution: it and its
sibling `cadrumo-data-official` ship at the same version as `cadrumo`, enforced by a
