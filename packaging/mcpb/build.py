...
DEMOTED SECONDARY ARTIFACT. The accepted ``2026-07-03-claude-ecosystem-packaging``
ADR (D3a, amending harness-refoundation R8) makes the Claude plugin — generated by
``cadrumo app agent --layout plugin`` and served from the marketplace tree under
``packaging/marketplace/`` — the consumer distribution path. This ``.mcpb`` bundle
